...
class cacheModel extends Model {
     ...
     * @return array
     */
    private function _tyq_level(){
        $list = $this->table('tyq_mldefault')->limit(false)->select();
    ...
    private function _admin_menu() {
        ...
        if (file_exists(BASE_PATH.DS.ADMIN_MODULES_TZX.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_TZX.'/include/menu.php');
        }
		...
		if (file_exists(BASE_PATH.DS.ADMIN_MODULES_SHOPWWI.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_SHOPWWI.'/include/menu.php');
        }
        return $_menu;
    }
    /**
