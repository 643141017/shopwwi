...
class servicer_store_gradeModel extends Model {

    public function __construct(){
        parent::__construct('servicer_store_grade');
    }
    ...
    public function getGradeList($condition = array()){
        ...
        $param = array();
        $param['table'] = 'servicer_store_grade';
    ...
    private function _condition($condition){
        ...
        if ($condition['ssg_id'] != ''){
            $condition_str .= " and servicer_store_grade.ssg_id = '". $condition['ssg_id'] ."'";
        }
    ...
    public function add($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::insert('servicer_store_grade',$tmp);
            return $result;
        }else {
            return false;
        }
    ...
    public function updates($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('servicer_store_grade',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = Db::delete('servicer_store_grade',$where);
            return $result;
        }else {
            return false;
        }
