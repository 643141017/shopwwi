...
define('BASE_CORE_PATH',BASE_ROOT_PATH.'/shopwwi');
...
define('ATTACH_TYQ','tyq');
define('ATTACH_TZX','tzx');
define('ATTACH_CB','cb');
define('ATTACH_LIVE','live');
define('ATTACH_MALBUM','mall/member');
define('ATTACH_TFX','tfx');
...
define('TPL_TYQ_NAME', 'default');
define('TPL_TFX_NAME', 'default');
define('TPL_TZX_NAME', 'default');
...
define('ADMIN_MODULES_TZX', 'modules/tzx');
define('ADMIN_MODULES_CIECLE', 'modules/tyq');
define('ADMIN_MODULES_SHOPWWI', 'modules/shopwwi');
define('ADMIN_MODULES_MICEOMALL', 'modules/tfx');
...
define('TZX_SITE_URL', $config['tzx_site_url']);
define('TZX_modules_URL', $config['tzx_modules_url']);
define('TYQ_SITE_URL', $config['tyq_site_url']);
define('TYQ_modules_URL', $config['tyq_modules_url']);
define('TFX_SITE_URL', $config['tfx_site_url']);
define('TFX_modules_URL', $config['tfx_modules_url']);
...
$_GET['wwi'] = is_string($_GET['wwi']) ? strtolower($_GET['wwi']) : (is_string($_POST['wwi']) ? strtolower($_POST['wwi']) : null);
...
$_GET['wwi'] = preg_match('/^[\w]+$/i',$_GET['wwi']) ? $_GET['wwi'] : 'index';
