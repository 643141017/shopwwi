...
function get_list() {
	...
	$.getJSON(ApiUrl + "/index.php?app=store&wwi=store_list" + window.location.search.replace("?", "&"), param, function(e) {
		if (!e) {
			e = [];
			e.datas = [];
			e.datas.store_list = []
...
function search_adv() {
	$.getJSON(ApiUrl + "/index.php?app=store&wwi=store_class_list", function(e) {
		var r = e.datas;
