...
var password,rcb_pay,pd_pay,payment_code;
 ...
 function toPay(pay_sn,app,op) {
     $.ajax({
         type:'post',
         url:ApiUrl+'/index.php?app='+app+'&wwi='+op,
         data:{
             key:key,
             pay_sn:pay_sn
             },
         ...
         success: function(result){
             ...
             $('#toPay').click(function(){
                 ...
                 if (_use_password) {
                     ...
                     $.ajax({
                         type:'post',
                         url:ApiUrl+'/index.php?app=member_buy&wwi=check_pd_pwd',
                         dataType:'json',
 ...
 function goToPayment(pay_sn,op) {
     location.href = ApiUrl+'/index.php?app=member_payment&wwi='+op+'&key=' + key + '&pay_sn=' + pay_sn + '&password=' + password + '&rcb_pay=' + rcb_pay + '&pd_pay=' + pd_pay + '&payment_code=' + payment_code;
 }
