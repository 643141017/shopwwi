$(function() {
    ...
    $.ajax({
        type:'get',
        url:ApiUrl+"/index.php?app=member_account&wwi=get_mobile_info",
        data:{key:key},
        dataType:'json',
    ...
    $('#send').click(function(){
        if($.sValid()){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+"/index.php?app=member_account&wwi=modify_password_step2",
    ...
    $('#nextform').click(function(){
        ...
        if (auth_code) {
            $.ajax({
                type:'post',
                url:ApiUrl+"/index.php?app=member_account&wwi=modify_password_step3",
