$(function (){
    ...
    if(!key){
        ...
        function delCartList(cart_id){
            $.ajax({
                url:ApiUrl+"/index.php?app=member_cart&wwi=cart_del",
                type:"post",
        ...
        function editQuantity(self,type){
            ...
            $.ajax({
                url:ApiUrl+"/index.php?app=member_cart&wwi=cart_edit_quantity",
                type:"post",
...
function getGoods(goods_id, goods_num){
    ...
    $.ajax({
        type:'get',
        url:ApiUrl+'/index.php?app=goods&wwi=goods_detail&goods_id='+goods_id,
        dataType:'json',
        async:false,
        success:function(result){
            if (result.datas.error) {
