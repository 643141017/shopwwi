...
$(function() {
    ...
    $.ajax({
        type: 'post',
        url: ApiUrl + "/index.php?app=store&wwi=store_info",
    ...
    $('#goods_rank_tab').find('a').click(function(){
        ...
        $.ajax({
            type: 'post',
            url: ApiUrl + '/index.php?app=store&wwi=store_goods_rank',
    ...
    function getStoreNewGoods(){
        ...
        load_class_newgoods.loadInit({'url':ApiUrl + '/index.php?app=store&wwi=store_new_goods','getparam':param,'tmplid':'newgoods_tpl','containerobj':$("#newgoods"),'iIntervalId':true,'resulthandle':'tidyStoreNewGoodsData'});
    }
    //加载店铺促销活动
    function getStoreactivity(){
        $.ajax({
            type: 'post',
            url: ApiUrl + "/index.php?app=store&wwi=store_promotion",
    ...
    $("#store_voucher").click(function(){
        if (!$("#store_voucher_con").html()) {
            $.ajax({
                type: 'post',
                url: ApiUrl + '/index.php?app=voucher&wwi=voucher_tpl_list',
