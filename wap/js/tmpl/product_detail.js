...
$(function (){
  ...
  function get_detail(goods_id) {
      //渲染页面
      $.ajax({
         url:ApiUrl+"/index.php?app=goods&wwi=goods_detail",
         type:"get",
            ...
            if(!data.error){
              ...
              $("#add-cart").click(function (){
                ...
                var quantity = parseInt($(".buy-num").val());
                 if(!key){
                    ...
                    $.ajax({
                       url:ApiUrl+"/index.php?app=member_cart&wwi=cart_add",
              ...
              if (data.goods_info.is_virtual == '1') {
                  $("#buy-now").click(function() {
                      ...
                      $.ajax({
                          type:'post',
                          url:ApiUrl+'/index.php?app=member_vr_buy&wwi=buy_step1',
                          data:json,
                          dataType:'json',
                          success:function(result){
  ...
  $('#product_detail_html').on('click', '#get_area_selected', function(){
      $.areaSelected({
          success : function(data){
              ...
              $.getJSON(ApiUrl + '/index.php?app=goods&wwi=calc', {goods_id:goods_id,area_id:area_id},function(result){
...
function virtual() {
    ...
    $.getJSON(ApiUrl + '/index.php?app=goods&wwi=store_o2o_addr', {store_id:store_id},function(result){
    	if (!result.datas.error) {
