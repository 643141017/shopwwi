$(function(){
    ...
    $.getJSON(ApiUrl+'/index.php?app=member_return&wwi=ship_form', {key:key,return_id:return_id}, function(result){
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+'/index.php?app=member_return&wwi=ship_post',
                data:param,
                dataType:'json',
                async:false,
