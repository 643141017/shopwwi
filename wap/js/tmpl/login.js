$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?app=connect&wwi=get_state', function(result){
	...
	$('.weibo').click(function(){
	    location.href = ApiUrl+'/index.php?app=connect&wwi=get_sina_oauth2';
	})
    $('.qq').click(function(){
        location.href = ApiUrl+'/index.php?app=connect&wwi=get_qq_oauth2';
    })
    $('.wx').click(function(){
        location.href = ApiUrl+'/index.php?app=connect&wwi=index';
    })
});