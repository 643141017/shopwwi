$(function(){
    ...
    $('#keyword').on('input',function(){
    	...
    	if (value == '') {
            ...
            $.getJSON(ApiUrl + '/index.php?app=goods&wwi=auto_complete',{term:$('#keyword').val()}, function(result) {
    ...
    $.getJSON(ApiUrl + '/index.php?app=index&wwi=search_key_list', function(result) {
    	var data = result.datas;
    	data.WapSiteUrl = WapSiteUrl;
