...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?app=member_refund&wwi=refund_form',{key:key,order_id:getQueryString('order_id'),order_goods_id:getQueryString('order_goods_id')}, function(result) {
        ...
        $('input[name="refund_pic"]').ajaxUploadImage({
            url : ApiUrl + "/index.php?app=member_refund&wwi=upload_pic",
            data:{key:key},
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+'/index.php?app=member_refund&wwi=refund_post',
                data:param,
                dataType:'json',
                async:false,
