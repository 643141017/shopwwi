$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?app=member_order&wwi=order_info',{key:key,order_id:getQueryString('order_id')}, function(result) {
        ...
        $.ajax({
            type: 'post',
            url: ApiUrl + "/index.php?app=member_order&wwi=get_current_deliver",
    ...
    function cancelOrderId(order_id) {
        $.ajax({
            type:"post",
            url:ApiUrl+"/index.php?app=member_order&wwi=order_cancel",
    ...
    function sureOrderId(order_id) {
        $.ajax({
            type:"post",
            url:ApiUrl+"/index.php?app=member_order&wwi=order_receive",
            data:{order_id:order_id,key:key},
            dataType:"json",
            success:function(result){
                if(result.datas && result.datas == 1){
