...
class mb_appControl extends SystemControl{
    ...
    public function mb_appWwi() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                $this->log('设置手机端下载地址');
                showMessage(Language::get('nc_common_save_succ'),'index.php?app=mb_app&wwi=mb_app');
            } else {
...
Tpl::showpage('mb_app.edit');
    ...
    public function mb_qrWwi() {
        ...
        $this->log('生成手机端二维码');
        showMessage('生成二维码成功','index.php?app=mb_app&wwi=mb_app');
    }
}
