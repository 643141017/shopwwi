...
class mb_connectControl extends SystemControl{
	    private $links = array(
		array('url'=>'app=mb_connect&wwi=wx','text'=>'微信登录'),
		array('url'=>'app=mb_connect&wwi=wap_wx','text'=>'WAP微信登录'),
        array('url'=>'app=mb_connect&wwi=qq','text'=>'QQ互联'),
        array('url'=>'app=mb_connect&wwi=sina','text'=>'新浪微博'),
    );
