...
Tpl::showpage('mb_special.list');
     ...
     * 保存专题
     */
    public function special_saveWwi() {
        $model_mb_special = Model('mb_special');
     ...
     * 编辑专题描述
     */
    public function update_special_descWwi() {
        $model_mb_special = Model('mb_special');
     ...
     * 删除专题
     */
    public function special_delWwi() {
        $model_mb_special = Model('mb_special');
...
Tpl::showpage('mb_special_item.list');
     ...
     * 编辑专题
     */
    public function special_editWwi() {
        $model_mb_special = Model('mb_special');
...
Tpl::showpage('mb_special_item.list');
     ...
     * 专题项目添加
     */
    public function special_item_addWwi() {
        $model_mb_special = Model('mb_special');
     ...
     * 专题项目删除
     */
    public function special_item_delWwi() {
        $model_mb_special = Model('mb_special');
     ...
     * 专题项目编辑
     */
    public function special_item_editWwi() {
        $model_mb_special = Model('mb_special');
     ...
     * 专题项目保存
     */
    public function special_item_saveWwi() {
        $model_mb_special = Model('mb_special');
     ...
     * 限时折扣商品列表
     */
    public function goods_xianshi_listWwi() {
        $model_goods = Model('goods');
        $condition = array();
     ...
     * 团购商品列表
     */
    public function goods_groupbuy_listWwi() {
        $model_goods = Model('goods');
        $condition = array();
        $condition['goods_name'] = array('like', '%' . $_GET['keyword'] . '%');
     ...
     * 更新项目排序
     */
    public function update_item_sortWwi() {
     ...
     * 更新项目启用状态
     */
    public function update_item_usableWwi() {
        $model_mb_special = Model('mb_special');
