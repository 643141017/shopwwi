...
$(function(){
	$('.flex-table').flexigrid({
        ...
        $('#add_form').validate({
            ...
            messages : {
                special_desc : {
                    required : "<i class='fa fa-exclamation-tyq'></i>专题描述不能为空",
                    maxlength : "<i class='fa fa-exclamation-tyq'></i>专题描述最多20个字"
                }
            }
        });
        ...
        //编辑专题描述
        $('span[nc_type="edit_special_desc"]').inline_edit({app: 'mb_special',wwi: 'update_special_desc'});
    });
