...
<div class="page"> 
  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <a id="btn_back" href="<?php echo urlAdminMobile('mb_special', 'special_edit', array('special_id' => $output['item_info']['special_id']));?>" class="back"  title="返回上一级"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <?php } else { ?>
      <a id="btn_back" href="<?php echo urlAdminMobile('mb_special', 'index_edit');?>" class="back" title="返回上一级"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <?php } ?>
      <div class="subject">
