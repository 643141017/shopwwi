...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=mb_category&wwi=mb_category_list" title="返回分类图片列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
//按钮先执行验证再提交表单	
	...
	$('#link_form').validate({
        ...
        messages : {
            link_title : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['link_add_title_null'];?>'
            },
            link_url  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['link_add_url_null'];?>',
                url : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['link_add_url_wrong'];?>'
            },
            link_sort  : {
                number   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['link_add_sort_int'];?>'
            }
        }
    });
});
