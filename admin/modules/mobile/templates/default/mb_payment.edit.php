...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminMobile('mb_payment', 'payment_list');?>" title="返回手机支付方式列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
	$('#post_form').validate({
        ...
        messages : {
            alipay_account  : {
                required : '<i class="fa fa-exclamation-tyq"></i>支付宝账号不能为空'
            },
            alipay_key  : {
                required : '<i class="fa fa-exclamation-tyq"></i>交易安全校验码不能为空'
            },
            alipay_partner  : {
                required : '<i class="fa fa-exclamation-tyq"></i>合作者身份不能为空'
            }
        }
		<?php } ?>
		<?php if ($output['payment']['payment_code'] == 'wxpay') { ?>
        ...
        messages : {
            appId  : {
                required : '<i class="fa fa-exclamation-tyq"></i>APP唯一凭证不能为空'
            },
            appSecret  : {
                required : '<i class="fa fa-exclamation-tyq"></i>应用密钥不能为空'
            },
            partnerId  : {
                required : '<i class="fa fa-exclamation-tyq"></i>合作者身份不能为空'
            },
			apiKey  : {
                required : '<i class="fa fa-exclamation-tyq"></i>合作者密钥不能为空'
            }
        }
		<?php } ?>
				<?php if ($output['payment']['payment_code'] == 'alipay_mb') { ?>
