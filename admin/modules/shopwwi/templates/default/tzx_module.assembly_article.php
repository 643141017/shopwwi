...
<!-- 文章　-->
<div class="tzx-module-assembly-article">
    <div class="title-bar">
    ...
    <div class="content-box">
        ...
        <?php echo "<?php if(\$output['edit_flag']) { ?>";?>
        <div class="tzx-index-module-handle"><a nctype="btn_module_article_edit" save_function="article_type_5_save" limit_count="0" href="JavaScript:void(0);" class="tip-l" title="<?php echo $lang['tzx_index_module_article_edit'];?>"><?php echo $lang['tzx_index_module_article_edit'];?></a></div>
        <?php echo "<?php } ?>";?>
    </div>
</div>
