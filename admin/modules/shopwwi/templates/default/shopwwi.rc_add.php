...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=shopwwi&wwi=rc" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3>首页推荐词 - 设置</h3>
...
$(document).ready(function(){
	$('#rc_form').validate({
        ...
        messages : {
            rc_name : {
                required : '<i class="fa fa-exclamation-tyq"></i>请填写推荐词名称'
            },
            rc_value : {
            	required : '<i class="fa fa-exclamation-tyq"></i>请填写推荐词链接'
            },
			rc_blod : {
            	required : '<i class="fa fa-exclamation-tyq"></i>请选择是否高亮'
            }
        }
    });
});
