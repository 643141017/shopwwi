...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tzx_tag_manage'];?></h3>
    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="350" align="left"><?php echo $lang['tzx_tag_name'];?></th>
          <th width="150" align="center"><?php echo $lang['tzx_tag_count'];?></th>
          <th></th>
        </tr>
      </thead>
      <tbody>
...
$(document).ready(function(){
    ...
    //行内ajax编辑
    $('span[nc_type="tag_sort"]').inline_edit({app: 'tzx_tag',wwi: 'update_tag_sort'});
    $('span[nc_type="tag_name"]').inline_edit({app: 'tzx_tag',wwi: 'update_tag_name'});
});
...
function submit_delete(id){
	...
	if(confirm('删除后将不能恢复，确认删除这 ' + id.length + ' 项吗？')){
        ...
        $('#list_form').attr('action','index.php?app=tzx_tag&wwi=tzx_tag_drop');
        $('#tag_id').val(id);
        $('#list_form').submit();
    }
}
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?app=tzx_tag&wwi=tzx_tag_add';
    }else if (name == 'delete') { 
