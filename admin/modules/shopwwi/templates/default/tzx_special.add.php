...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=tzx_special&wwi=tzx_special_list" title="返回专题列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['nc_tzx_special_manage'];?> -  新增专题页</h3>
        <h5><?php echo $lang['nc_tzx_special_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=tzx_special&wwi=tzx_special_save">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="special_title"><em>*</em><?php echo $lang['tzx_text_title'];?></label>
        </dt>
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic"><?php echo $lang['tzx_special_title_explain'];?></p>
        </dd>
      </dl>
       <dl class="row">
        <dt class="tit">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic"><?php echo $lang['tzx_special_background_color_explain'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit"><?php echo $lang['tzx_special_background_image'];?></dt>
        <dd class="opt">
          <div class="input-file-show"><span class="show"> <a href="<?php if(!empty($output['special_detail']['special_background'])){ echo getTZXSpecialImageUrl($output['special_detail']['special_background']);} else {echo ADMIN_TEMPLATES_URL . '/images/preview.png';}?>" nctype="nyroModal"> <i class="fa fa-picture-o" onMouseOver="toolTip('<img src=<?php if(!empty($output['special_detail']['special_background'])){ echo getTZXSpecialImageUrl($output['special_detail']['special_background']);} else {echo ADMIN_TEMPLATES_URL . '/images/preview.png';}?>>')" onMouseOut="toolTip()"></i> </a> </span> <span class="type-file-box">
            <input name="special_background" type="file" class="type-file-file" id="special_background" size="30" hidefocus="true" nctype="tzx_image">
            <input name="old_special_background" type="hidden" value="<?php echo $output['special_detail']['special_background'];?>" />
            </span></div>
          <span class="err"></span>
          <p class="notic"><span class="vatop rowform"><?php echo $lang['tzx_special_background_image_explain'];?></span></p>
      </dl>
      <dl class="row">
        <dt class="tit"><?php echo $lang['tzx_special_background_type'];?></dt>
        <dd class="opt">
          <label class="mr10">
            <input name="special_repeat" type="radio" value="no-repeat" <?php if($output['special_detail']['special_repeat'] == 'no-repeat') echo 'checked';?> />
            <?php echo $lang['tzx_special_background_type_norepeat'];?></label>
          <label class="mr10">
            <input name="special_repeat" type="radio" value="repeat" <?php if($output['special_detail']['special_repeat'] == 'repeat') echo 'checked';?>/>
            <?php echo $lang['tzx_special_background_type_repeat'];?></label>
          <label class="mr10">
            <input name="special_repeat" type="radio" value="repeat-x" <?php if($output['special_detail']['special_repeat'] == 'repeat-x') echo 'checked';?>/>
            <?php echo $lang['tzx_special_background_type_xrepeat'];?></label>
          <label class="mr10">
            <input name="special_repeat" type="radio" value="repeat-y" <?php if($output['special_detail']['special_repeat'] == 'repeat-y') echo 'checked';?>/>
            <?php echo $lang['tzx_special_background_type_yrepeat'];?></label>
          <span class="err"></span>
          <p class="notic"><?php echo $lang['tzx_special_background_type_explain'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit"><?php echo $lang['tzx_special_content_top_margin'];?></dt>
        <dd class="opt">&nbsp;
          ...
          <p class="notic"><?php echo $lang['tzx_special_content_explain'];?></p>
        </dd>
      </dl>
    </div>
    <div class="ncap-form-all">
      <div class="title">
        <h3><?php echo $lang['tzx_special_content'];?></h3>
        <ul class="tab-base nc-row">
          <li> <a id="btn_content_view" class="current" href="javascript:void(0);"><?php echo $lang['tzx_text_view'];?></a> </li>
          <li> <a id="btn_content_edit" href="javascript:void(0);"><?php echo $lang['nc_edit'];?></a> </li>
        </ul>
      </div>
      <dl class="row">
        <dd class="opt nopd nobd nobs">
          <div class="tab-content" style="background-color: <?php echo $output['special_detail']['special_background_color'];?>; background-image: url(<?php if(!empty($output['special_detail']['special_background'])){echo getTZXSpecialImageUrl($output['special_detail']['special_background']);}?>); background-repeat: <?php echo $output['special_detail']['special_repeat'];?>; background-position: top center; width: 100%; padding: 0; margin: 0; overflow: hidden;">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit"><?php echo $lang['tzx_special_image_and_goods'];?></dt>
        <dd class="opt">
          <div class="ncap-upload-btn">
            ...
            <a href="javascript:void(0);" class="ncap-btn"><i class="fa fa-upload"></i><?php echo $lang['tzx_text_image_upload'];?></a> </div>
          <div class="ncap-upload-btn">
            <input class="input-button" id="btn_show_special_insert_goods" type="button" value="" />
            <a href="javascript:void(0);" class="ncap-btn"><i class="fa fa-cubes"></i><?php echo $lang['tzx_text_goods_add'];?></a></div>
          <p class="notic"><?php echo $lang['tzx_special_image_explain1'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit"><?php echo $lang['tzx_special_image_list'];?></dt>
        <dd class="opt">
          <div class="tzx-special-uploadpic">
            <ul id="special_image_list" class="ncap-thumb-list">
              ...
              <?php $image_url = getTZXSpecialImageUrl($value['image_name']);?>
              <li class="picture">
                <div class="size-64x64"> <span class="thumb size-64x64"><i></i> <img alt="" src="<?php echo $image_url;?>"> </span></div>
                <p class="handle "><a image_url="<?php echo $image_url;?>" nctype="btn_show_image_insert_link" class="insert-link " title="<?php echo $lang['tzx_special_image_tips1'];?>">&nbsp;</a><a image_name="<?php echo $value['image_name'];?>" image_url="<?php echo $image_url;?>" nctype="btn_show_image_insert_hot_point" class="insert-hotpoint  " title="<?php echo $lang['tzx_special_image_tips2'];?>">&nbsp;</a><a image_name="<?php echo $value['image_name'];?>" nctype="btn_drop_special_image" class="delete  " title="<?php echo $lang['tzx_special_image_tips3'];?>">&nbsp;</a></span> </p>
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-blue" id="btn_draft"><?php echo $lang['tzx_special_draft'];?></a> <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="btn_publish"><?php echo $lang['tzx_special_publish'];?></a></div>
    </div>
  </form>
  <!-- 插入图片链接对话框 -->
  <div id="_dialog_image_insert_link" style="display:none;">
    <div class="upload_adv_dialog dialog-image-insert-link">
      <div class="s-tips"><i class="fa fa-lightbulb-o"></i><?php echo $lang['tzx_special_image_link_explain1'];?></div>
      <div class="ncap-form-default" id="upload_adv_type">
        ...
        <dl class="row" id="upload_adv_type">
          <dt class="tit"><?php echo $lang['tzx_special_image_link_url'];?></dt>
          <dd class="opt">
            <input nctype="_image_insert_link" type="text" class="input-txt" placeholder="http://"/>
            <p class="notic"><?php echo $lang['tzx_special_image_link_url_explain'];?>如不填加任何链接请保持默认。</p>
          </dd>
        </dl>
        <div class="bot"><a nctype="btn_image_insert_link" href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" ><?php echo $lang['tzx_text_save'];?></a></div>
      </div>
    </div>
  </div>
  <!-- 插入图片热点对话框 -->
  <div id="_dialog_image_insert_hot_point" style="display:none;">
    <div class="dialog-image-insert-hot-point">
      <div class="s-tips"><i class="fa fa-lightbulb-o"></i><?php echo $lang['tzx_special_image_link_hot_explain1'];?></div>
      <div class="ncap-form-default" id="upload_adv_type">
        <div ncytpe="div_image_insert_hot_point" class="special-hot-point"><img nctype="img_hot_point" alt="" src="<?php echo $image_url;?>"> </div>
        <dl class="row">
          <dt class="tit"><?php echo $lang['tzx_special_image_link_hot_url'];?></dt>
          <dd class="opt">
            ...
            <p class="notic"><?php echo $lang['tzx_special_image_link_url_explain'];?></p>
          </dd>
        </dl>
        <dl class="row">
        ...
        <div class="bot"><a nctype="btn_image_insert_hot_point" href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" ><?php echo $lang['tzx_special_insert_editor'];?></a></div>
      </div>
    </div>
  </div>
  <!-- 插入商品对话框 -->
  <div id="_dialog_special_insert_goods" style="display:none;">
    <div class="upload_adv_dialog dialog-special-insert-goods">
      <div class="s-tips"><i class="fa fa-lightbulb-o"></i><?php echo $lang['tzx_special_goods_explain1'];?></div>
      <div class="ncap-form-default" id="upload_adv_type">
        <dl class="row">
          <dt class="tit"> <?php echo $lang['tzx_special_goods_url'];?></dt>
          <dd class="opt">
            <input nctype="_input_goods_link" type="text" class="input-txt"/>
            <a class="ncap-btn" nctype="btn_special_goods" href="javascript:void(0);"><?php echo $lang['tzx_text_save'];?></a>
            <p class="notic"><?php echo $lang['tzx_special_goods_explain3'];?></p>
          </dd>
        </dl>
        ...
        <div class="bot"><a nctype="btn_special_insert_goods" href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green"><?php echo $lang['tzx_special_insert_editor'];?></a></div>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript" src="<?php echo ADMIN_RESOURCE_URL;?>/js/tzx/tzx_special.js" charset="utf-8"></script> 
<script type="text/javascript">
    ...
    $('#add_form').validate({
        ...
        messages : {
            <?php if(empty($output['special_detail'])) {?>
            special_image: {
                required : "<?php echo $lang['tzx_special_image_error'];?>"
            },
            <?php } ?>
            special_title: {
                required : "<?php echo $lang['tzx_title_not_null'];?>",
                maxlength : "<?php echo $lang['tzx_title_max'];?>", 
                minlength : "<?php echo $lang['tzx_title_min'];?>" 
            }
        }
    });
