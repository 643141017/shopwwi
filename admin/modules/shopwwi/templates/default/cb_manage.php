...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=cb_manage&wwi=cb_manage_save">
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="cb_isuse_1" class="cb-enable <?php if($output['setting']['cb_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_open'];?>"><?php echo $lang['nc_open'];?></label>
            <label for="cb_isuse_0" class="cb-disable <?php if($output['setting']['cb_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_close'];?>"><?php echo $lang['nc_close'];?></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"><span class="show">
            ...
            <input class="type-file-file" id="cb_logo" name="cb_logo" type="file" size="30" hidefocus="true" nc_type="cb_image" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span></div>
...
$(document).ready(function(){
    ...
    $("input[nc_type='cb_image']").live("change", function(){
