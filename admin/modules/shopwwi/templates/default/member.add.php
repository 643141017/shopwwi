...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=member&wwi=member" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url : '<?php echo ADMIN_SITE_URL?>/index.php?app=common&wwi=pic_upload&form_submit=ok&uploadpath=<?php echo ATTACH_AVATAR;?>',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['nc_cut'];?>','<?php echo ADMIN_SITE_URL?>/index.php?app=common&wwi=pic_cut&type=member&x=120&y=120&resize=1&ratio=1&url='+data.url,690);
					}else{
						alert(data.msg);
					}
    ...
    $('#user_form').validate({
        ...
        rules : {
			member_name: {
				...
				maxlength: 20,
				remote   : {
                    url :'index.php?app=member&wwi=ajax&branch=check_user_name',
                    type:'get',
                    data:{
                        user_name : function(){
            ...
            member_email   : {
                ...
                email : true,
				remote   : {
                    url :'index.php?app=member&wwi=ajax&branch=check_email',
                    type:'get',
                    data:{
                        user_name : function(){
        ...
        messages : {
			member_name: {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_add_name_null']?>',
				maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_add_name_length']?>',
				minlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_add_name_length']?>',
				remote   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_add_name_exists']?>'
			},
            member_passwd : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo '密码不能为空'; ?>',
                maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_edit_password_tip']?>',
                minlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_edit_password_tip']?>'
            },
            member_email  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_edit_email_null']?>',
                email   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_edit_valid_email']?>',
				remote   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_edit_email_exists']?>'
            },
			member_qq : {
				digits: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_edit_qq_wrong']?>',
				minlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_edit_qq_wrong']?>',
				maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['member_edit_qq_wrong']?>'
			}
        }
    });
});
