...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tzx_picture_manage'];?></h3>
        <h5><?php echo $lang['nc_tzx_picture_manage_subhead'];?></h5>
      </div>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['tzx_picture_list_tip2'];?></li>
...
<div id="dialog_verify" style="display:none;">
  <form id="verify_form" method='post' action="index.php?app=tzx_picture&wwi=tzx_picture_verify">
...
$(function(){
    ...
    var flexUrl = 'index.php?app=tzx_picture&wwi=tzx_picture_list_xml&picture_state=<?php echo $output['currentState']; ?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?app=tzx_picture&wwi=tzx_picture_drop&picture_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$("a[data-j='drop']").live('click', function() {
    ...
    location.href = 'index.php?app=tzx_picture&wwi=tzx_picture_drop&picture_id='+id;
});
...
$("a[data-j='callback']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    location.href = 'index.php?app=tzx_picture&wwi=tzx_picture_callback&picture_id=' + id;
});
...
$("a[data-j='picture_commend_flag'],a[data-j='picture_comment_flag']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    $.get('index.php?app=tzx_picture&wwi=ajax', {
        column: column,
        id: id,
        value: value
    }, function(d) {
...
$("span[data-live-inline-edit]").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php?app=tzx_picture&wwi=update_' + column, {
