...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tzx_picture_class'];?></h3>
    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['class_id']; ?>">
          ...
          <td class="handle-s"><a href="index.php?app=tzx_picture_class&wwi=tzx_picture_class_drop&class_id=<?php echo $val['class_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a></td>
	...
	$('.flex-table').flexigrid({
        ...
        buttons : [
				   ...
				   {display: '<i class="fa fa-trash"></i>批量删除', name : 'del', bclass : 'del', title : '将选定行数据批量删除', onpress : function() {
                    ...
                    location.href = 'index.php?app=tzx_picture_class&wwi=tzx_picture_class_drop&class_id=__IDS__'.replace('__IDS__', ids.join(','));
                    } }
               ]
		});

    //行内ajax编辑
    $('span[nc_type="class_sort"]').inline_edit({app: 'tzx_picture_class',wwi: 'update_class_sort'});
    $('span[nc_type="class_name"]').inline_edit({app: 'tzx_picture_class',wwi: 'update_class_name'});
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?app=tzx_picture_class&wwi=tzx_picture_class_add';
    }
}
</script>