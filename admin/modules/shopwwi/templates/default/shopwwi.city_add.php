...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=shopwwi&wwi=city" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3>切换城市 - 设置</h3>
        <h5>切换城市用于多城市选择</h5>
      </div>
      ...
      <dl class="row">
       ...
       <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic">首页链接必须包含‘index.php?app=index&wwi=index’</p>
        </dd>
      </dl>
...
$(document).ready(function(){
	$('#city_form').validate({
        ...
        messages : {
            city_name : {
                required : '<i class="fa fa-exclamation-tyq"></i>请填写城市名称'
            },
            city_value : {
            	required : '<i class="fa fa-exclamation-tyq"></i>请填写城市ID'
            },
			city_url : {
            	required : '<i class="fa fa-exclamation-tyq"></i>请填写城市默认连接'
            }
        }
    });
});
