...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=goods" title="返回商品列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(function(){
	...
	$("#pingjia_form").validate({
        ...
        messages : {
            member_name : {
                required : '<i class="fa fa-exclamation-tyq"></i>请填写会员名称',
               
            },
            geval_content  : {
                required   : '<i class="fa fa-exclamation-tyq"></i>请填写评价内容'
            }
        }
	});	
});
