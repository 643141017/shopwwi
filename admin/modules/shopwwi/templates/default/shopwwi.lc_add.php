...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=shopwwi&wwi=lc" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3>楼层快速直达 - 设置</h3>
...
$(document).ready(function(){
	$('#lc_form').validate({
        ...
        messages : {
            lc_name : {
                required : '<i class="fa fa-exclamation-tyq"></i>请填写显示司'
            },
            lc_value : {
            	required : '<i class="fa fa-exclamation-tyq"></i>请填写楼层号'
            }
        }
    });
});
