...
Tpl::showpage('cb_index');
    ...
    public function cb_index_previewWwi() {
        $model_index_module = Model('cb_index_module');
...
Tpl::showpage('cb_index.template', 'null_layout');
     ...
     * 首页静态文件生成
     */
    public function cb_index_buildWwi() {
        $data = array();
        $data['result'] = TRUE;
...
Tpl::showpage('cb_index_module.edit');
    ...
    public function save_page_moduleWwi() {
        ...
        if($result) {
            ...
            showMessage(Language::get('nc_common_save_succ'), 'index.php?app=cb_index&wwi=cb_index');
        } else {
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'cb_index'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_manage'),'menu_url'=>'index.php?app=cb_index&wwi=cb_index'),
        );
