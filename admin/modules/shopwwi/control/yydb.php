...
class yydbControl extends SystemControl{
        ...
        if (chksubmit()){
           $obj_validate = new Validate();
            ...
            if($state){
                ...
                showDialog(添加成功,'index.php?app=yydb&wwi=index','succ');
            }
        }
        //模型实例化
        $where = array();
     ...
     * 夺宝模板列表XML
     */
    public function yydblist_xmlWwi()
    {
        $where = array();
        ...
        foreach ($list as $val) {
            ...
            $o .= "<li><a href='index.php?app=yydb&wwi=ydbedit&tid=".$val['yydb_t_id']."'>编辑信息</a></li>";
            $o .= "<li><a href='index.php?app=yydb&wwi=giveoutlist&tid=".$val['yydb_t_id']."'>查看详细</a></li>";
            $o .= "</ul>";
    ...
    public function ydbeditWwi(){
        ...
        if ($t_id <= 0){
            showDialog(L('param_error'),'index.php?app=yydb&wwi=ydblist');
        }
        $model_yydb = Model('yydb');
        //查询模板信息
        $where = array();
        ...
        if(chksubmit()){            
            ...
            if($rs){
               ...
               $upload_model->updatebywhere(array('item_id'=>$prod_info['pgoods_id']),array('upload_type'=>6,'item_id'=>'0','upload_id_in'=>"{$file_idstr}"));
                ...
                showDialog(L('nc_common_save_succ'),'index.php?app=yydb&wwi=yydblist','succ');
            } else {
   ...
   /**
     * 夺宝期数列表
     */
    public function giveoutlistWwi()
    {
        TPL::output('gettype_arr',$this->gettype_arr);
        TPL::output('templateState',$this->templatestate_arr);
		Tpl::setDirquna('shopwwi');/*网 店 运 维mall wwi.com*/
     ...
     * 夺宝期数模板列表XML
     */
    public function giveoutlist_xmlWwi()
    {
        $where = array();
        if ($_REQUEST['advanced']) {
        ...
        foreach ($list as $val) {
            ...
            $o .= "<span class='btn'><em><i class='fa fa-cog'></i>设置 <i class='arrow'></i></em><ul>";
            $o .= "<li><a href='index.php?app=yydb&wwi=ydbedit&tid=".$val['yydb_t_id']."'>编辑信息</a></li>";
            $o .= "<li><a href='index.php?app=yydb&wwi=ydbinfo&tid=".$val['yydb_t_id']."'>查看详细</a></li>";
            $o .= "</ul>";
    ...
    */
    ...
    public function export_step1Wwi(){
        ...
        if (!is_numeric($_GET['curpage'])){
            ...
            if ($count > self::EXPORT_SIZE ){//显示下载链接
                ...
                Tpl::output('murl','index.php?app=yydb&wwi=ydbinfo&tid='.$t_id);
     ...
     * 夺宝图片上传
     */
    public function yydb_pic_uploadWwi(){
        /**
         * 上传图片
         */
        $upload = new UploadFile();
