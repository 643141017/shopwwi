  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="handle-s"><a class="btn red" href="index.php?app=inform&wwi=inform_subject_type_drop&inform_type_id=<?php echo $v['inform_type_id'];?>" onclick="if(confirm('删除后将不能恢复，确认删除这  1 项吗？')){return true;} else {return false;}"><i class="fa fa-trash-o"></i>删除</a></td>
...
<script>
    ...
    function fg_operation(name, grid) {
        if (name == 'add') {
            window.location.href = 'index.php?app=inform&wwi=inform_subject_type_add';
        }
    }
</script> 
