...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=contract&wwi=citemlist" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
	$('#item_form').validate({
        ...
        messages : {
            item_name : {
                required : '<i class="fa fa-exclamation-tyq"></i>项目名称不能为空且不能大于50个字符',
                rangelength : '<i class="fa fa-exclamation-tyq"></i>项目名称不能为空且不能大于50个字符'
            },
            item_cost : {
                required : '<i class="fa fa-exclamation-tyq"></i>保证金应为大于1的数字',
                number : '<i class="fa fa-exclamation-tyq"></i>保证金应为大于1的数字',
                min : '<i class="fa fa-exclamation-tyq"></i>保证金应为大于1的数字'
            },
            <?php if(!$output['item_info']['cti_icon']){?>
            textfield : {
                required : '<i class="fa fa-exclamation-tyq"></i>请添加项目图标'
            },
            <?php }?>
            item_desc : {
                required : '<i class="fa fa-exclamation-tyq"></i>项目描述不能为空且小于200个字符',
                rangelength : '<i class="fa fa-exclamation-tyq"></i>项目描述不能为空且小于200个字符'
            },
            item_sort : {
            	required : '<i class="fa fa-exclamation-tyq"></i>排序应为大于1的正整数',
                digits : '<i class="fa fa-exclamation-tyq"></i>排序应为大于1的正整数',
                min : '<i class="fa fa-exclamation-tyq"></i>排序应为大于1的正整数'
            }
        }
    });
});
