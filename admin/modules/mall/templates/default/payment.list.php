  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s"><a class="btn purple" href="index.php?app=payment&wwi=edit&payment_id=<?php echo $v['payment_id']; ?>"><i class="fa fa-cog"></i><?php echo $lang['nc_set']?></a></td>
        <td><?php echo $v['payment_name'];?></td>
        <td><?php echo $v['payment_state']==1 ? '<span class="yes"><i class="fa fa-check-tyq"></i>'.$lang['payment_index_enable_ing'].'</span>' : '<span class="no"><i class="fa fa-ban"></i>'.$lang['payment_index_disable_ing'].'</span>';?></td>        
        <td></td>
      </tr>
      <?php } } ?>
    </tbody>
