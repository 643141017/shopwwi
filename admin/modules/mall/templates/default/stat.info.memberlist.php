...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=stat_member&wwi=get_member_xml&t=<?php echo $_GET['t'];?>',
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?app=stat_member&wwi=showmember&exporttype=excel&t=<?php echo $_GET['t'];?>';
