...
<script>
$(function(){
    var flexUrl = 'index.php?app=activity&wwi=detail_xml&id=<?php echo $output['activity_detail']['activity_id']; ?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?app=activity&wwi=deal&state=1&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?app=activity&wwi=deal&state=2&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?app=activity&wwi=del_detail&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            }
        ],
...
$("span[data-live-inline-edit='activity_detail_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('index.php?app=activity&wwi=ajax&branch=activity_detail_sort', {
