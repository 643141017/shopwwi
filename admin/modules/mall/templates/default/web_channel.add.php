...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=web_channel" title="返回频道列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3>频道管理 - 新增频道</a></h3>
        <h5>商城的频道及模块内容管理</h5>
      </div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <ul class="home-templates-board-style">
            ...
            <li class="default selected"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_default'];?></li>
          </ul>
          <span class="err"></span>
