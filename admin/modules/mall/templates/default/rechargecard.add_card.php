...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminMall('rechargecard', 'index'); ?>" title="返回平台充值卡列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3>平台充值卡 - 新增</h3>
...
}, "<i class='fa fa-exclamation-tyq'></i>总数必须是1~9999之间的整数");
...
$("#form_add").validate({
    ...
    messages : {
        denomination : {
            required : '<i class="fa fa-exclamation-tyq"></i>请填写面额',
            min : '<i class="fa fa-exclamation-tyq"></i>面额不能小于0.01',
            max: '<i class="fa fa-exclamation-tyq"></i>面额不能大于1000'
        },
        batchflag : {
            maxlength: '<i class="fa fa-exclamation-tyq"></i>请输入20字之内的批次标识'
        }
    }
});
});
