...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=groupbuy&wwi=price_list_xml',
        colModel: [
        ...
        buttons: [
            {
                ...
                title: '添加一条新数据到列表',
                onpress: function() {
                    location.href = 'index.php?app=groupbuy&wwi=price_add';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?app=groupbuy&wwi=price_drop&range_id=' + ids.join(',');
                }
            }
        ],
        usepager: false,
