...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=store_class" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
	...
	$('#store_class_form').validate({
        ...
        rules : {
            sc_name : {
                required : true,
                remote   : {                
                url :'index.php?app=store_class&wwi=ajax_check_name',
                type:'get',
                data:{
                    sc_name : function(){
                        return $('#sc_name').val();
        ...
        messages : {
            sc_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['store_class_name_no_null'];?>',
                remote   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['store_class_name_is_there'];?>'
            },
            sc_sort  : {
                number   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['store_class_sort_only_number'];?>'
            }
        }
    });
});
