  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=pointprod&wwi=pointprod" ><span><?php echo $lang['admin_pointprod_list_title'];?></span></a></li>
...
<script>
$(function() {
    var flexUrl = 'index.php?app=pointprod&wwi=pointorder_list_xml';
