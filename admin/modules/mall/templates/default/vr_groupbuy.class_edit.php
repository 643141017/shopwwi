...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?app=vr_groupbuy&wwi=class_list" title="返回列表">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=vr_groupbuy&wwi=class_edit">
...
$(function(){
    ...
    $('#add_form').validate({
        ...
        messages : {
            class_name: {
                required : "<i class='fa fa-exclamation-tyq'></i>分类名称不能为空",
                maxlength : jQuery.validator.format("分类名称长度最多10个字符")
            },
            class_sort: {
                required : "<i class='fa fa-exclamation-tyq'></i>排序不能为空",
                digits: "<i class='fa fa-exclamation-tyq'></i>排序必须是数字,且数值0-255",
