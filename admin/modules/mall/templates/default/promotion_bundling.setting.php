  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=promotion_bundling&wwi=bundling_list"><?php echo $lang['bundling_list'];?></a></li>
        <li><a href="index.php?app=promotion_bundling&wwi=bundling_quota"><?php echo $lang['bundling_quota'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['bundling_setting'];?></a></li>
      </ul>
    </div>
  </div>
  <form id="add_form" method="post" action="index.php?app=promotion_bundling&wwi=bundling_setting">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
		...
		messages : {
			promotion_bundling_price: {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_price_error'];?>',
				digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_price_error'];?>',
				min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_price_error'];?>'
			},
			promotion_bundling_sum: {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_sum_error'];?>',
				digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_sum_error'];?>'
			},
			promotion_bundling_goods_sum: {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_goods_sum_error'];?>',
				digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_goods_sum_error'];?>',
				min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_goods_sum_error'];?>',
				max : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['bundling_goods_sum_error'];?>'
			}
		}
	});
});
