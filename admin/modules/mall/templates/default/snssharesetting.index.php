  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s">
          <a class="btn blue" href="index.php?app=sns_sharesetting&wwi=edit&state=1&key=<?php echo $k; ?>"><i class="fa fa-pencil-square-o"></i> <?php echo $lang['nc_edit']?></a></td>
        <td><?php echo $v['name'];?></td>
        <td><?php echo $v['url'];?></td>
        <td><?php if($v['isuse'] == '1'){ ?>
          <span class="yes"><i class="fa fa-check-tyq"></i>启用</span>
          <?php }else { ?>
