...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=predeposit&wwi=predeposit" title="返回充值管理列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
  ...
  <form method="post" name="form1" id="form1" action="index.php?app=predeposit&wwi=recharge_edit&id=<?php echo intval($_GET['id']);?>">
...
$(function(){
	...
	$("#form1").validate({
        ...
        messages : {
        	payment_time : {
                required : '<i class="fa fa-exclamation-tyq"></i>请填写付款时间'
            },
            payment_code : {
