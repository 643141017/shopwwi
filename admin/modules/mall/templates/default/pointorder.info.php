...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"> <a class="back" href="<?php echo urlAdminMall('pointprod', 'pointorder_list'); ?>" title="返回列表"> <i class="fa fa-arrow-tyq-o-left"></i> </a>
      <div class="subject">
        <h3>积分兑换 - 兑换详情</h3>
  ...
  <div class="ncap-order-style">
    <div class="ncap-order-flow">
      <ol class="num3">
        <li class="current">
          <h5>提交兑换</h5>
          <i class="fa fa-arrow-tyq-right"></i>
