...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?app=vr_groupbuy&wwi=area_edit">
...
$(document).ready(function(){
    ...
    $('#add_form').validate({
        ...
        messages : {
            area_name: {
                required : '<i class="fa fa-exclamation-tyq"></i>区域名称不能为空'
            },
            area_number:{
                number:'<i class="fa fa-exclamation-tyq"></i>区号必须是数字'
            },
            post:{
                number:'<i class="fa fa-exclamation-tyq"></i>邮编必须是数字'
            }
        }
    });
});
