...
<?php if ($output['store_info']) { ?>
      <a class="back" href="index.php?app=promotion_sole&wwi=sole_quota_list" title="返回套餐列表">
...
<?php } else { ?>
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="<?php echo urlAdminMall('promotion_sole', 'sole_setting');?>"><?php echo $lang['nc_config'];?></a></li>
      </ul>
<?php } ?>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=promotion_sole&wwi=goods_list_xml&store_id=<?php echo $output['store_id']; ?>',
        colModel: [
