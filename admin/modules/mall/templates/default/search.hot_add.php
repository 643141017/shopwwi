...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=search&wwi=hot" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3>热门搜索词 - 设置</h3>
...
$(document).ready(function(){
	$('#search_form').validate({
        ...
        messages : {
            ...
            s_value : {
            	required : '<i class="fa fa-exclamation-tyq"></i>请填写搜索词'
            }
        }
    });
});
