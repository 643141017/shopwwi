  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=sns_malbum&wwi=class_list"><?php echo $lang['snsalbum_class_list'];?></a></li>
...
$(document).ready(function(){
	...
	$('#form_setting').validate({
        ...
        messages : {
        	malbum_max_sum  : {
            	required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['snsalbum_pls_input_figures'];?>',
            	digits   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['snsalbum_pls_input_figures'];?>'
            }
        }
    });
});
