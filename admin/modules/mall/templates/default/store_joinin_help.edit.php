...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=store_joinin&wwi=help_list" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(function(){
	...
	$("#post_form").validate({
        ...
        messages : {
            help_title : {
                required : "<i class='fa fa-exclamation-tyq'></i>类型名称不能为空"
            },
            type_id : {
                required : "<i class='fa fa-exclamation-tyq'></i>请选择帮助类型"
            },
            help_sort  : {
                required : "<i class='fa fa-exclamation-tyq'></i>排序仅可以为数字",
                digits   : "<i class='fa fa-exclamation-tyq'></i>排序仅可以为数字"
            },
            help_url : {
                url : "<i class='fa fa-exclamation-tyq'></i>链接格式不正确"
            },
            content : {
                required : "<i class='fa fa-exclamation-tyq'></i>帮助内容不能为空"
            }
        }
	});
    // 图片上传
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?app=store_joinin&wwi=upload_pic&item_id=<?php echo $output['help']['help_id']?>',
...
function del_file_upload(file_id){
    ...
    $.getJSON('index.php?app=store_joinin&wwi=del_pic&file_id=' + file_id, function(result){
        if(result){
            $('#pic_' + file_id).remove();
        }
    });
