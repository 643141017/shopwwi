      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <ul class="home-templates-board-style">
            <li class="red"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_red'];?></li>
            <li class="pink"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_pink'];?></li>
            <li class="orange"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_orange'];?></li>
            <li class="green"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_green'];?></li>
            <li class="blue"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_blue'];?></li>
            <li class="purple"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_purple'];?></li>
            <li class="brown"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_brown'];?></li>
            <li class="default"><em></em><i class="fa fa-check-tyq"></i><?php echo $lang['web_config_style_default'];?></li>
          </ul>
          <span class="err"></span>
...
$(function(){
	...
	$("#web_form").validate({
        ...
        messages : {
            web_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['web_config_add_name_null'];?>'
            },
            web_sort  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['web_config_sort_int'];?>',
                digits   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['web_config_sort_int'];?>'
            }
        }
	});
});
