...
<div class="page">
  ...
  <form id="ship_form" method="post" name="ship_form" action="index.php?app=pointprod&wwi=order_ship&id=<?php echo $_GET['id']; ?>">
  ...
  <div class='msgdiv'> <?php echo $output['errormsg']; ?> <br>
    <br>
    <a class="forward" href="index.php?app=pointprod&amp;wwi=pointorder_list"><?php echo $lang['admin_pointorder_gobacklist']; ?></a> </div>
  <?php } ?>
</div>
...
$(function(){
	...
	$('#ship_form').validate({
        ...
        messages : {
            shippingcode  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointorder_ship_code_nullerror']; ?>'
            },
            shippingdesc  : {
                required : '<i class="fa fa-exclamation-tyq"></i>请填写发货描述'
            }
        }
    });
});
