...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=contract&wwi=contractlist" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(function(){
    ...
    $('#cost_form').validate({
        ...
        messages : {
            operatetype :{
                required : '<i class="fa fa-exclamation-tyq"></i>请选择增减类型'
            },
            price :{
                required : '<i class="fa fa-exclamation-tyq"></i>金额不能为空且为大于0数字',
                number : '<i class="fa fa-exclamation-tyq"></i>金额不能为空且为大于0数字',
                min : '<i class="fa fa-exclamation-tyq"></i>金额不能为空且为大于0数字'
            },
            clog_desc : {
                required : '<i class="fa fa-exclamation-tyq"></i>原因描述必填且小于200个字符',
                rangelength:'<i class="fa fa-exclamation-tyq"></i>原因描述必填且小于200个字符'
            }
        }
    });
