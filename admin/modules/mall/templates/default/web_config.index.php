  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?app=web_config&wwi=focus_edit"><?php echo '焦点区';?></a></li>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle"><a class="btn purple" href="index.php?app=web_config&wwi=web_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-cog"></i><?php echo $lang['web_config_web_edit'];?></a><a class="btn orange" href="index.php?app=web_config&wwi=code_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-steam"></i><?php echo $lang['web_config_code_edit'];?></a></td>
        ...
        <td><?php echo $v['web_show']==1 ? '<span class="yes"><i class="fa fa-check-tyq"></i>'.$lang['nc_yes'].'</span>' : '<span class="no"><i class="fa fa-ban"></i>'.$lang['nc_no'].'</span>';?></td>
        <td></td>
      </tr>
      <?php } ?>
      <?php }else { ?>
