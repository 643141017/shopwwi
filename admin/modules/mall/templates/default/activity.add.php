...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?app=activity&wwi=activity" title="返回活动列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
        	activity_title: {
        		required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['activity_new_title_null'];?>'
        	},
        	activity_start_date: {
        		required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['activity_new_startdate_null'];?>'
        	},
        	activity_end_date: {
        		required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['activity_new_enddate_null'];?>'
        	},
			activity_banner: {
        		required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['activity_new_banner_null'];?>',
				accept   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['activity_new_ing_wrong'];?>'
			},
        	activity_sort: {
        		required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['activity_new_sort_null'];?>',
        		min:'<i class="fa fa-exclamation-tyq"></i><?php echo $lang['activity_new_sort_minerror'];?>',
        		max:'<i class="fa fa-exclamation-tyq"></i><?php echo $lang['activity_new_sort_maxerror'];?>'
        	}
        }
	});
});
