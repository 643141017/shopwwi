  ...
  <div class="ncap-order-flow">
    <ol class="num5">
      <li  id="state_new" class="">
        ...
        <i class="fa fa-arrow-tyq-right"></i> </li>
...
$(document).ready(function(){
  ...
  <div class="ncap-order-details">
    ...
    <div class="tabs-panels">
      <div class="misc-info">
        <dl>
          <dt><?php echo $lang['order_mall_name'];?><?php echo $lang['nc_colon'];?></dt>
          ...
          <dd><a href="index.php?app=order&wwi=show_order&order_id=<?php echo $output['order_info']['order_id'];?>"> <?php echo $output['order_info']['order_sn'];?></a></dd>
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?app=complain&wwi=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?app=complain&wwi=publish_complain_talk',
                cache:false,
...
function forbit_talk(talk_id) {
        $.ajax({
            type:'POST',
                url:'index.php?app=complain&wwi=forbit_talk',
                cache:false,
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row" id="close_complain">
      ...
      <form method='post' id="verify_form" action="index.php?app=complain&wwi=complain_verify">
    ...
    <form method='post' id="close_form" action="index.php?app=complain&wwi=complain_close">
