...
<div class="page">
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="fa fa-trash"></i><?php echo $lang['nc_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-mallping-cart"></i><?php echo '商品块';?></a></dt>
                <dd>
  ...
  <div class="bot"><a href="index.php?app=web_channel&wwi=html_update&web_id=<?php echo $_GET['web_id'];?>" class="ncap-btn-big ncap-btn-green" id="submitBtn">更新模块内容</a> </div>
</div>
...
<div id="upload_channel_act_dialog" class="upload_channel_act_dialog" style="display:none;">
  <form id="upload_channel_act_form" name="upload_channel_act_form" enctype="multipart/form-data" method="post" action="index.php?app=web_channel&wwi=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
...
<div id="upload_adv_a_dialog" class="upload_adv_a_dialog" style="display:none;">
  <form id="upload_adv_a_form" name="upload_adv_a_form" enctype="multipart/form-data" method="post" action="index.php?app=web_channel&wwi=upload_pic" target="upload_pic">
...
<div id="upload_adv_b_dialog" class="upload_adv_b_dialog" style="display:none;">
  <form id="upload_adv_b_form" name="upload_adv_b_form" enctype="multipart/form-data" method="post" action="index.php?app=web_channel&wwi=upload_pic" target="upload_pic">
...
<div id="upload_adv_c_dialog" class="upload_adv_c_dialog" style="display:none;">
  <form id="upload_adv_c_form" name="upload_adv_c_form" enctype="multipart/form-data" method="post" action="index.php?app=web_channel&wwi=upload_pic" target="upload_pic">
