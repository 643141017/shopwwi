  ...
  <form method="post" name="settingForm" id="settingForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="pointmall_isuse_1" class="cb-enable <?php if($output['list_setting']['pointmall_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_open'];?>"><span><?php echo $lang['nc_open'];?></span></label>
            <label for="pointmall_isuse_0" class="cb-disable <?php if($output['list_setting']['pointmall_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_close'];?>"><span><?php echo $lang['nc_close'];?></span></label>
          ...
          <p class="notic"><?php echo sprintf($lang['open_pointmall_isuse_notice'],"index.php?app=setting&wwi=pointmall_setting");?></p>
        </dd>
      </dl>
      <dl class="row">
