  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="<?php echo urlAdminMall('delivery', 'index');?>" <?php if ($output['sign'] != 'verify') {?>class="current"<?php }?>><?php echo $lang['nc_manage'];?></a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=delivery&wwi=index_xml&sign=<?php echo $output['sign']; ?>',
        colModel: [
