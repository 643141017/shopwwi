...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=servicer_store&wwi=bill_cycle" title="返回<?php echo $lang['manage'];?>列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
  ...
  <h3>设置结算周期</h3>
    ...
    <input type="hidden" name="app" value="servicer_store" />
