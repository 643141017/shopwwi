  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=brand&wwi=brand"><?php echo $lang['nc_manage'];?></a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=brand&wwi=get_xml&type=apply',
        colModel : [
...
function fg_apply(id) {
    ...
    $.getJSON('index.php?app=brand&wwi=brand_apply_set', {id:id}, function(data){
        if (data.state) {
