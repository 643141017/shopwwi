...
//自动加载滚动条
    ...
    $('#attr_form').validate({
        ...
        messages : {
        	attr_name : {
            	required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_edit_type_attr_name_no_null'];?>',
                maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_edit_type_attr_name_max'];?>',
                minlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_edit_type_attr_name_max'];?>'
            },
            attr_sort: {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_edit_type_attr_sort_no_null'];?>',
				digits   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_edit_type_attr_sort_no_digits'];?>'
            }
        }
    });
