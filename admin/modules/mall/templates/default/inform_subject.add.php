...
<div class="page">
  ...
  <br/>
  <form id="add_form" method="post" action="index.php?app=inform&wwi=inform_subject_save">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		inform_subject_content: {
       			required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['inform_subject_add_null'];?>',
       			maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['inform_subject_add_null'];?>'
	    	}
        }
	});
});
