  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?app=domain&wwi=store_domain_list"><?php echo $lang['nc_domain_mall'];?></a></li>
      </ul>
    </div>
  </div>
...
$(document).ready(function(){
	...
	$("#settingForm").validate({
        ...
        messages : {
            subdomain_times  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['domain_times_null'];?>',
                digits   : '<?php echo $lang['domain_times_digits'];?>',
                min    :'<?php echo $lang['domain_times_min'];?>'
            },
            subdomain_length  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['domain_length_tips'];?>',
