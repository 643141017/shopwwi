...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=goods_class&wwi=get_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'update') {
        window.location.href = 'index.php?app=goods_class&wwi=tag_update';
    }
    if (name == 'reset') {
        window.location.href = 'index.php?app=goods_class&wwi=tag_reset';
    }
}
function fg_edit(id) {
    CUR_DIALOG = ajax_form('tag_edit', '编辑TAG', 'index.php?app=goods_class&wwi=tag_edit&id='+id, 640);
}
</script>