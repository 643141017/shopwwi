...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <input type="hidden" name="wwi" value="hotrank" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?app=stat_store&wwi=hotrank_list&type='+type+'&search_sclass='+search_sclass+'&t=<?php echo $output['searchtime'];?>');
}
</script>