...
$(function() {
    ...
    // 行内ajax编辑
    $('span[nc_type="class_sort"]').inline_edit({app: 'promotion_xianshi', wwi: 'class_sort_update'});
    $('span[nc_type="class_name"]').inline_edit({app: 'promotion_xianshi', wwi: 'class_name_update'});
...
function submit_delete(id) {
    if (confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?app=promotion_xianshi&wwi=class_drop');
        $('#class_id').val(id);
        $('#list_form').submit();
    }
}
