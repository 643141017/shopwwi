...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=goods_album&wwi=list" title="返回<?php echo $lang['g_album_list'];?>"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
  ...
  <form method='post' action="index.php" name="picForm" id="picForm">
    ...
    <input type="hidden" name="wwi" value="del_more_pic" />
    <div class="ncap-store-album">
      ...
      <?php }else { ?>
      <div class="no-data"><i class="fa fa-exclamation-tyq"></i><?php echo $lang['nc_no_record'];?></div>
      <?php } ?>
    </div>
    <div class="bot">
...
$(function(){
	...
	$('a[nc_type="delete"]').bind('click',function(){
		...
		cur_note = this;
		$.get("index.php?app=goods_album&wwi=del_album_pic", {'key':$(this).attr('nc_key')}, function(data){
            if (data == 1) {
