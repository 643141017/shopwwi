...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=complain&wwi=complain_setting_save">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		complain_time_limit: {
       			required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['complain_time_limit_error'];?>',
                digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['complain_time_limit_error'];?>'
	    	}
        }
	});
});
