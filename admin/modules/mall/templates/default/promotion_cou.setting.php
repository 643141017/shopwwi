...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=promotion_cou&wwi=cou_setting_save">
...
$(function(){
    ...
    $("#add_form").validate({
        ...
        messages : {
            promotion_cou_price: {
                required : '<i class="fa fa-exclamation-tyq"></i>请输入价格',
                digits : '<i class="fa fa-exclamation-tyq"></i>请输入数字',
                min : '<i class="fa fa-exclamation-tyq"></i>请输入大于或等于0的数字'
            }
        }
    });
});
