...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="<?php echo urlAdminMall('voucher', 'pricelist'); ?>" title="返回列表">
        <i class="fa fa-arrow-tyq-o-left"></i>
      </a>
      <div class="subject">
        <h3>店铺代金券 - 面额设置</h3>
  ...
  <form id="add_form" method="post" action="index.php?app=voucher&wwi=<?php echo $output['menu_key']; ?>">
...
$(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		voucher_price_describe: {
       			required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_price_describe_error'];?>',
       			maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_price_describe_lengtherror'];?>'
	    	},
	    	voucher_price: {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_price_error'];?>',
                digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_price_error'];?>',
                min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_price_error'];?>'
		    },
		    voucher_points: {
		    	digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_price_points_error'];?>'
            }
        }
	});
});
