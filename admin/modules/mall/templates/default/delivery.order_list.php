...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminMall('delivery', 'index');?>" title="返回<?php echo $lang['nc_manage'];?>列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=delivery&wwi=order_list_xml&dlyp_id=<?php echo $output['dlyp_id']; ?>',
        colModel: [
