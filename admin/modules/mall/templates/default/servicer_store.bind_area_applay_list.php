...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>此处可以对服务商新申请的服务区域进行 审核/删除 操作。</li>
    </ul>
  </div>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?app=servicer_store&wwi=get_bind_area_applay_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
    });

    // 高级搜索重置
    $('#ncreset').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?app=servicer_store&wwi=get_bind_area_applay_xml'}).flexReload();
        $("#formSearch")[0].reset();
    });
    $("#flexigrid").flexigrid({
        url: 'index.php?app=servicer_store&wwi=get_bind_area_applay_xml',
        colModel : [
            ...
            {display: '服务区域', name : 'class', width: 400, sortable : false, align : 'left'}
            ],
        searchitems : [
