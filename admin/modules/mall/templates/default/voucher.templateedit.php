...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?app=voucher&wwi=templateedit">
...
$(function(){
	...
	$("#add_form").validate({
	    ...
	    messages : {
	    	points: {
	    		required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_template_points_error'];?>',
		    	digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_template_points_error'];?>'
	        }
	    }
	});
