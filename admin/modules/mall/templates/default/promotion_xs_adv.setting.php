    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <label title="<?php echo $lang['tyq_setting_adv_url_address'];?>" class="ml5"><i class="fa fa-link"></i><input class="input-txt ml5" type="text" name="adv_url1" value="<?php echo $output['list'][1]['url'];?>" placeholder="请输入广告连接地址" /></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
         ...
         <label title="<?php echo $lang['tyq_setting_adv_url_address'];?>" class="ml5"><i class="fa fa-link"></i><input class="input-txt ml5" type="text" name="adv_url2" value="<?php echo $output['list'][2]['url'];?>" placeholder="请输入广告连接地址" /></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <label title="<?php echo $lang['tyq_setting_adv_url_address'];?>" class="ml5"><i class="fa fa-link"></i><input class="input-txt ml5" type="text" name="adv_url3" value="<?php echo $output['list'][3]['url'];?>" placeholder="请输入广告连接地址" /></label>
          <p class="notic">请使用宽度590像素，高度240像素的jpg/gif/png格式图片作为幻灯片banner上传，<br/>如需跳转请在后方添加以http://开头的链接地址。</p>
        </dd>
      </dl>
