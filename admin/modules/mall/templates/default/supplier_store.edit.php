...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=supplier_store&wwi=store" title="返回<?php echo $lang['manage'];?>列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
  ...
  <h3>编辑店铺信息</h3>
    ...
    <form id="store_form" method="post">
      ...
      <div class="ncap-form-default">
        ...
        <dl class="row">
          <dt class="tit">
            <label for="ssg_id"> <?php echo $lang['supplier_belongs_level'];?> </label>
          </dt>
          <dd class="opt">
    ...
    <form id="joinin_form" enctype="multipart/form-data" method="post" action="index.php?app=supplier_store&wwi=edit_save_joinin" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
...
$(function(){
    ...
    $('#store_form').validate({
        ...
        messages : {
            store_name: {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['please_input_store_name'];?>',
