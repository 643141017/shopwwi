  ...
  <div class="fixed-bar">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
            <input type="text" onclick="oCopy(this)" value="<?php echo MALL_SITE_URL.DS;?>index.php?app=redpacket&wwi=getredpacket&tid=<?php echo $output['t_info']['rpacket_t_id'];?>" readonly class='w350'/>
<script>
	function oCopy(obj){
		obj.select();
...
<script>
$(function(){
    var flexUrl = 'index.php?app=redpacket&wwi=rplist_xml&tid=<?php echo $output['t_info']['rpacket_t_id'];?>&gtype=<?php echo $output['t_info']['rpacket_t_gettype_key'];?>';
...
function fg_csv(ids) {
    id = ids.join(',');
    window.location.href = 'index.php?app=redpacket&wwi=export_step1&tid=<?php echo $output['t_info']['rpacket_t_id'];?>&rid=' + id;
}
</script>