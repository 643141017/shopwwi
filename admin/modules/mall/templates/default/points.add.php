  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=points&wwi=pointslog"><?php echo $lang['admin_points_log_title']?></a></li>
        <li><a href="index.php?app=points&wwi=setting">规则设置</a></li>
...
function checkmember(){
	...
	$.getJSON("index.php?app=points&wwi=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
...
$(function(){
    ...
    $('#points_form').validate({
        ...
        messages : {
			member_name: {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_points_addmembername_error'];?>'
			},
			member_id : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_points_member_error_again'];?>'
            },
            pointsnum  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_points_points_null_error']; ?>',
                min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_points_points_min_error']; ?>'
            }
        }
    });
});
