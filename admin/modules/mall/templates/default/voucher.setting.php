...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?app=voucher&wwi=setting">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
        	promotion_voucher_price: {
       			required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_price_error'];?>',
       			digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_price_error'];?>',
                min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_price_error'];?>'
	    	},
	    	promotion_voucher_storetimes_limit: {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_storetimes_error'];?>',
                digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_storetimes_error'];?>',
                min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_storetimes_error'];?>'
            },
            promotion_voucher_buyertimes_limit: {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_buyertimes_error'];?>',
                digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_buyertimes_error'];?>',
                min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_voucher_setting_buyertimes_error'];?>'
            }
        }
	});
});
