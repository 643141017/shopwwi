  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?app=promotion_bundling&wwi=bundling_setting"><?php echo $lang['bundling_setting'];?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
<script>
$(function(){
    var flexUrl = 'index.php?app=promotion_bundling&wwi=bundling_list_xml';
