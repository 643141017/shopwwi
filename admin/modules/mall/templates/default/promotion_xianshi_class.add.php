...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?app=promotion_xianshi&wwi=class_list" title="返回列表">
  ...
  <form id="add_form" method="post" action="index.php?app=promotion_xianshi&wwi=class_save">
...
$(document).ready(function(){
	...
	$('#add_form').validate({
        ...
        messages : {
            input_class_name: {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['class_name_error'];?>'
            },
            input_sort: {
                number   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['sort_error'];?>'
            }
        }
    });
});
