  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=domain&wwi=store_domain_setting"><?php echo $lang['nc_config'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['nc_domain_mall'];?></a></li>
      </ul>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=domain&wwi=get_xml',
        colModel : [
