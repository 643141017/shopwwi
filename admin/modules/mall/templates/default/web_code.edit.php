...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=web_config&wwi=web_config" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
  ...
  <div class="ncap-form-all">
    <div class="title">
      ...
      <a href="index.php?app=web_config&wwi=web_edit&web_id=<?php echo $output['web_array']['web_id'];?>">设置该板块色彩</a> </div>
    <dl class="row">
      <dt class="tit">
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="fa fa-trash"></i><?php echo $lang['nc_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-mallping-cart"></i><?php echo '商品块';?></a> <a href="JavaScript:show_recommend_pic_dialog(<?php echo $key;?>);"><i class="icon-lightbulb"></i><?php echo '广告块';?></a> </dt>
                <dd>
                  ...
                  <div class="middle-banner"> 
                  	<a href="javascript:void(0);" class="wwi-hd-a">
...
<a href="javascript:void(0);" class="wwi-hd-b">
                  <img pic_url="<?php echo $val['pic_list']['11']['pic_url'];?>" title="<?php echo $val['pic_list']['11']['pic_name'];?>" stitle="<?php echo $val['pic_list']['11']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['11']['pic_img'];?>"/></a> <a href="javascript:void(0);" class="wwi-hd-c">
                  ...
                  <a href="javascript:void(0);" class="wwi-hdd-a">
                  ...
                  <a href="javascript:void(0);" class="wwi-hdd-b">
  ...
  <div class="bot"><a href="index.php?app=web_config&wwi=web_html&web_id=<?php echo $_GET['web_id'];?>" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['web_config_web_html'];?></a> </div>
</div>
...
<div id="upload_tit_dialog" style="display:none;">
  ...
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&wwi=upload_pic" target="upload_pic">
...
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  ...
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&wwi=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
...
<div id="recommend_pic_dialog" style="display:none;">
  ...
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&wwi=recommend_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
...
<a recommend_pic_id="14" href="javascript:void(0);" class="wwi-hd-a">
	<img pic_url="<?php echo $val['pic_list']['14']['pic_url'];?>" title="<?php echo $val['pic_list']['14']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['14']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['14']['pic_img'];?>" stitle="<?php echo $val['pic_list']['14']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['14']['pic_sname'];?>"/></a>
          <a recommend_pic_id="11" href="javascript:void(0);" class="wwi-hd-b">
          ...
          <a recommend_pic_id="12" href="javascript:void(0);" class="wwi-hd-c">
          ...
          <a recommend_pic_id="21" href="javascript:void(0);" class="wwi-hdd-a">
          ...
          <a recommend_pic_id="24" href="javascript:void(0);" class="wwi-hdd-b">
...
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
  ...
  <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&wwi=slide_adv" target="upload_pic">
