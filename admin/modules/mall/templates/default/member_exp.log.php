  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?app=member_exp&wwi=expsetting">规则设置</a></li>
        <li><a href="index.php?app=member_exp&wwi=member_grade">等级设定</a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=member_exp&wwi=get_xml',
        colModel : [
