...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=type&wwi=type" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        ...
        <dd class="opt">
          ...
          <div id="spec_div" class="scrollbar-box">
            <div class="ncap-type-spec-list">
              ...
              <?php }?>
              <?php }else{?>
              <div><?php echo $lang['type_add_spec_null_one'];?><a href="JavaScript:void(0);" onclick="window.parent.openItem('mall|spec')"><?php echo $lang['nc_spec_manage'];?></a><?php echo $lang['type_add_spec_null_two']?></div>
              <?php }?>
            </div>
          </div>
        </dd>
        ...
        <dd class="opt">
          ...
          <div id="brand_div" class="scrollbar-box">
            <div class="ncap-type-spec-list">
              ...
              <?php }?>
              <?php }else{?>
              <div><?php echo $lang['type_add_brand_null_one'];?><a href="JavaScript:void(0);" onclick="window.parent.openItem('mall|brand')"><?php echo $lang['nc_brand_manage'];?></a><?php echo $lang['type_add_brand_null_two']?></div>
              <?php }?>
            </div>
          </div>
        </dd>
        ...
        <dd class="opt">
          <ul class="ncap-ajax-add" id="ul_attr">
            ...
            <li>
              ...
              <label><a href="javascript:void(0);" onclick="ajax_form('attr_deit', '编辑属性', '<?php echo urlAdminMall('type', 'attr_edit', array('attr_id' => $aval['attr_id']));?>', 640)" class="ncap-btn"><?php echo $lang['nc_edit'];?></a></label>
            </li>
            <?php }?>
            <?php }?>
...
$(function(){
    ...
    $('#type_form').validate({
        ...
        messages : {
            t_mane : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_add_name_no_null'];?>',
                maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_add_name_max'];?>',
                minlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_add_name_max'];?>'
            },
            t_sort: {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_add_sort_no_null'];?>',
                digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['type_add_sort_no_digits'];?>'
            }
        }
    });
