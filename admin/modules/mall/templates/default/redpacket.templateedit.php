...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=redpacket&wwi=rptlist" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3>平台红包 - 编辑红包模板</h3>
        <h5>平台红包新增与管理</h5>
      </div>
        ...
        if($("#rpt_form").valid()){
        	...
        	if(choose_gettype == 'pwd'){
            	...
            	if(template_total > 10000){
            		...
            		$("#rpt_total").parent('dd').children('span.err').append('<label for="rpt_total" class="error"><i class="fa fa-exclamation-tyq"></i>领取方式为卡密兑换的红包，发放总数不能超过10000张</label>');
            		return false;
                }
            }
            $("#rpt_form").submit();
...
$(document).ready(function(){
	...
	$('#rpt_form').validate({
        ...
        messages : {
        	rpt_title : {
                required : '<i class="fa fa-exclamation-tyq"></i>模版名称不能为空且小于50个字符',
                rangelength : '<i class="fa fa-exclamation-tyq"></i>模版名称不能为空且小于50个字符'
            },
            rpt_gettype : {
                required : '<i class="fa fa-exclamation-tyq"></i>请选择领取方式'
            },
            rpt_sdate : {
            	required : '<i class="fa fa-exclamation-tyq"></i>请选择有效期'
            },
            rpt_edate : {
            	required : '<i class="fa fa-exclamation-tyq"></i>请选择有效期'
            },
            rpt_price : {
                required : '<i class="fa fa-exclamation-tyq"></i>面额不能为空且为大于1的整数',
                digits : '<i class="fa fa-exclamation-tyq"></i>面额不能为空且为大于1的整数',
                min: '<i class="fa fa-exclamation-tyq"></i>面额不能为空且为大于1的整数'
            },
            rpt_points : {
            	checkpoints : '<i class="fa fa-exclamation-tyq"></i>兑换所需积分不能为空且为大于1的整数'
            },
            rpt_total  : {
            	required : '<i class="fa fa-exclamation-tyq"></i>可发放数量不能为空且为大于1的整数',
                digits : '<i class="fa fa-exclamation-tyq"></i>可发放数量不能为空且为大于1的整数',
                min: '<i class="fa fa-exclamation-tyq"></i>可发放数量不能为空且为大于1的整数'
            },
            rpt_orderlimit : {
            	required : '<i class="fa fa-exclamation-tyq"></i>模版使用消费限额不能为空且必须是数字',
                number : '<i class="fa fa-exclamation-tyq"></i>模版使用消费限额不能为空且必须是数字'
            },
            rpt_desc : {
            	required : '<i class="fa fa-exclamation-tyq"></i>模版描述不能为空且小于200个字符',
            	rangelength:'<i class="fa fa-exclamation-tyq"></i>模版描述不能为空且小于200个字符'
            }
        },
        groups : {
