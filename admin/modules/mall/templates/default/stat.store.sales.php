...
function getTrends(storeid){
	var s_type = $("#search_type").val();
	$('#stattrends').load('index.php?app=stat_store&wwi=storesales_trends&storeid='+storeid+'&search_type='+s_type+'&'+$("#formSearch").serialize());
}
function update_flex(){
    $('#stattrends').html('');
    $("#flexigrid").flexigrid({
        url: 'index.php?app=stat_store&wwi=get_storesales_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?app=stat_store&wwi=storesales_list';
