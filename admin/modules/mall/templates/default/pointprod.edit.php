...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"> <a class="back" href="<?php echo urlAdminMall('pointprod', 'index'); ?>" title="返回列表"> <i class="fa fa-arrow-tyq-o-left"></i> </a>
      <div class="subject">
      ...
      <dl class="row">
        ...
        <dd class="opt" id="divComUploadContainer">
          ...
          <div id="thumbnails" class="ncap-thumb-list">
            <h5><i class="fa fa-exclamation-tyq"></i>上传后的图片可以插入到富文本编辑器中使用，无用附件请手动删除，如不处理系统会始终保存该附件图片。</h5>
            <ul>
...
//
    $('#pointprod_form').validate({
        ...
        messages : {
        	goodsname  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_goodsname_error']; ?>'
            },
            goodsprice : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_goodsprice_null_error']; ?>',
                number   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_goodsprice_number_error']; ?>',
                min     : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_goodsprice_number_error']; ?>'
            },
            goodspoints : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_goodspoint_null_error']; ?>',
				digits     : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_goodspoint_number_error']; ?>',
				min		   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_goodspoint_number_error']; ?>'
            },
            goodsserial:{
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_goodsserial_null_error']; ?>'
            },
            goodsstorage : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_storage_null_error']; ?>',
				digits  : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_storage_number_error']; ?>'
            },
            limitnum : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_limitnum_error']; ?>',
				digits  : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_limitnum_digits_error']; ?>',
				min		: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_limitnum_digits_error']; ?>'
            },
            starttime  : {
            	required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_limittime_null_error']; ?>'
            },
            endtime  : {
            	required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_limittime_null_error']; ?>'
            },
            sort : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_sort_null_error']; ?>',
				digits  : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_sort_number_error']; ?>',
				min		: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_pointprod_add_sort_number_error']; ?>'
            }
        }
    });
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?app=pointprod&wwi=pointprod_pic_upload&item_id=<?php echo $output['prod_info']['pgoods_id']; ?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('index.php?app=pointprod&wwi=ajaxdelupload&file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
