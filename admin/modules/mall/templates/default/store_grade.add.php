...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=store_grade&wwi=store_grade" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
	...
	$('#grade_form').validate({
        ...
        rules : {
            sg_name : {
                required : true,
                remote   : {
                url :'index.php?app=store_grade&wwi=ajax&branch=check_grade_name',
                type:'get',
                data:{
                        sg_name : function(){
                        	return $('#sg_name').val();
            ...
            sg_sort : {
                ...
                digits  : true,
                remote   : {
	                url :'index.php?app=store_grade&wwi=ajax&branch=check_grade_sort',
	                type:'get',
	                data:{
	                        sg_sort : function(){
	                        	return $('#sg_sort').val();
        ...
        messages : {
            sg_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['store_grade_name_no_null'];?>',
                remote   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['now_store_grade_name_is_there'];?>'
            },
			sg_price : {
                required  : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['charges_standard_no_null'];?>',
                number : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['charges_standard_no_null'];?>',
                min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['charges_standard_no_null'];?>'
            },
            sg_goods_limit : {
                digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['only_lnteger'];?>'
            },
            sg_space_limit : {
                digits  : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['only_lnteger'];?>'
            },
            sg_sort  : {
            	required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['grade_add_sort_null_error']; //级别信息不能为空?>',
                digits   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['only_lnteger'];?>',
                remote   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['add_gradesortexist']; //级别已经存在?>'
            }
        }
    });
});
