...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=supplier_store&wwi=bill_cycle" title="返回<?php echo $lang['manage'];?>列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
  ...
  <h3>设置结算周期</h3>
    ...
    <input type="hidden" name="app" value="supplier_store" />
    <input type="hidden" name="wwi" value="bill_cycle_edit" />
...
$(function(){
    ...
    $('#store_form').validate({
        ...
        messages : {
        	bill_cycle: {
            	digits : '<i class="fa fa-exclamation-tyq"></i>请正确输入结算周期',
            	max   : '<i class="fa fa-exclamation-tyq"></i>结算周期不得大于180天',
            	min   : '<i class="fa fa-exclamation-tyq"></i>结算周期不得小于1天'
            }
        }
    });
});
