...
<div class="page">
  ...
  <form id="post_form" method="post" action="index.php?app=return&wwi=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
      ...
      <dl class="row">
        ...
        <dd class="opt"><?php echo ncPriceFormat($output['order']['pay_amount']);?></dd>
          ...
          <dl class="row">
            <dt class="tit"></dt>
            <dd class="opt">
                <a href="<?php echo ADMIN_SITE_URL;?>/index.php?app=refund&wwi=alipay&refund_id=<?php echo $output['return']['refund_id']; ?>" target="_blank">支付宝退款</a>  
...
$(function(){
	...
	$("#wxpayBtn").click(function(){
	    var ajaxurl = "<?php echo ADMIN_SITE_URL;?>/index.php?app=refund&wwi=wxpay&refund_id=<?php echo $output['return']['refund_id']; ?>";
		show_msg(ajaxurl);
	});
	$("#alipayBtn").click(function(){
	    var ajaxurl = "<?php echo ADMIN_SITE_URL;?>/index.php?app=refund&wwi=get_detail&refund_id=<?php echo $output['return']['refund_id']; ?>";
		show_msg(ajaxurl);
	});
    $('#post_form').validate({
