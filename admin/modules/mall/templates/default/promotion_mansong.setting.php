...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=promotion_mansong&wwi=mansong_setting_save">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		promotion_mansong_price: {
       			required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['mansong_price_error'];?>',
       			digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['mansong_price_error'];?>',
                min : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['mansong_price_error'];?>'
            }
        }
	});
});
