...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?app=groupbuy&wwi=price_save">
...
$(document).ready(function(){
	...
	$('#add_form').validate({
        ...
        messages : {
            range_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['range_name_error'];?>'
            },
            range_start : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['range_start_error'];?>',
                digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['range_start_error'];?>'
            },
            range_end : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['range_end_error'];?>',
                digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['range_end_error'];?>'
            }
        }
    });
});
