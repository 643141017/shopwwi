...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=store&wwi=store" title="返回<?php echo $lang['manage'];?>列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
  ...
  <h3>编辑店铺信息</h3>
    ...
    <form id="joinin_form" enctype="multipart/form-data" method="post" action="index.php?app=store&wwi=edit_save_joinin" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
