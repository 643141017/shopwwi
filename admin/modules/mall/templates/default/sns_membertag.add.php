...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=sns_member" title="返回会员标签列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(function(){
	...
	$('#membertag_form').validate({
        ...
        messages : {
        	membertag_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['sns_member_tag_name_null_error'];?>',
                maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['sns_member_tag_maxlength_error'];?>'
            },
            membertag_sort : {
            	digits   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['sns_member_tag_sort_error'];?>'
            },
            membertag_desc :{
				maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['sns_member_tag_desc_max_error'];?>'
            }
        }
    });
});
