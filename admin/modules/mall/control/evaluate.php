...
class evaluateControl extends SystemControl{
    private $links = array(
            array('url'=>'app=evaluate&wwi=evalgoods_list','text'=>'来自买家的评价'),
            array('url'=>'app=evaluate&wwi=evalstore_list','text'=>'店铺动态评价')
    );
    public function __construct() {
        parent::__construct();
        Language::read('evaluate');
        if ($_GET['wwi'] == 'index') $_GET['wwi'] = 'evalgoods_list';
        Tpl::output('top_link',$this->sublink($this->links,$_GET['wwi']));
    }

    public function indexWwi() {
        $this->evalgoods_listWwi();
    }

    /**
     * 商品来自买家的评价列表
     */
    public function evalgoods_listWwi() {
						//网 店 运 维mall wwi.com
		Tpl::setDirquna('mall');
     ...
     * 删除商品评价
     */
    public function evalgoods_delWwi() {
     ...
     * 店铺动态评价列表
     */
    public function evalstore_listWwi() {
						//网 店 运 维mall wwi.com
		Tpl::setDirquna('mall');
     ...
     * 删除店铺评价
     */
    public function evalstore_delWwi() {
