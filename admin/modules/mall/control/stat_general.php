...
class stat_generalControl extends SystemControl{
    private $links = array(
        array('url'=>'app=stat_general&wwi=general','lang'=>'stat_generalindex'),
        array('url'=>'app=stat_general&wwi=setting','lang'=>'stat_goodspricerange'),
        array('url'=>'app=stat_general&wwi=orderprange','lang'=>'stat_orderpricerange')
    );
