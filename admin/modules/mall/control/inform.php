...
class informControl extends SystemControl{
    private $links = array(
            array('url'=>'app=inform&wwi=inform_list','text'=>'未处理'),
            array('url'=>'app=inform&wwi=inform_handled_list','text'=>'已处理'),
            array('url'=>'app=inform&wwi=inform_subject_type_list','text'=>'类型设置'),
            array('url'=>'app=inform&wwi=inform_subject_list','text'=>'主题设置')
    );
    public function __construct(){
        parent::__construct();
        Language::read('inform');
        if ($_GET['wwi'] == 'index') $_GET['wwi'] = 'inform_list';
     ...
     * 已处理的举报列表
     */
    public function inform_handled_listWwi(){
		Tpl::setDirquna('mall');/*网 店 运 维mall wwi.com*/
        Tpl::showpage('inform.list');
    }
    ...
    public function get_xmlWwi(){
        ...
        if ($inform_list && is_array($inform_list)) {
            ...
            foreach ($inform_list as $k => $v){
                ...
                $list['operation'] = "<a class=\"btn orange\" href=\"index.php?app=inform&wwi=show_handle_page&inform_id={$v['inform_id']}&inform_goods_name={$v['inform_goods_name']}\"><i class=\"fa fa-gavel\"></i>处理</a>";
                } else {
                    $list['operation'] = '--';
                }
     ...
     * 举报类型列表
     */
    public function inform_subject_type_listWwi() {
     ...
     * 举报主题列表
     */
    public function inform_subject_listWwi(){
     ...
     * 添加举报类型页面
     */
    public function inform_subject_type_addWwi(){
Tpl::setDirquna('mall');/*网 店 运 维mall wwi.com*/
     ...
     * 保存添加的举报类型
     */
    public function inform_subject_type_saveWwi(){
        ...
        if ($error != ''){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?app=inform&wwi=inform_subject_type_list');
        }
    }
     ...
     * 删除举报类型,伪删除只是修改标记
     */
    public function inform_subject_type_dropWwi(){
        ...
        showMessage(Language::get('nc_common_del_succ'),'index.php?app=inform&wwi=inform_subject_type_list');
     ...
     * 添加举报主题页面
     */
    public function inform_subject_addWwi(){
     ...
     * 保存添加的举报主题
     */
    public function inform_subject_saveWwi(){
        ...
        if ($error != ''){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?app=inform&wwi=inform_subject_list');
        }
    }
     ...
     * 删除举报主题,伪删除只是修改标记
     */
    public function inform_subject_dropWwi(){
        ...
        showMessage(Language::get('nc_common_del_succ'),'index.php?app=inform&wwi=inform_subject_list');
    }

    /*
     * 显示处理举报
     */
    public function show_handle_pageWwi() {
     ...
     * 处理举报
     */
    public function inform_handleWwi(){
        ...
        if($model_inform->updateInform($update_array,$where_array)) {
            ...
            showMessage(Language::get('nc_common_op_succ'),'index.php?app=inform&wwi=inform_list');
        }
        else {
