...
class promotion_bundlingControl extends SystemControl{
     ...
     * 套餐管理
     */
    public function bundling_quotaWwi()
    {
     ...
     * 套餐管理XML
     */
    public function bundling_quota_xmlWwi()
    {
        $condition = array();
     ...
     * 活动管理XML
     */
    public function bundling_list_xmlWwi()
    {
        $condition = array();
     ...
     * 设置
     */
    public function bundling_settingWwi() {
        // 实例化模型
        $model_setting = Model('setting');
     ...
     * 删除套餐活动
     */
    public function del_bundlingWwi() {
