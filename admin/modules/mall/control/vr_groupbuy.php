...
class vr_groupbuyControl extends SystemControl
{
    ...
    public function class_addWwi()
    {
        if (chksubmit()) { //添加虚拟团购分类
            ...
            if ($res) {
                ...
                $url = array(
                    array(
                        'url'=>'index.php?app=vr_groupbuy&wwi=class_add&parent_class_id='.$params['parent_class_id'],
                        'msg'=>'继续添加',
                    ),
                    array(
                        'url'=>'index.php?app=vr_groupbuy&wwi=class_list',
                        'msg'=>'返回列表',
                    )
                );
                showMessage('添加成功', $url);
            } else {
                showMessage('添加失败', 'index.php?app=vr_groupbuy&wwi=class_list', '', 'error');
            }
        }
    ...
    public function class_editWwi()
    {
        if (chksubmit()) {
            ...
            if ($res) {
                ...
                showMessage('编辑成功', 'index.php?app=vr_groupbuy&wwi=class_list', '', 'succ');
            } else {
                showMessage('编辑失败', 'index.php?app=vr_groupbuy&wwi=class_list', '', 'error');
            }
        }
    ...
    public function class_delWwi()
    {
        ...
        showMessage('删除成功', 'index.php?app=vr_groupbuy&wwi=class_list', '', 'succ');
    }
     ...
     * 区域列表XML
     */
    public function area_list_xmlWwi()
    {
        $condition = array();
...
<span class="btn">
  ...
  <ul>
    <li><a href="index.php?app=vr_groupbuy&wwi=area_edit&area_id={$val['area_id']}">编辑区域</a></li>
    <li><a  href="index.php?app=vr_groupbuy&wwi=area_view&parent_area_id={$val['area_id']}">下级区域</a></li>
  </ul>
</span>
EOB;
            ...
            if ($val['hot_city'] == '1') {
                $i['hot_city'] = '<span class="yes"><i class="fa fa-check-tyq"></i>是</span>';
            } else {
    ...
    public function area_addWwi()
    {
        if (isset($_POST) && !empty($_POST)) {
            ...
            if ($res) {
                ...
                showMessage('添加成功','index.php?app=vr_groupbuy&wwi=area_list','','succ');
            } else {
                showMessage('添加失败','index.php?app=vr_groupbuy&wwi=area_list','','error');
            }
        }
    ...
    public function area_editWwi()
    {
        if (isset($_POST) && !empty($_POST)) {
            ...
            if ($res) {
                ...
                showMessage('编辑成功', 'index.php?app=vr_groupbuy&wwi=area_list', '', 'succ');
            } else {
                showMessage('编辑失败', 'index.php?app=vr_groupbuy&wwi=area_list', '', 'error');
            }
        }
     ...
     * 查看商区
     */
    public function area_streetWwi()
    {
        //获取区域信息
        $model = Model();
    ...
    public function area_dropWwi()
    {
        ...
        if ($res) {
            ...
            showMessage('删除成功','index.php?app=vr_groupbuy&wwi=area_list','','succ');
        } else {
            showMessage('删除失败','index.php?app=vr_groupbuy&wwi=area_list','','error');
        }
    }
