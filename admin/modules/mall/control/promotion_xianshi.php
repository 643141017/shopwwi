...
class promotion_xianshiControl extends SystemControl{
     ...
     * 活动列表
     */
    public function xianshi_listWwi()
    {
     ...
     * 活动列表
     */
    public function xianshi_list_xmlWwi()
    {
        $condition = array();
     ...
     * 限时折扣活动取消
     **/
    public function xianshi_cancelWwi() {
     ...
     * 限时折扣活动删除
     **/
    public function xianshi_delWwi() {
        $xianshi_id = intval($_REQUEST['xianshi_id']);
        $model_xianshi = Model('p_xianshi');
     ...
     * 推荐
     */
    public function xianshi_recWwi()
    {
     ...
     * 活动详细信息
     **/
    public function xianshi_detailWwi() {
     ...
     * 套餐管理
     */
    public function xianshi_quotaWwi()
    {
     ...
     * 套餐管理XML
     */
    public function xianshi_quota_xmlWwi()
    {
        $condition = array();
    ...
    public function class_saveWwi() {
        ...
        if(empty($class_id)) {
            ...
            if ($class_id = $model_xianshi_class->save($param)) {
                ...
                showMessage(新增成功,'index.php?app=promotion_xianshi&wwi=class_list');
            }
            else {
                showMessage(新增失败,'index.php?app=promotion_xianshi&wwi=class_list');
            }
        }
        else {
            //编辑
            if($model_xianshi_class->updates($param,array('class_id'=>$class_id))) {
                ...
                showMessage('编辑成功','index.php?app=promotion_xianshi&wwi=class_list');
            }
            else {
                showMessage('编辑失败','index.php?app=promotion_xianshi&wwi=class_list');
            }
        }
   ...
   public function class_sort_updateWwi()
     ...
     * 设置
     **/
    public function xianshi_settingWwi() {
    ...
    public function xianshi_setting_saveWwi() {
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'xianshi_list'=>array('menu_type'=>'link','menu_name'=>Language::get('xianshi_list'),'menu_url'=>'index.php?app=promotion_xianshi&wwi=xianshi_list'),
            'xianshi_detail'=>array('menu_type'=>'link','menu_name'=>Language::get('xianshi_detail'),'menu_url'=>'index.php?app=promotion_xianshi&wwi=xianshi_detail'),
            'xianshi_quota'=>array('menu_type'=>'link','menu_name'=>Language::get('xianshi_quota'),'menu_url'=>'index.php?app=promotion_xianshi&wwi=xianshi_quota'),
            'xianshi_setting'=>array('menu_type'=>'link','menu_name'=>Language::get('xianshi_setting'),'menu_url'=>'index.php?app=promotion_xianshi&wwi=xianshi_setting'),
            'adv_manage'=>array('menu_type'=>'link','menu_name'=>'淘特卖幻灯','menu_url'=>'index.php?app=promotion_xianshi&wwi=adv_manage'),
            'class_list'=>array('menu_type'=>'link','menu_name'=>'淘特卖分类','menu_url'=>'index.php?app=promotion_xianshi&wwi=class_list'),
        );
