...
class refundControl extends SystemControl{
    ...
    private $links = array(
            ...
            array('url'=>'app=refund&wwi=refund_all','text'=>'所有记录'),
            array('url'=>'app=refund&wwi=reason','text'=>'退款退货原因')
    );
     ...
     * 待处理列表
     */
    public function get_manage_xmlWwi() {
        $model_refund = Model('refund_return');
        $condition = array();
        ...
        foreach ($refund_list as $k => $refund_info) {
            $list = array();
            $list['operation'] = "<a class=\"btn orange\" href=\"index.php?app=refund&wwi=edit&refund_id={$refund_info['refund_id']}\"><i class=\"fa fa-gavel\"></i>处理</a>";
     ...
     * 所有记录
     */
    public function get_all_xmlWwi() {
        $model_refund = Model('refund_return');
        $condition = array();
    ...
    public function editWwi() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?app=refund&wwi=index');
            } else {
                showMessage(Language::get('nc_common_save_fail'));
            }
        }
    ...
    public function add_reasonWwi() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?app=refund&wwi=reason');
            } else {
                showMessage(Language::get('nc_common_save_fail'));
            }
        }
     ...
     *
     */
    public function edit_reasonWwi() {
        $model_refund = Model('refund_return');
        $condition = array();
    ...
    public function del_reasonWwi() {
        ...
        if ($state) {
            ...
            showMessage(Language::get('nc_common_del_succ'),'index.php?app=refund&wwi=reason');
        } else {
