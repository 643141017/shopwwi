...
class activityControl extends SystemControl{
     ...
     * 活动列表/删除活动XML
     */
    public function activity_xmlWwi()
    {
        $condition = array();
        ...
        foreach ($list as $val) {
            ...
            if ($val['activity_state'] == 0 || $val['activity_end_date'] < time()) {
                $o .= '<a class="btn red confirm-del-on-click" href="javascript:;" data-href="index.php?app=activity&wwi=del&activity_id=' .
                    $val['activity_id'] .
            ...
            $o .= '<li><a href="index.php?app=activity&wwi=edit&activity_id=' .
                    $val['activity_id'] .
                    '">编辑活动</a></li>';

            $o .= '<li><a href="index.php?app=activity&wwi=detail&id=' .
                $val['activity_id'] .
                '">处理申请</a></li>';
...
EOB;
    ...
    public function newWwi(){
        ...
        if($result){
            ...
            showMessage(Language::get('nc_common_op_succ'),'index.php?app=activity&wwi=activity');
        }else{
    ...
    public function editWwi(){
        ...
        if($result){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?app=activity&wwi=activity');
        }else{
            if($_FILES['activity_banner']['name']!=''){
                @unlink(BASE_UPLOAD_PATH.DS.ATTACH_activity.DS.$upload->file_name);
            }
    ...
    public function detail_xmlWwi()
    {
        ...
        foreach ($list as $val) {
            ...
            if ($val['activity_detail_state'] != 1) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="index.php?app=activity&wwi=deal&state=1&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">通过</a></li>';
            }

            if ($val['activity_detail_state'] != 2) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="index.php?app=activity&wwi=deal&state=2&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">拒绝</a></li>';
            }
            ...
            if ($val['activity_detail_state'] != 1) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="' .
                    'index.php?app=activity&wwi=del_detail&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">删除</a></li>';
            }
