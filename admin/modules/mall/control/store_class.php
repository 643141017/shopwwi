...
class store_classControl extends SystemControl{
     ...
     * 店铺分类
     */
    public function store_classWwi(){
     ...
     * 商品分类添加
     */
    public function store_class_addWwi(){
        $lang   = Language::getLangContent();
        $model_class = Model('store_class');
        if (chksubmit()){
            //验证
            ...
            if ($error != ''){
                ...
                if ($result){
                    $url = array(
                    array(
                    'url'=>'index.php?app=store_class&wwi=store_class_add',
                    'msg'=>$lang['continue_add_store_class'],
                    ),
                    array(
                    'url'=>'index.php?app=store_class&wwi=store_class',
     ...
     * 编辑
     */
    public function store_class_editWwi(){
        $lang   = Language::getLangContent();
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    showMessage($lang['nc_common_save_succ'],'index.php?app=store_class&wwi=store_class');
                }else {
                    showMessage($lang['nc_common_save_fail']);
                }
            }
     ...
     * 删除分类
     */
    public function store_class_delWwi(){
        $lang   = Language::getLangContent();
        $model_class = Model('store_class');
        ...
        showMessage($lang['nc_common_del_fail'],'index.php?app=store_class&wwi=store_class');
    }
