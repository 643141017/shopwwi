...
class store_joininControl extends SystemControl{
    ...
    public function edit_infoWwi() {
        ...
        if (chksubmit()) {
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?app=store_joinin&wwi=edit_info');
        }
    ...
    public function edit_helpWwi() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?app=store_joinin&wwi=help_list');
            } else {
