...
class settingControl extends SystemControl{
    private $links = array(
        array('url'=>'app=setting&wwi=base','lang'=>'web_set'),
        array('url'=>'app=setting&wwi=dump','lang'=>'dis_dump')
    );
    ...
    public function ajax_categoryWwi(){
     ...
     *
     */
    public function seo_categoryWwi(){
        if (chksubmit()){
