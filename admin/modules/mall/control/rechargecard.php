...
<a class="btn green confirm-del-on-click" href="javascript:;" data-href="index.php?app=rechargecard&wwi=del_card&id={$val['id']}"><i class="fa fa-trash"></i>删除</a>
EOB;
    ...
    public function export_step1Wwi()
    {
        ...
        if (!is_numeric($_GET['curpage'])) {
            ...
            if ($count > self::EXPORT_SIZE) {
                ...
                Tpl::output('murl', 'index.php?app=rechargecard&wwi=index');
				Tpl::setDirquna('mall');/*网 店 运 维mall wwi.com*/
     ...
     * 充值卡使用明细XML
     */
    public function log_list_xmlWwi()
    {
     ...
     * 导出使用日志
     */
    public function log_export_step1Wwi()
    {
        $model = Model('rcb_log');
        ...
        if (!is_numeric($_GET['curpage'])){
            ...
            if ($count > self::EXPORT_SIZE ){
                ...
                Tpl::output('list',$array);
                Tpl::output('murl','index.php?app=rechargecard&wwi=log_list');
				Tpl::setDirquna('mall');/*网 店 运 维mall wwi.com*/
                Tpl::showpage('export.excel');
                return;
