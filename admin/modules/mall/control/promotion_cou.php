...
class promotion_couControl extends SystemControl
{
     ...
     * 活动列表
     */
    public function cou_list_xmlWwi()
    {
        $condition = array();
...
EOB;
     ...
     * 设置
     */
    public function cou_settingWwi()
    {
        $model_setting = Model('setting');
    ...
    public function cou_setting_saveWwi()
    {
    ...
    public function cou_quota_xmlWwi()
    {
        $condition = array();
    ...
    private function showMenu($menu_key)
    {
        $menu_array = array(
            'cou_list' => array(
                'menu_type' => 'link',
                'menu_name' => '活动列表',
                'menu_url'=>'index.php?app=promotion_cou&wwi=cou_list',
            ),
            'cou_detail' => array(
                'menu_type' => 'link',
                'menu_name' => '活动详情',
            ...
            'cou_quota' => array(
                'menu_type' => 'link',
                'menu_name' => '套餐管理',
                'menu_url'=>'index.php?app=promotion_cou&wwi=cou_quota',
            ),
            'cou_setting' => array(
                'menu_type' => 'link',
                'menu_name' => '设置',
                'menu_url'=>'index.php?app=promotion_cou&wwi=cou_setting',
            ),
        );
