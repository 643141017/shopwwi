...
class groupbuyControl extends SystemControl{
    ...
    public function __construct(){
        ...
        if (C('groupbuy_allow') != 1){
            $url = array(
                ...
                array(
                    'url'=>'index.php?app=groupbuy&wwi=groupbuy_template_list&groupbuy_open=1',
     ...
     *
     */
    public function groupbuy_listWwi()
    {
    ...
    public function groupbuy_list_xmlWwi()
    {
        $condition = array();
        ...
        foreach ($groupbuy_list as $val) {
            $u = MALL_SITE_URL . "/index.php?app=show_groupbuy&wwi=groupbuy_detail&group_id=" . $val['groupbuy_id'];
...
EOB;
            ...
            $i['recommended'] = $val['recommended'] == '1'
                ? '<span class="yes"><i class="fa fa-check-tyq"></i>是</span>'
     ...
     * 审核通过
     */
    public function groupbuy_review_passWwi(){
     ...
     * 审核失败
     */
    public function groupbuy_review_failWwi(){
        $groupbuy_id = intval($_REQUEST['groupbuy_id']);
     ...
     * 取消
     */
    public function groupbuy_cancelWwi() {
        $groupbuy_id = intval($_REQUEST['groupbuy_id']);
     ...
     * 删除
     */
    public function groupbuy_delWwi(){
        $groupbuy_id = intval($_REQUEST['groupbuy_id']);
     ...
     * 推荐
     */
    public function groupbuy_recWwi()
    {
    ...
    public function class_sort_updateWwi()
    {
        $update_array = array();
        $where_array = array();
    ...
    public function class_name_updateWwi()
    {
        $update_array = array();
        $where_array = array();
     ...
     * 套餐管理
     */
    public function groupbuy_quotaWwi()
    {
     ...
     * 套餐管理
     */
    public function groupbuy_quota_xmlWwi()
    {
        $condition = array();
    ...
    public function class_saveWwi() {
        ...
        if(empty($class_id)) {
            ...
            if ($class_id = $model_groupbuy_class->save($param)) {
                ...
                showMessage(Language::get('groupbuy_class_add_success'),'index.php?app=groupbuy&wwi=class_list');
            }
            else {
                showMessage(Language::get('groupbuy_class_add_fail'),'index.php?app=groupbuy&wwi=class_list');
            }
        }
        else {
            //编辑
            if($model_groupbuy_class->updates($param,array('class_id'=>$class_id))) {
                ...
                showMessage(Language::get('groupbuy_class_edit_success'),'index.php?app=groupbuy&wwi=class_list');
            }
            else {
                showMessage(Language::get('groupbuy_class_edit_fail'),'index.php?app=groupbuy&wwi=class_list');
            }
        }
     ...
     * 抢购价格区间列表
     */
    public function price_list_xmlWwi()
    {
        ...
        foreach ($groupbuy_price_list as $val) {
            $o = '<a class="confirm-del-on-click btn red" href="index.php?app=groupbuy&wwi=price_drop&range_id='
                . $val['range_id']
                . '"><i class="fa fa-trash-o"></i>删除</a>';
            $o .= '<a class="btn blue" href="index.php?app=groupbuy&wwi=price_edit&range_id='
                . $val['range_id']
    ...
    public function price_saveWwi() {
        ...
        if(empty($range_id)) {
            ...
            if($model->save($param)) {
                ...
                showMessage(Language::get('groupbuy_price_range_add_success'),'index.php?app=groupbuy&wwi=price_list');
            }
            else {
                showMessage(Language::get('groupbuy_price_range_add_fail'),'index.php?app=groupbuy&wwi=price_list');
            }
        }
        else {
            //编辑
            if($model->updates($param,array('range_id'=>$range_id))) {
                ...
                showMessage(Language::get('groupbuy_price_range_edit_success'),'index.php?app=groupbuy&wwi=price_list');
            }
            else {
                showMessage(Language::get('groupbuy_price_range_edit_fail'),'index.php?app=groupbuy&wwi=price_list');
            }
        }
     ...
     * 设置
     **/
    public function groupbuy_settingWwi() {
    ...
    public function groupbuy_setting_saveWwi() {
     ...
     * 幻灯片清空
     */
    public function slider_clearWwi()
    {
        $model_setting = Model('setting');
        $update = array();
        $update['live_pic1'] = '';
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'groupbuy_list'=>array('menu_type'=>'link','menu_name'=>'抢购活动','menu_url'=>'index.php?app=groupbuy&wwi=groupbuy_list'),
            'groupbuy_quota'=>array('menu_type'=>'link','menu_name'=>'套餐管理','menu_url'=>'index.php?app=groupbuy&wwi=groupbuy_quota'),
            'class_list'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_class_list'),'menu_url'=>'index.php?app=groupbuy&wwi=class_list'),
            'class_add'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_class_add'),'menu_url'=>'index.php?app=groupbuy&wwi=class_add'),
            'price_list'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_list'),'menu_url'=>'index.php?app=groupbuy&wwi=price_list'),
            'price_add'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_add'),'menu_url'=>'index.php?app=groupbuy&wwi=price_add'),
            'price_edit'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_edit'),'menu_url'=>'index.php?app=groupbuy&wwi=price_edit'),
