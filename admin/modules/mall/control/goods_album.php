...
class goods_albumControl extends SystemControl{
    ...
    public function get_xmlWwi() {
        ...
        foreach ($album_list as $value) {
            $param = array();
            $operation = "<a class='btn red' href='javascript:void(0);' onclick='fg_del(". $value['aclass_id'] .")'><i class='fa fa-trash-o'></i>删除</a><a class='btn green' href='index.php?app=goods_album&wwi=pic_list&aclass_id=".$value['aclass_id']."'><i class='fa fa-list-alt'></i>查看</a>";
     ...
     *
     */
    public function del_album_picWwi(){
     ...
     *
     */
    public function del_more_picWwi(){
