...
class domainControl extends SystemControl{
     ...
     * @return
     */
    public function store_domain_settingWwi(){
        /**
         * 读取语言包
         */
     ...
     * 店铺二级域名列表
     */
    public function store_domain_listWwi(){
						//网 店 运 维mall wwi.com
		Tpl::setDirquna('mall');
    ...
    public function get_xmlWwi() {
        ...
        foreach ($store_list as $value) {
            $param = array();
            $param['operation'] = "<a class='btn blue' href='index.php?app=domain&wwi=store_domain_edit&store_id=" . $value['store_id'] . "'><i class='fa fa-pencil-square-o'></i>编辑</a>";
     ...
     * 二级域名编辑
     */
    public function store_domain_editWwi(){
        ...
        if (chksubmit()){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?app=domain&wwi=store_domain_list');//保存成功
        }
