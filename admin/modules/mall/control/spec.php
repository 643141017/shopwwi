...
class specControl extends SystemControl {
    ...
    public function get_xmlWwi() {
        ...
        foreach ((array)$spec_list as $value) {
            ...
            $operation .= "<a class='btn blue' href='index.php?app=spec&wwi=spec_edit&sp_id=".$value['sp_id']."'><i class='fa fa-pencil-square-o'></i>编辑</a>";
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if($return) {
                    $url = array(
                        array(
                            'url'=>'index.php?app=spec&wwi=spec_add',
                            'msg'=>$lang['spec_index_continue_to_dd']
                        ),
                        array(
                            'url'=>'index.php?app=spec&wwi=spec',
