    ...
    public function addpointsWwi(){
        if (chksubmit()){
            ...
            if (!is_array($member_info) || count($member_info)<=0){
                showMessage(Language::get('admin_points_userrecord_error'),'index.php?app=points&wwi=addpoints','','error');
            }

            $pointsnum = intval($_POST['pointsnum']);
            if ($_POST['operatetype'] == 2 && $pointsnum > intval($member_info['member_points'])){
                showMessage(Language::get('admin_points_points_short_error').$member_info['member_points'],'index.php?app=points&wwi=addpoints','','error');
            }
            ...
            if ($result){
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?app=points&wwi=addpoints');
            }else {
                showMessage(Language::get('nc_common_save_fail'),'index.php?app=points&wwi=addpoints','','error');
            }
        }else {
