...
class uploadControl extends SystemControl{
    private $links = array(
        array('url'=>'app=upload&wwi=param','lang'=>'upload_param'),
        array('url'=>'app=upload&wwi=default_thumb','lang'=>'default_thumb'),
        array('url'=>'app=upload&wwi=font','lang'=>'font_set')
    );
     ...
     * 默认图设置
     */
    public function default_thumbWwi(){
        $model_setting = Model('setting');
        if (chksubmit()){
            //上传图片
