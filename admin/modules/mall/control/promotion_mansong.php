...
class promotion_mansongControl extends SystemControl{
     ...
     * 活动列表XML
     */
    public function mansong_list_xmlWwi()
    {
        $condition = array();
...
EOB;
     ...
     * 满即送活动取消
     **/
    public function mansong_cancelWwi() {
     ...
     * 套餐管理
     */
    public function mansong_quotaWwi()
    {
     ...
     * 套餐管理XML
     */
    public function mansong_quota_xmlWwi()
    {
        $condition = array();
     ...
     * 设置
     **/
    public function mansong_settingWwi() {
    ...
    public function mansong_setting_saveWwi() {
