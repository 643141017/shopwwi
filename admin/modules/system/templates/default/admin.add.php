...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=admin&wwi=admin" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
	...
	$("#add_form").validate({
        ...
        rules : {
            admin_name : {
				...
				maxlength: 20,
				remote	: {
                    url :'index.php?app=admin&wwi=ajax&branch=check_admin_name',
                    type:'get',
                    data:{
                    	admin_name : function(){
        ...
        messages : {
            admin_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_username_null'];?>',
				minlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_username_max'];?>',
				maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_username_max'];?>',
				remote   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_admin_not_exists'];?>'
            },
            admin_password : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_password_null'];?>',
				minlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_password_max'];?>',
				maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_password_max'];?>'
            },
            admin_rpassword : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_password_null'];?>',
                equalTo  : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_edit_repeat_error'];?>'
            },
            gid : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['admin_add_gid_null'];?>'
            }
        }
	});
});
