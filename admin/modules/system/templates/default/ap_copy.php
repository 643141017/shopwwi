...
<dd>JavaScript:</dd>
  <dd >
    <input type="text" style=" width:400px;" value='<script type="text/javascript" src="<?php echo MALL_SITE_URL;?>/index.php?app=adv&wwi=advshow&ap_id=<?php echo $_GET['id'];?>"></script>' />
  </dd>
  <dd>PHP:</dd>
