...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=adv&wwi=ap_manage" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
	...
	$('#link_form').validate({
        ...
        messages : {
        	ap_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['ap_can_not_null']; ?>'
            },
            ap_width_media	:{
            	required   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['ap_input_digits_pixel']; ?>',
            	digits	:'<i class="fa fa-exclamation-tyq"></i><?php echo $lang['ap_input_digits_pixel'];?>',
            	min	:'<i class="fa fa-exclamation-tyq"></i><?php echo $lang['ap_input_digits_pixel'];?>'
            },
            ap_height	:{
            	required   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['ap_input_digits_pixel']; ?>',
            	digits	:'<i class="fa fa-exclamation-tyq"></i><?php echo $lang['ap_input_digits_pixel'];?>',
            ...
            default_word	:{
            	required   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['ap_default_word_can_not_null']; ?>'
            },
            default_pic: {
        		required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['default_pic_can_not_null'];?>',
