...
$(function(){
	$('#form').validate({
		...
		messages : {
		    image_max_filesize : {
				number   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['image_max_size_only_num'];?>',
				maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['image_max_size_c_num'];?>'
			},
			image_allow_ext : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['image_allow_ext_not_null'];?>'
			}
		}
	});
});
