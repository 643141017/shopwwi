...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=adv" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=adv&wwi=get_adv_xml&ap_id=<?php echo $_GET['ap_id'];?>',
        colModel : [
...
function fg_delete(id){
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?app=adv&wwi=adv_delete",
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?app=adv&wwi=adv_add&ap_id=<?php echo $_GET['ap_id'];?>';
    }else if (name == 'delete') { 
