...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=area&wwi=index" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3>地区设置 - 新增</h3>
        <h5>地区新增与编辑</h5>
      </div>
  ...
  <form id="form" method="post" action="index.php?app=area&wwi=save&area_id=<?php echo $_GET['area_id']?>">
...
$(document).ready(function(){
	...
	$('#form').validate({
        ...
        messages : {
        	area_name : {
                required : '<i class="fa fa-exclamation-tyq"></i>请填写地区'
            }
        }
    });
});
