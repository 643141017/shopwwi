...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=rec_position&wwi=rec_list" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
  ...
  <form id="rec_form" enctype="multipart/form-data" method="post" action="index.php?app=rec_position&wwi=rec_edit_save">
