...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=document&wwi=document" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
	$('#doc_form').validate({
        ...
        messages : {
            doc_title : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['document_index_title_null'];?>'
            },
			doc_content : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['document_index_content_null'];?>'
            }
        }
    });
    // 图片上传
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?app=document&wwi=document_pic_upload&item_id=<?php echo $output['doc']['doc_id'];?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('index.php?app=document&wwi=ajax&branch=del_file_upload&file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
