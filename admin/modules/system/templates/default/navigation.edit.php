...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=navigation&wwi=navigation" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
	$('#navigation_form').validate({
        ...
        messages : {
            nav_title : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['navigation_add_partner_null'];?>'
            },
            nav_sort  : {
                number   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['navigation_add_sort_int'];?>'
            }
        }
    });
