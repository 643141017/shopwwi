...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=article_class&wwi=article_class" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
	...
	$('#article_class_form').validate({
        ...
        rules : {
            ac_name : {
                required : true,
                remote   : {                
                url :'index.php?app=article_class&wwi=ajax&branch=check_class_name',
                type:'get',
                data:{
                    ac_name : function(){
                        return $('#ac_name').val();
        ...
        messages : {
            ac_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['article_class_add_name_null'];?>',
                remote   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['article_class_add_name_exists'];?>'
            },
            ac_sort  : {
                number   : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['article_class_add_sort_int'];?>'
            }
        }
    });
});
