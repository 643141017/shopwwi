...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=admin&wwi=gadmin" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
	...
	$("#add_form").validate({
        ...
        rules : {
            gname : {
                required : true,
				remote	: {
                    url :'index.php?app=admin&wwi=ajax&branch=check_gadmin_name&gid=<?php echo $output['ginfo']['gid']?>',
                    type:'get',
                    data:{
                    	gname : function(){
                            return $('#gname').val();
        ...
        messages : {
            gname : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['nc_none_input'];?>',
