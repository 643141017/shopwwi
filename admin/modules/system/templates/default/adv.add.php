...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=adv&wwi=adv&ap_id=<?php echo $_GET['ap_id'];?>" title="返回列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
	$('#adv_form').validate({
        ...
        messages : {
        	adv_name : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['adv_can_not_null'];?>'
            },
            aptype_hidden : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['must_select_ap_id'];?>'
            },
            adv_start_time  : {
                required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['adv_start_time_can_not_null']; ?>'
            },
            adv_end_time  : {
            	required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['adv_end_time_can_not_null']; ?>'
            },
            adv_pic: {
        		required : '<i class="fa fa-exclamation-tyq"></i>请上传图片',
				accept   : '<i class="fa fa-exclamation-tyq"></i>图片格式错误'
			},
			flash_swf: {
        		required : '<i class="fa fa-exclamation-tyq"></i>请上传Flash',
				accept   : '<i class="fa fa-exclamation-tyq"></i>Flash格式错误'
			}
        }
    });
});
