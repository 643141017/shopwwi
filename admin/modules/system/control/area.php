...
class areaControl extends SystemControl{
    ...
    public function get_xmlWwi() {
        ...
        foreach ($list as $k => $info) {
            ...
            $operation_detail .= "<li><a href=\"index.php?app=area&wwi=edit&area_id={$info['area_id']}\">编辑地区</a></li>";
            if ($info['area_deep'] <= 3) {
                $operation_detail .= "<li><a href=\"index.php?app=area&wwi=add&parent_id={$info['area_id']}\">新增下级</a></li>";
