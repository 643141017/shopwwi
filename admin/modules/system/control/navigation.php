...
class navigationControl extends SystemControl{
     ...
     * 页面导航 添加
     */
    public function navigation_addWwi(){
        $lang   = Language::getLangContent();
        $model_navigation = Model('navigation');
        if (chksubmit()){
            /**
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?app=navigation&wwi=navigation_add',
                            'msg'=>$lang['navigation_add_again'],
                        ),
                        array(
                            'url'=>'index.php?app=navigation&wwi=navigation',
     ...
     * 页面导航 编辑
     */
    public function navigation_editWwi(){
        $lang   = Language::getLangContent();
        $model_navigation = Model('navigation');
        if (chksubmit()){
            /**
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?app=navigation&wwi=navigation_edit&nav_id='.intval($_POST['nav_id']),
     ...
     * 删除页面导航
     */
    public function navigation_delWwi(){
        $lang   = Language::getLangContent();
        $model_navigation = Model('navigation');
        if (preg_match('/^[\d,]+$/', $_GET['nav_id'])) {
            ...
            showMessage($lang['navigation_index_del_succ'],'index.php?app=navigation&wwi=navigation');
        }else {
            showMessage($lang['navigation_index_choose_del'],'index.php?app=navigation&wwi=navigation');
        }
    }
