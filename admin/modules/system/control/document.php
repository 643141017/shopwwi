...
class documentControl extends SystemControl{
        ...
        if(chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?app=document&wwi=document',
                            'msg'=>$lang['document_edit_back_to_list']
                        ),
                        array(
                            'url'=>'index.php?app=document&wwi=edit&doc_id='.intval($_POST['doc_id']),
     ...
     * 系统文章图片上传
     */
    public function document_pic_uploadWwi(){
        /**
         * 上传图片
         */
