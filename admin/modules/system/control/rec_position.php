...
class rec_positionControl extends SystemControl{
    ...
    public function get_xmlWwi(){
        ...
        foreach ($list as $k => $info) {
            ...
            $operation_detail = "<li><a href='index.php?app=rec_position&wwi=rec_edit&rec_id={$info['rec_id']}'>编辑内容</a></li>";
            $operation_detail .= "<li><a href=\"javascript:void(0);\" rec_id=\"{$info['rec_id']}\" nctype=\"jscode\"></i>调用代码</a></li>";
            $operation_detail .= "<li><a href=\"index.php?app=rec_position&wwi=rec_view&rec_id={$info['rec_id']}\" target=\"_blank\">预览效果</a></li>";
            if ($operation_detail) {
            ...
            $list['target'] = $info['content']['target'] == 1 ? '<span class="no"><i class="fa fa-ban"></i>否</span>' : '<span class="yes"><i class="fa fa-check-tyq"></i>是</span>';
    ...
    public function rec_saveWwi(){
        ...
        showMessage(Language::get('nc_common_save_succ'),'index.php?app=rec_position&wwi=rec_list');
    }
     ...
     *
     */
    public function rec_edit_saveWwi(){
        ...
        if ($result){
            ...
            showMessage(Language::get('nc_common_save_fail'),'index.php?app=rec_position&wwi=rec_list');
        }
    }

    public function rec_codeWwi(){
		Tpl::setDirquna('system');
        Tpl::showpage('rec_position.code','null_layout');
    }

    public function rec_viewWwi(){
