...
class accountControl extends SystemControl{
    private $links = array(
        array('url'=>'app=account&wwi=qq','lang'=>'qqSettings'),
        array('url'=>'app=account&wwi=sina','lang'=>'sinaSettings'),
        array('url'=>'app=account&wwi=sms','text'=>'手机短信'),
        array('url'=>'app=account&wwi=wx','text'=>'微信登录'),
		array('url'=>'app=account&wwi=uc','text'=>'UC互联')
    );
