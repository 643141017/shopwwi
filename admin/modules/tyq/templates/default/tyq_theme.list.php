...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['tyq_theme_prompts_one'];?></li>
      <li><?php echo $lang['tyq_theme_prompts_two'];?></li>
      <li><?php echo $lang['tyq_theme_prompts_three'];?></li>
    </ul>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=tyq_theme&wwi=get_xml',
        colModel : [
            ...
            {display: '所属圈子', name : 'tyq_name', width : 150, sortable : false, align: 'left'},
...
function fg_del(id) {
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?app=tyq_theme&wwi=theme_del', {id:id}, function(data){
            if (data.state) {
