...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tyq_informnamage'];?></h3>
        <h5><?php echo $lang['nc_tyq_informnamage_subhead'];?></h5>
      </div>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=tyq_inform&wwi=get_xml',
        colModel : [
            ...
            {display: '所属圈子', name : 'tyq_name', width : 100, sortable : true, align: 'left'},
...
function fg_del(ids) {
    ...
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?app=tyq_inform&wwi=inform_del', {id:id}, function(data){
            if (data.state) {
