...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=tyq_manage&wwi=tyq_list"><?php echo $lang['nc_manage'];?></a></li>
        <li><a href="javascript:void(0);" class="current"><?php echo $lang['tyq_wait_verify'];?></a></li>
      </ul>
    </div>
  </div>
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['tyq_verify_prompts_one'];?></li>
      <li><?php echo $lang['tyq_verify_prompts_two'];?></li>
    </ul>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=tyq_manage&wwi=get_xml&type=verify',
        colModel : [
