  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=tyq_memberlevel"><?php echo $lang['tyq_defaultlevel'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['tyq_memberlevelref'];?></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="150" align="left"><?php echo $lang['tyq_memberlevelgroup'];?></th>
          <th width="150" align="center"><?php echo $lang['tyq_addtime'];?></th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle"><a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?app=tyq_memberlevel&wwi=ref_del&mlref_id=<?php echo $val['mlref_id'];?>'}" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a><a href="index.php?app=tyq_memberlevel&wwi=ref_edit&mlref_id=<?php echo $val['mlref_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?app=tyq_memberlevel&wwi=ref_add';
    }
}
</script>
