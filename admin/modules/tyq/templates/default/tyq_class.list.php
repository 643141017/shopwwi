...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tyq_classmanage'];?></h3>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['tyq_class_prompts_one'];?></li>
      <li><?php echo $lang['tyq_class_prompts_two'];?></li>
    </ul>
  </div>
  <div class="flex-table-search">
    <form method="get" name="formSearch">
      <input type="hidden" name="app" value="tyq_class">
      <input type="hidden" name="wwi" value="class_list">
      <div class="sDiv">
        <select name="searchstatus" class="select">
          <option value=""><?php echo $lang['tyq_class_status'];?></option>
    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="300" align="left"><?php echo $lang['tyq_class_name'];?></th>
      ...
      <tbody>
        ...
        <tr class="edit"  data-id="<?php echo $v['class_id'];?>">
          ...
          <td class="handle"><a href="javascript:void(0);" onclick="fg_del(<?php echo $v['class_id'];?>)" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a><a href="index.php?app=tyq_class&wwi=class_edit&classid=<?php echo $v['class_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?app=tyq_class&wwi=class_add';
    } else if (name == 'del') {
...
function fg_del(ids) {
    ...
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?app=tyq_class&wwi=class_del', {id:id}, function(data){
            if (data.state) {
                location.reload();
            } else {
                showError(data.msg)
