...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=tyq_class&wwi=class_list" title="返回分类列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['nc_tyq_classmanage'];?> - <?php echo $lang['nc_edit'];?>圈子分类“<?php echo $output['class_info']['class_name'];?>”</h3>
        <h5><?php echo $lang['nc_tyq_classmanage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="class_form" method="post">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="class_name"><em>*</em><?php echo $lang['tyq_class_name'];?></label>
        </dt>
        <dd class="opt">
          <input type="text" name="class_name" id="class_name" class="input-txt" value="<?php echo $output['class_info']['class_name'];?>" />
          <span class="err"></span>
          <p class="notic"><?php echo $lang['tyq_class_name_tips'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label for="recommend"><?php echo $lang['tyq_class_is_recommend'];?></label>
        </dt>
        <dd class="opt">
          <div class="onoff">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="status"><?php echo $lang['tyq_class_status'];?></label>
        </dt>
        <dd class="opt">
          <div class="onoff">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic"><?php echo $lang['tyq_class_sort_tips'];?></p>
        </dd>
      </dl>
...
$(function(){
	...
	$('#class_form').validate({
        ...
        messages : {
        	class_name : {
        		required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['tyq_class_name_not_null'];?>',
        		maxlength: '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['tyq_class_name_maxlength'];?>'
        	},
        	class_sort : {
            	digits : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['tyq_class_sort_is_number'];?>',
            	max : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['tyq_class_sort_max'];?>'
            }
        }
    });
});
