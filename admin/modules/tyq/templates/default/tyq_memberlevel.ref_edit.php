...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=tyq_memberlevel&wwi=ref" title="返回<?php echo $lang['tyq_memberlevelref'];?>列表"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['tyq_memberlevel'];?> - <?php echo $lang['tyq_memberleveledit'];?>“<?php echo $output['mlref_info']['mlref_name'];?>”</h3>
  ...
  <form method="post" id="clmdEditForm" name="clmdEditForm">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="mlref_name"><?php echo $lang['tyq_memberlevelgroup'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['tyq_is_use'];?></dt>
        <dd class="opt">
          <div class="onoff">
    ...
    <div class="ncap-form-all">
      <dl class="row">
        <dt class="tit"> <span class="w100 tc"><?php echo $lang['tyq_level'];?></span> <span class="w350"><?php echo $lang['tyq_rankname'];?></span> <span class="w100 tc"><?php echo $lang['tyq_level'];?></span> <span class="w350"><?php echo $lang['tyq_rankname'];?></span> </dt>
        <?php for($i=1;$i<=8;$i++){?>
        <dd class="opt">
...
$(function(){
	...
	$("#clmdEditForm").validate({
		...
		messages : {
			mlref_name : {
				required : '<i class="fa fa-exclamation-tyq"></i><?php echo $lang['tyq_memberlevelgroupname_not_null'];?>'
			}
			<?php for($i=1;$i<=16;$i++){?>
			,mlref_<?php echo $i;?> : {
