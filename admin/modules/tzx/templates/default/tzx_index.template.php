...
<?php if($_GET['wwi'] === 'tzx_index_preview') { ?>
<link href="<?php echo TZX_SITE_URL.DS;?>templates/default/css/base.css" rel="stylesheet" type="text/css"/>
...
$(document).ready(function() {
    ...
    //计算自定义块高度
    var frames = $('.tzx-module-frame');
    $.each(frames, function(index, frame) {
        var boxs = $(frame).find('[nctype="tzx_module_content"]');
        var height = 0;
