...
<link href="<?php echo TZX_SITE_URL.DS;?>templates/tzx_special.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="<?php echo ADMIN_RESOURCE_URL;?>/js/tzx/tzx_index.js" charset="utf-8"></script>
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=tzx_index&wwi=tzx_index" title="返回模板"><i class="fa fa-arrow-tyq-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['nc_tzx_index_manage'];?> - <?php echo $lang['tzx_index_module_edit'];?></h3>
        <h5>资讯首页模板可视化编辑生成</h5>
      </div>
      
    </div>
  </div>
  <form id="add_form" method="post" action="index.php?app=tzx_index&wwi=save_page_module">
    <input name="module_id" type="hidden" value="<?php echo $output['module_detail']['module_id'];?>" />
    <div class="ncap-form-all">
      <dl class="row">
        
        <dd class="opt nobs nobd" id="tzxIndexModuleEdit">
      ...
      <div class="bot"><a href="Javascript: void(0)" class="ncap-btn-big ncap-btn-green" id="btn_module_save"><?php echo $lang['tzx_text_save'];?></a></div>
    </div>
  </form>
</div>
<!--编辑标题-->
<div id="dialog_module_title_edit" style="display:none;">
  <div class="ncap-form-default">
    <dl class="row">
      <dt class="tit"><?php echo $lang['tzx_index_module_title'];?></dt>
      <dd class="opt">
        <input name="input_module_title" type="text" class="input-txt" id="input_module_title" maxlength="8" />
        <p class="notic"><?php echo $lang['tzx_index_module_title_explain'];?></p>
      </dd>
    </dl>
    <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_title_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
  </div>
</div>
<!-- 关键字标题 -->
<div id="dialog_module_tag_edit" style="display:none;">
  <div class="ncap-form-all">
    <dl class="row">
      <dt class="tit"><?php echo $lang['tzx_index_module_tag_selected'];?></dt>
      <dd class="opt">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['tzx_index_module_tag_list'];?></dt>
      <dd class="opt">
        <ul class="article-tag-list">
          <?php if(!empty($output['tag_list']) && is_array($output['tag_list'])) {?>
          <?php foreach($output['tag_list'] as $value){ ?>
          <li nctype="btn_tag_select" data-tag-id="<?php echo $value['tag_id'];?>"><a href="<?php echo TZX_SITE_URL;?>/index.php?app=article&wwi=article_tag_search&tag_id=<?php echo $value['tag_id'];?>" ><?php echo $value['tag_name'];?></a><i></i></li>
          <?php } ?>
          <?php } ?>
        </ul>
      </dd>
    </dl>
    <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_tag_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
  </div>
</div>
<!--编辑图片-->
<div id="dialog_module_image_edit" style="display:none;">
  <div id="module_image_edit_explain" class="s-tips"></div>
  <form action="index.php?app=tzx_index&wwi=image_upload" method="post">
    <div class="ncap-form-default">
      <ul id="image_selected_list" class="image-selected-list clearfix">
      </ul>
      <dl class="row">
        <dt class="tit"><?php echo $lang['tzx_index_module_image_select'];?></dt>
        <dd class="opt">
      ...
      <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_image_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
    </div>
  </form>
</div>
<!--编辑文章-->
<div id="dialog_module_article_edit" style="display:none;">
  <div class="ncap-form-all">
    <dl class="row">
      <dt class="tit"><?php echo $lang['tzx_index_module_article_seleceted'];?></dt>
      <dd class="opt">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['tzx_index_module_article_search'];?></dt>
      <dd class="opt">
        <div class="dialog-show-box">
          <div class="search-bar">
            ...
            <label for="radio_article_search_type_1"><?php echo $lang['tzx_text_id'];?></label>
            <input id="radio_article_search_type_2" name="article_search_type" type="radio" value="article_keyword"/>
            <label for="radio_article_search_type_2"><?php echo $lang['tzx_text_keyword'];?></label>
            <input id="input_article_search_keyword" type="text" class="txt" />
            <a href="JavaScript:void(0);" id="btn_article_search" class="ncap-btn"><?php echo $lang['tzx_text_search'];?></a></div>
          <div id="div_article_select_list" class="show-recommend-goods-list"> </div>
        </div>
      </dd>
    </dl>
    <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_article_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
  </div>
</div>
<!--编辑商品-->
<div id="dialog_module_goods_edit" class="dialog-special-insert-goods upload_adv_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-lightbulb-o"></i><?php echo $lang['tzx_index_module_goods_explain'];?></div>
  <div id="upload_adv_type" class="ncap-form-default">
    <dl class="row">
      <dt class="tit"><?php echo $lang['tzx_index_module_goods_input_url'];?></dt>
      <dd class="opt">
        <input id="input_goods_link" type="text" class="input-txt" />
        <a class="ncap-btn" id="btn_goods_search" href="javascript:void(0);"><?php echo $lang['tzx_text_add'];?></a>
        <p class="notic"><?php echo $lang['tzx_index_module_goods_explain'];?></p>
      </dd>
    </dl>
  </div>
  <div class="ncap-form-all">
  ...
  <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_goods_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
</div>
<!-- 品牌选择弹出窗口 -->
<div id="dialog_module_brand_edit" class="brand_list_dialog" style="display:none;">
  <div class="s-tips"><i class="fa fa-lightbulb-o"></i><?php echo $lang['tzx_index_module_brand_explain'];?> </div>
  <div class="ncap-form-all" id="upload_adv_type">
    <dl class="row">
      <dt class="tit"><?php echo $lang['tzx_index_module_brand_selected'];?><?php echo $lang['nc_colon'];?></dt>
      <dd class="opt">
        <ul id="brand_selected_list" class="tzx-brand-list">
        </ul>
      </dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['tzx_index_module_brand_list'];?><?php echo $lang['nc_colon'];?></dt>
      <dd class="opt">
        <div id="div_brand_select_list" class="dialog-show-box"></div>
      </dd>
    </dl>
    <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_brand_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
  </div>
</div>
<!-- 商品分类选择弹出窗口 -->
<div id="dialog_module_goods_class_edit" class="goods_class_list_dialog" style="display:none;">
  <div class="s-tips"><i></i><?php echo $lang['tzx_index_module_goods_class_explain'];?></div>
  <div class="ncap-form-default">
    <dl class="row"><dt class="tit"><?php echo $lang['tzx_index_module_goods_class'];?> </dt>
    <dd class="opt"><span class="handle">
      <select id="select_goods_class_list" class=" w200">
      </select>
      </span><p class="notic"><?php echo $lang['tzx_index_module_goods_class_explain'];?></p></dd></dl>
  </div>
  <div id="goods_class_selected_list" class="category-list category-list-edit"></div>
  <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_goods_class_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
</div>
<!--编辑店铺-->
    ...
    <dl class="row">
      ...
      <dd class="opt">
        <div class="search-bar">
          ...
          <a href="JavaScript:void(0);" id="btn_store_search" class="ncap-btn"><?php echo $lang['tzx_text_search'];?></a></div>
        <div class="dialog-show-box">
          <div id="div_store_select_list" class="show-store-list"> </div>
        </div>
      </dd>
    </dl>
    <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_store_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
  </div>
</div>
<!--编辑会员-->
    ...
    <dl class="row">
      ...
      <dd class="opt">
        <div class="search-bar">
          ...
          <a href="JavaScript:void(0);" id="btn_member_search" class="ncap-btn"><?php echo $lang['tzx_text_search'];?></a></div>
        <div class="dialog-show-box">
          <div id="div_member_select_list" class="show-member-list"> </div>
        </div>
      </dd>
    </dl>
    <div class="bot"><a class="ncap-btn-big ncap-btn-green" id="btn_module_member_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
  </div>
</div>
<!--编辑FLASH-->
<div id="dialog_module_flash_edit" style="display:none;">
  ...
  <div class="ncap-form-default">
    ...
    <div class="bot"><a id="btn_module_flash_save" href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" ><?php echo $lang['tzx_text_save'];?></a></div>
  </div>
</div>
<!-- FLASH组件模板 --> 
...
<div id="dialog_module_html_edit" style="display:none;">
  <div class="ncap-form-all">
    ...
    <div class="bot"><a class="ncap-btn-big ncap-btn-green"id="btn_module_html_save" href="JavaScript:void(0);"><?php echo $lang['tzx_text_save'];?></a></div>
  </div>
</div>
