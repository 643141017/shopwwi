...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tzx_navigation_manage'];?></h3>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['tzx_article_class_list_tip1'];?></li>
    </ul>
  </div>
    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="300"><?php echo $lang['tzx_navigation_name'];?></th>
          <th width="300"><?php echo $lang['tzx_navigation_url'];?></th>
          <th width="100" align="center"><?php echo $lang['tzx_navigation_open_type'];?></th>
          <th></th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr data-id="<?php echo $val['navigation_id']; ?>">
          ...
          <td class="handle-s"><a href="index.php?app=tzx_navigation&wwi=tzx_navigation_drop&navigation_id=<?php echo $val['navigation_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a></td>
...
$(function(){
        ...
        buttons : [
            ...
            },
            {
                ...
                onpress : function() {
                    ...
                    location.href = 'index.php?app=tzx_navigation&wwi=tzx_navigation_drop&navigation_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ]
    });
    ...
    //行内ajax编辑
    $('span[nc_type="navigation_sort"]').inline_edit({app: 'tzx_navigation',wwi: 'update_navigation_sort'});
    $('span[nc_type="navigation_title"]').inline_edit({app: 'tzx_navigation',wwi: 'update_navigation_title'});
    $('span[nc_type="navigation_link"]').inline_edit({app: 'tzx_navigation',wwi: 'update_navigation_link'});
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?app=tzx_navigation&wwi=tzx_navigation_add';
    }
}
</script>