...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tfx_goods_manage'];?></h3>
        <h5><?php echo $lang['nc_tfx_goods_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['tfx_goods_tip1'];?></li>
      <li><?php echo $lang['tfx_goods_tip2'];?></li>
    </ul>
  </div>
...
<script>
$(function() {
    var flexUrl = 'index.php?app=goods&wwi=goods_manage_xml';
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel: [
            ...
            {display: '排序', name: 'tfx_sort', width: 60, sortable: false, align: 'left'},
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?app=goods&wwi=goods_drop&commend_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$('a[data-ie-column]').live('click', function() {
    $.get('index.php?app=goods&wwi=ajax&branch=goods_commend', {
...
$("span[data-live-inline-edit='tfx_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php?app=goods&wwi=goods_sort_update', {
            id: $this.parents('tr').attr('data-id'),
            value: v2
        }, function(d) {
            if (d.result) {
