...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tfx_personal_class'];?></h3>
    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="300"><?php echo $lang['tfx_class_name'];?></th>
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['class_id'];?>">
          ...
          <td class="handle"><a href="index.php?app=personal_class&wwi=personalclass_drop&class_id=<?php echo $val['class_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a><a href="index.php?app=personal_class&wwi=personalclass_edit&class_id=<?php echo $val['class_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
          ...
          <td><a href="javascript:;" class="pic-thumb-tip" onmouseout="toolTip()" onmouseover="toolTip('<img src=\'<?php echo UPLOAD_SITE_URL.DS.ATTACH_TFX.DS. (empty($val['class_image']) ? 'default_goods_class_image.gif' : $val['class_image']); ?>\'>')"> <i class='fa fa-picture-o'></i> </a></td>
          <td></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
	...
	$('.flex-table').flexigrid({
        ...
        buttons : [
				   ...
				   {display: '<i class="fa fa-trash"></i>批量删除', name : 'del', bclass : 'del', title : '将选定行数据批量删除', onpress : function() {
                    ...
                    location.href = 'index.php?app=personal_class&wwi=personalclass_drop&class_id=__IDS__'.replace('__IDS__', ids.join(','));
                } }
               ]
		});

    //行内ajax编辑
    $('span[nc_type="class_sort"]').inline_edit({app: 'personal_class',wwi: 'personalclass_sort_update'});
    $('span[nc_type="class_name"]').inline_edit({app: 'personal_class',wwi: 'personalclass_name_update'});
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?app=personal_class&wwi=personalclass_add';
    }
}
</script>