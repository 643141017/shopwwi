...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['tfx_goods_class_binding_tip1'];?></li>
      <li><?php echo $lang['tfx_goods_class_binding_tip2'];?></li>
    </ul>
  </div>
  ...
  <div class="ncap-form-default">
    <dl class="row">
      <dt class="tit">
        <label for="class_name"><?php echo $lang['tfx_goods_class_binded'];?></label>
      </dt>
      <dd class="opt">
    ...
    <dl class="row">
      <dt class="tit">
        <label for="class_name"><?php echo $lang['tfx_goods_class_binding_select'];?></label>
      </dt>
      <dd class="opt">
...
<form id="add_form" method="POST" action="index.php?app=goods_class&wwi=goodsclass_binding_save">
...
$(document).ready(function(){
    ...
    $("#goods_class").change(function(){
        ...
        $.getJSON('index.php?app=goods_class&wwi=goodsclass_get',{class_id:$(this).val()},function(data){
            if(data != null)
            {
