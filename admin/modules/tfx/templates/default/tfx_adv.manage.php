...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_tfx_adv_manage'];?></h3>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['tfx_adv_tip1'];?></li>
    </ul>
  </div>
  <div class="flex-table-search">
    <form method="get" name="formSearch">
      <input type="hidden" value="adv" name="app">
      <input type="hidden" value="adv_manage" name="wwi">
      <div class="sDiv">
    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="300"><?php echo $lang['tfx_adv_name'];?></th>
          <th width="300">广告链接</th>
          <th width="150" align="center"><?php echo $lang['tfx_adv_type'];?></th>
          <th></th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr data-id="<?php echo $val['adv_id']; ?>">
          ...
          <td class="handle"><a href="index.php?app=adv&wwi=adv_drop&adv_id=<?php echo $val['adv_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a><a href="index.php?app=adv&wwi=adv_edit&adv_id=<?php echo $val['adv_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
          ...
          <td><a href="javascript:;" class="pic-thumb-tip" onmouseout="toolTip()" onmouseover="toolTip('<img src=\'<?php echo UPLOAD_SITE_URL.DS.ATTACH_TFX.DS.'adv'.DS. $val['adv_image']; ?>\'>')"> <i class='fa fa-picture-o'></i> </a></td>
	...
	$('.flex-table').flexigrid({
        ...
        buttons : [
				   ...
				   {display: '<i class="fa fa-trash"></i>批量删除', name : 'del', bclass : 'del', title : '将选定行数据批量删除', onpress : function() {
                    ...
                    location.href = 'index.php?app=adv&wwi=adv_drop&adv_id=__IDS__'.replace('__IDS__', ids.join(','));
                    } }
               ]
		});

    //行内ajax编辑
    $('span[nc_type="adv_sort"]').inline_edit({app: 'adv',wwi: 'adv_sort_update'});
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?app=adv&wwi=adv_add';
    }
}
</script>