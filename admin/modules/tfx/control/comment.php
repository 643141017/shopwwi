...
class commentControl extends SystemControl{
    ...
    public function comment_manageWwi()
    {
        ...
        Tpl::setDirquna('tfx');
Tpl::showpage('tfx_comment.manage');
    }
    ...
    public function comment_manage_xmlWwi()
    {
        ...
        foreach ($list as $val) {
            ...
            $o = '<a class="btn red confirm-del-on-click" href="index.php?app=comment&wwi=comment_drop&comment_id=' .
                    $val['comment_id'] .
                    '"><i class="fa fa-trash"></i>删除</a>';

            $o .= '<a class="btn green" target="_blank" href="' .
                TFX_SITE_URL.DS.'index.php?app=' .
                $channel['key'] .
                '&wwi=detail&' .
                $channel['key'] .
                '_id=' .
            ...
            $i['member_name'] = '<a href="' .
                TFX_SITE_URL.DS.'index.php?app=home&member_id=' .
    ...
    private function get_channel_array() {
        $channel_array = array();
        $channel_array[self::GOODS_FLAG] = array('name'=>Language::get('nc_tfx_goods'),'key'=>'goods');
        $channel_array[self::PERSONAL_FLAG] = array('name'=>Language::get('nc_tfx_personal'),'key'=>'personal');
        $channel_array[self::STORE_FLAG] = array('name'=>Language::get('nc_tfx_store'),'key'=>'store');
