$(document).ready(function(){
    ...
    $("input[nctype='tzx_image']").live("change", function(){
    ...
    $("#picture_image_upload").fileupload({
        dataType: 'json',
            url: "index.php?app=tzx_special&wwi=special_image_upload",
            add: function(e,data) {
    ...
    $("[nctype='btn_drop_special_image']").live("click",function(){
        ...
        $.getJSON("index.php?app=tzx_special&wwi=special_image_drop", { image_name: image_name }, function(result){
                if(result.status == "success") {
                    image_object.remove();
                } else {
    ...
    $("[nctype='btn_special_goods']").live('click', function(){
        ...
        $.getJSON("index.php?app=tzx_special&wwi=goods_info_by_url", { url: url}, function(data){
            if(data.result == "true") {
