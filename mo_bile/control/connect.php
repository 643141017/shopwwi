...
class connectControl extends mobileHomeControl {
     ...
     * QQ互联获取应用唯一标识
     */
    public function get_qq_appidWwi(){
        output_data(C('app_qq_akey'));
    }
    /**
     * 请求QQ互联授权
     */
    public function get_qq_oauth2Wwi(){
        $logic_connect_api = Logic('connect_api');
     ...
     * QQ互联获取回调信息
     */
    public function get_qq_infoWwi(){
        $code = $_GET['code'];
        $token = $_GET['token'];
        $client = $_GET['client'];
        $logic_connect_api = Logic('connect_api');
     ...
     * 新浪微博获取应用唯一标识
     */
    public function get_sina_appidWwi(){
        output_data(C('app_sina_akey'));
    }
    /**
     * 请求新浪微博授权
     */
    public function get_sina_oauth2Wwi(){
        $logic_connect_api = Logic('connect_api');
     ...
     * 新浪微博获取回调信息
     */
    public function get_sina_infoWwi(){
        $code = $_GET['code'];
        $client = $_GET['client'];
     ...
     * 微信获取应用唯一标识
     */
    public function get_wx_appidWwi(){
        output_data(C('app_weixin_appid'));
    }
    /**
     * 微信获取回调信息
     */
    public function get_wx_infoWwi(){
        $code = $_GET['code'];
     ...
     * 获取手机短信动态码
     */
    public function get_sms_captchaWwi(){
     ...
     * 验证手机动态码
     */
    public function check_sms_captchaWwi(){
        $phone = $_GET['phone'];
     ...
     * 手机注册
     */
    public function sms_registerWwi(){
        $phone = $_POST['phone'];
     ...
     * 手机找回密码
     */
    public function find_passwordWwi(){
        $phone = $_POST['phone'];
        $captcha = $_POST['captcha'];
        $password = $_POST['password'];
        $client = $_POST['client'];
