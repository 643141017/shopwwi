...
class indexControl extends mobileHomeControl{
     ...
     * android客户端版本号
     */
    public function apk_versionWwi() {
     ...
     * 默认搜索词列表
     */
    public function search_key_listWwi() {
     ...
     * 热门搜索列表
     */
    public function search_hot_infoWwi() {
        if (C('rec_search') != '') {
