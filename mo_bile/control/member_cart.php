...
class member_cartControl extends mobileMemberControl {
     ...
     * 购物车列表
     */
    public function cart_list_oldWwi() {
        $model_cart = Model('cart');
     ...
     * 更新购物车购买数量
     */
    public function cart_edit_quantityWwi() {
     ...
     */
    public function cart_batchaddWwi(){
        $param = $_POST;
