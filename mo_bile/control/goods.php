...
class goodsControl extends mobileHomeControl{
     ...
     * 商品详细页
     */
    public function goods_detailWwi() {
    ...
    public function goods_evaluateWwi() {
        $goods_id = intval($_GET['goods_id']);
     ...
     * 取得店铺分店地址
     */
    public function store_o2o_addrWwi() {
    ...
    public function auto_completeWwi() {
