...
class seller_statControl extends mobileSellerControl {
    ...
    public function ordersamountWwi() {
        $this->ordersstat('ordersamount');
    }
    public function ordersnumWwi() {
     ...
     * 客单价统计
     */
    public function perguestpriceWwi(){
        $model_stat = Model('stat');
        $where = array();
        $where['store_id'] = $this->store_info['store_id'];
        $where['order_isvalid'] = 1;//计入统计的有效订单
    ...
    public function goodsamountWwi() {
        $this->goodssales('goodsamount');
    }
    public function goodsnumWwi() {
    ...
    public function areasalesamountWwi() {
        $this->areasales('ordersamount');
    }
    public function areasalesnumWwi() {
        $this->areasales('ordersnum');
    }
    public function areamembernumWwi() {
