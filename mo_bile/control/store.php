...
class storeControl extends mobileHomeControl
{
     ...
     * 店铺商品分类
     */
    public function store_goods_classWwi()
    {
        $store_id = (int) $_REQUEST['store_id'];
        if ($store_id <= 0) {
            output_error('参数错误');
     ...
     * 店铺商品
     */
    public function store_goodsWwi()
    {
        $param = $_REQUEST;
     ...
     * 商品评价
     */
    public function store_creditWwi() {
     ...
     * 店铺商品排行
     */
    public function store_goods_rankWwi()
    {
        $store_id = (int) $_REQUEST['store_id'];
        if ($store_id <= 0) {
            output_data(array());
     ...
     * 店铺商品上新
     */
    public function store_new_goodsWwi(){
        $store_id = (int) $_REQUEST['store_id'];
        if ($store_id <= 0) {
     ...
     * 店铺简介
     */
    public function store_introWwi()
    {
        $store_id = (int) $_REQUEST['store_id'];
        if ($store_id <= 0) {
            output_error('参数错误');
 ...
 */
  ...
  */
  ...
  public function store_class_listWwi(){
  	$condition = array();
     ...
     * 店铺促销活动
     */
    public function store_promotionWwi(){
        $param = $_REQUEST;
        $store_id = (int) $param['store_id'];
        if ($store_id <= 0) {
            output_error('参数错误');
