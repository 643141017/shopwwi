...
class member_addressControl extends mobileMemberControl {
     ...
     * 地址列表
     */
    public function address_listWwi() {
     ...
     * 地址详细信息
     */
    public function address_infoWwi() {
     ...
     * 删除地址
     */
    public function address_delWwi() {
        $address_id = intval($_POST['address_id']);
     ...
     * 新增地址
     */
    public function address_addWwi() {
     ...
     * 编辑地址
     */
    public function address_editWwi() {
        $address_id = intval($_POST['address_id']);
