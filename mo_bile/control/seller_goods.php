...
class seller_goodsControl extends mobileSellerControl {
     ...
     * 商品详细信息
     */
    public function goods_image_infoWwi() {
        $common_id = $_POST['goods_commonid'];
        $model_goods = Model('goods');
     ...
     * 商品图片保存
     */
    public function goods_edit_imageWwi() {
