...
<script type="text/javascript">
    ...
    <a href="<?php echo $value['adv_url'];?>">
        <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_TFX.DS.'adv'.DS.$value['adv_image'];?>"/> 
    </a>
    </li>
    <?php } ?>
    <?php } else { ?>
        <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_TFX.DS.'default_store_list_banner.jpg';?>"/> 
    <?php } ?>
</ul>
</div>
<?php
