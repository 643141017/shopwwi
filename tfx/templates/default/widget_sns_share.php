...
$(document).ready(function(){
    ...
    $("#btn_sns_share").click(function(){
        $("#div_sns_share").tfx_form_show({width:480});
    });
    $("#div_sns_share").tfx_form({title:'<?php echo $lang['tfx_text_share'];?>'});
...
<div id="div_sns_share" style="display:none;">
    <form action="<?php echo TFX_SITE_URL;?>/index.php?app=share&wwi=share_save&type=<?php echo $_GET['app'];?>" method="post" id="share_form" class="feededitor">
        ...
        <div class="command-goods">
            <div class="pic">
                <span class="thumb size100">
                    <i></i>
                    <?php $personal_image_array = getTfxPersonalImageUrl($output['detail'],'tiny');?>
        ...
        <input type="hidden" value="<?php echo $output['detail']['tfx_store_id'];?>" name="share_id" id="share_id"></input>
        <div class="command-goods">
            <div class="pic">
                <span class="thumb size100">
                    <i></i>
        ...
        <dl class="share">
            <dt><?php echo $lang['tfx_sns_share_title'];?></dt>
            <dd></dd>
            <textarea name="commend_message" id="commend_message" ></textarea>
        </dl>
        <div class="handle"><input id="btn_publish" type="button" value="<?php echo $lang['tfx_text_share'];?>" /> <!-- 站外分享 -->
