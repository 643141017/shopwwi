...
<link href="<?php echo TFX_TEMPLATES_URL;?>/css/base.css" rel="stylesheet" type="text/css">
<link href="<?php echo TFX_TEMPLATES_URL;?>/css/layout.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="<?php echo TFX_RESOURCE_SITE_URL;?>/js/jquery.masonry.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/common.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo TFX_RESOURCE_SITE_URL;?>/js/common.js" charset="utf-8"></script>
<script type="text/javascript">
    ...
    $("[nc_type='bindbtn']").bind('click',function(){
            ...
            html_form("bindtooltip", "<?php echo $lang['tfx_share_account_link'];?>", html, 360, 0);
    ...
    $("#finishbtn").live('click',function(){
            ...
            eval( "data_str = "+data_str);
            //验证是否绑定成功
            var url = '<?php echo urlMember('member_sharemanage');?>&wwi=checkbind&callback=?';
...
<div class="public-top-layout w">
  <div class="topbar warp-all">
    <div class="user-entry">
      ...
      <?php echo $lang['nc_hello'];?><span><a href="<?php echo urlMall('member', 'home');?>"><?php echo str_cut($_SESSION['member_name'],20);?></a></span><?php echo $lang['nc_comma'],$lang['welcome_to_site'];?> <a href="<?php echo MALL_SITE_URL;?>"  title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><span><?php echo $output['setting_config']['site_name']; ?></span></a> <span>[<a href="<?php echo urlLogin('login','logout');?>"><?php echo $lang['nc_logout'];?></a>]</span>
      <?php }else{?>
      <?php echo $lang['nc_hello'].$lang['nc_comma'].$lang['welcome_to_site'];?> <a href="<?php echo MALL_SITE_URL;?>" title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><?php echo $output['setting_config']['site_name']; ?></a> <span>[<a href="<?php echo urlMall('login');?>"><?php echo $lang['nc_login'];?></a>]</span> <span>[<a href="<?php echo urlMall('login','register');?>"><?php echo $lang['nc_register'];?></a>]</span>
      <?php }?>
    </div>
    <div class="quick-menu">
      ...
      <dl>
        <dt><a href="<?php echo MALL_SITE_URL;?>/index.php?app=member_favorite_goods&wwi=fglist"><?php echo $lang['nc_favorites'];?></a><i></i></dt>
        <dd>
          <ul>
            <li><a href="<?php echo MALL_SITE_URL;?>/index.php?app=member_favorite_goods&wwi=fglist">商品收藏</a></li>
            <li><a href="<?php echo MALL_SITE_URL;?>/index.php?app=member_favorite_store&wwi=fslist">店铺收藏</a></li>
          </ul>
        </dd>
      </dl>
      <dl>
...
<header id="topHeader">
  <div class="warp-all">
    <div class="micro-logo"> <a href="<?php echo TFX_SITE_URL;?>">
      <?php if(C('tfx_logo')) { ?>
      <img src="<?php echo TFX_IMG_URL.DS.C('tfx_logo');?>" class="pngFix">
      <?php } else { ?>
      <img src="<?php echo TFX_IMG_URL.DS.'default_logo_image.png';?>" class="pngFix">
      <?php } ?>
      </a> </div>
    <div class="micro-header-pic"> <a href="<?php echo TFX_SITE_URL;?>">
      <?php if(C('tfx_header_pic')) { ?>
      <img src="<?php echo TFX_IMG_URL.DS.C('tfx_header_pic');?>" class="pngFix">
      <?php } else { ?>
      <img src="<?php echo TFX_IMG_URL.DS.'default_header_pic_image.png';?>" class="pngFix">
      <?php } ?>
      </a> </div>
    <div class="micro-search">
      ...
      <div class="ms-form">
        <form id="form_search" method="get" action="<?php echo TFX_SITE_URL;?>/index.php">
          <?php if(in_array($_GET['app'],array_keys($output['search_type']))) { ?>
...
<div id="navBar" class="pngFix">
  <div id="navBox">
    <ul class="nc-nav-menu">
      <li <?php echo $output['index_sign'] == 'index'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo TFX_SITE_URL;?>" class="pngFix"><span class="pngFix"><?php echo $lang['nc_index'];?></span></a></li>
      <li <?php echo $output['index_sign'] == 'goods'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo TFX_SITE_URL;?>/index.php?app=goods" class="pngFix"><span class="pngFix"><?php echo $lang['nc_tfx_goods'];?></span></a></li>
      <!--
      <li <?php echo $output['index_sign'] == 'album'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo TFX_SITE_URL;?>/index.php?app=album"><span><?php echo $lang['nc_tfx_album'];?></span></a></li>
      -->
      <li <?php echo $output['index_sign'] == 'personal'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo TFX_SITE_URL;?>/index.php?app=personal" class="pngFix"><span class="pngFix"><?php echo $lang['nc_tfx_personal'];?></span></a></li>
      <li <?php echo $output['index_sign'] == 'store'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo TFX_SITE_URL;?>/index.php?app=store" class="pngFix"><span class="pngFix"><?php echo $lang['nc_tfx_store'];?></span></a></li>
    </ul>
    <div class="microMall-user">
      <?php $member_avatar = TFX_TEMPLATES_URL.DS.'images'.DS.'default_user_portrait.gif' ?>
      ...
      <ul class="sub-menu">
        ...
        <li class="pngFix"><a href="javascript:void(0)"><span title="<?php echo $_SESSION['member_name'];?>"><?php echo $_SESSION['member_name'];?></span><i></i></a>
          <ul>
            <li><a href="<?php echo TFX_SITE_URL.'/index.php?app=home&wwi=goods'?>"><?php echo $lang['nc_tfx_goods'];?></a></li>
            <li><a href="<?php echo TFX_SITE_URL.'/index.php?app=home&wwi=personal'?>"><?php echo $lang['nc_tfx_personal'];?></a></li>
            <!--
            <li> <a href="<?php echo TFX_SITE_URL.'/index.php?app=home&wwi=album'?>"><?php echo $lang['nc_tfx_album'];?></a> </li>
            -->
          </ul>
        </li>
        <?php } else { ?>
        ...
        <li class="pngFix"><a href="javascript:void(0)"><?php echo $lang['nc_publish'];?><i></i></a>
          <ul>
            <li><a href="<?php echo TFX_SITE_URL.'/index.php?app=publish&wwi=goods_buy';?>"><?php echo $lang['tfx_goods_buy'];?></a> </li>
            <li><a href="<?php echo TFX_SITE_URL.'/index.php?app=publish&wwi=goods_favorites';?>"><?php echo $lang['tfx_goods_favorite'];?></a> </li>
            <li><a href="<?php echo TFX_SITE_URL.'/index.php?app=home&wwi=personal&publish=personal';?>"><?php echo $lang['nc_tfx_personal'];?></a> </li>
            <!--
            <li> <a href="<?php echo TFX_SITE_URL.'/index.php?app=publish&wwi=album';?>"><?php echo $lang['nc_tfx_album'];?></a> </li>
            -->
          </ul>
        </li>
        <li class="pngFix"><a href="javascript:void(0)"><?php echo $lang['tfx_text_like'];?><i></i></a>
          <ul>
            <li> <a href="<?php echo TFX_SITE_URL.'/index.php?app=home&wwi=like_list&type=goods'?>"><?php echo $lang['nc_tfx_goods'];?></a> </li>
            <!--
            <li> <a href="<?php echo TFX_SITE_URL.'/index.php?app=home&wwi=like_list&type=personal'?>"><?php echo $lang['nc_tfx_album'];?></a> </li>
            -->
            <li> <a href="<?php echo TFX_SITE_URL.'/index.php?app=home&wwi=like_list&type=personal'?>"><?php echo $lang['nc_tfx_personal'];?></a> </li>
            <li> <a href="<?php echo TFX_SITE_URL.'/index.php?app=home&wwi=like_list&type=store'?>"><?php echo $lang['nc_tfx_store'];?></a> </li>
          </ul>
        </li>
      </ul>
    </div>
