...
(function($) {
    $.fn.tfx_form_show = function(options) {
 ...
 */
(function($) {
    $.fn.tfx_publish = function(options,submit_function) {
...
(function($) {
    $.fn.tfx_like = function(options) {
        ...
        function submit_like() {
            var item = $(this);
            $.getJSON("index.php?app=like&wwi=like_save", { type: settings.type, like_id: item.attr("like_id") }, function(json){
                if(json.result == "true") {
                    if(settings.count_target == '') {
                        item.find("em").tfx_count({type:"+"});
                    } else {
                        settings.count_target.tfx_count({type:"+"});
                    }
                }
                $(".like_tooltips").hide();
