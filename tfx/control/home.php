...
class homeControl extends TfxControl{
    ...
    public function __construct() {
        ...
        Tpl::output('html_title',$member_info['member_name'].'-'.Language::get('nc_tfx').'-'.C('site_name'));
    ...
    public function like_listWwi() {
        ...
        case 'store':
            ...
            if(!empty($like_store_list)) {
                ...
                $store_list = $model_tfx_store->getListWithStoreInfo(array('tfx_store_id' => array('in' , $store_id)), null, 'tfx_sort asc');
            }
