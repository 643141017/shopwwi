...
class apiControl extends TfxControl{
     ...
     * 获取微商城名称
     */
    public function get_micro_nameWwi() {
        $result = '';
        $micro_name = Language::get('nc_tfx');
     ...
     * 推荐个人秀
     */
    public function get_personal_commendWwi(){
        $result = '';
        ...
        $condition_personal['tfx_commend'] = 1;
     ...
     * 个人秀分类
     */
    public function get_personal_classWwi(){
        $result = '';
     ...
     * 推荐店铺
     */
    public function get_store_commendWwi(){
        $result = '';
        $data_count = intval($_GET['data_count']);
        if($data_count <= 0) {
            $data_count = 10;
