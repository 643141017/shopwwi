...
class personalControl extends TfxControl{
    ...
    public function listWwi() {
        ...
        Tpl::output('html_title',Language::get('nc_tfx_personal').'-'.Language::get('nc_tfx').'-'.C('site_name'));
    ...
    public function detailWwi() {
        ...
        Tpl::output('html_title',$detail['commend_message'].'-'.Language::get('nc_tfx_personal').'-'.Language::get('nc_tfx').'-'.C('site_name'));
