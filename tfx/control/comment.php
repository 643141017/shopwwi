...
class commentControl extends TfxControl{
    ...
    public function comment_saveWwi() {
        ...
        if(!empty($_SESSION['member_id'])) {
            ...
            if($result) {
                ...
                $data['member_link'] = TFX_SITE_URL.'/index.php?app=home&member_id='.$_SESSION['member_id'];
                ...
                if(isset($_POST['share_app_items'])) {
                    ...
                    $info['type'] = $_GET['type'];
                    $info['url'] = TFX_SITE_URL.DS."index.php?app={$_GET['type']}&wwi=detail&{$_GET['type']}_id=".$_POST['comment_id'].'#widgetcommenttitle';
