<div class="eject_con">
  <form id="post_form" method="post" action="index.php?app=member_favorite_goods&wwi=log_msg&log_id=<?php echo $output['favorites']['log_id']; ?>" onsubmit="ajaxpost('post_form','','','onerror')">
