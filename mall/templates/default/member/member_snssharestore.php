...
<div class="dialog-share">
  <form method="post" action="index.php?app=member_snsindex&wwi=sharestore&<?php if($_GET['irefresh'] == 1){?>irefresh=1<?php }?>" id="sharestore_form">
	...
	$("#weibobtn_store").click(function(){
		if($("#sharestore_form").valid()){
			...
			if(cookienum >= max_recordnum && $("#ss_seccode").css('display') == 'none'){
				...
				$("#ss_seccode").find("[name='codeimage']").attr('src','index.php?app=seccode&wwi=makecode&nchash='+nchash+'&t=' + Math.random());
