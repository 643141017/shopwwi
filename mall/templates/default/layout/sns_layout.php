  ...
  <div class="wrapper">
    ...
    <div class="search">
      <form id="formSearch" name="formSearch" action="index.php" method="get">
        ...
        <input id="keyword" class="wwi-ss-search-input-text" type="text" lang="zh-CN" x-webkit-grammar="builtin:search" onwebkitspeechchange="foo()" x-webkit-speech="" name="keyword" style="color: rgb(153, 153, 153);">
        <a class="wwi-ss-search-btn-mall" nctype="search_in_mall" href="javascript:void(0)" onClick="$('#formSearch').submit();"> <span><?php echo $lang['nc_common_search'];?></span> </a>
      </form>
    </div>
    ...
    <ul class="menu">
      ...
      <li><a href="javascript:void(0)" class="my-friend"><?php echo $lang['sns_my_attention'];?><i></i></a>
        <div class="friend-menu">
          ...
          <p>
            <?php if(!empty($output['my_attention'])){?>
            <a href="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_snsfriend&wwi=follow"><?php echo $lang['sns_attention_more'];?></a>
            <?php }else{?>
            <a href="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_snsfriend&wwi=find"><?php echo $lang['sns_search_friend'];?></a>
            <?php }?>
          </p>
        </div>
      </li>
...
<div id="container" class="wrapper mt20">
  ...
  <div class="sns-nav">
    <ul>
      <li><a <?php if($output['menu_sign'] == 'snshome'){?>class="current"<?php }?> href="index.php?app=member_snshome<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><i class="home pngFix"></i><?php echo $lang['nc_index'];?></a></li>
      <li><a <?php if($output['menu_sign'] == 'sharegoods'){?>class="current"<?php }?> href="index.php?app=member_snshome&wwi=shareglist<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><i class="goods pngFix"></i><?php echo $lang['sns_treasure'];?></a></li>
      <li><a <?php if($output['menu_sign'] == 'sharestore'){?>class="current"<?php }?> href="index.php?app=member_snshome&wwi=storelist<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><i class="store pngFix"></i><?php echo $lang['sns_store'];?></a></li>
      ...
      <li><a <?php if($output['menu_sign'] == 'snstrace'){?>class="current"<?php }?> href="index.php?app=member_snshome&wwi=trace<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><i class="news pngFix"></i><?php echo $lang['sns_fresh_news'];?></a></li>
      <?php if(intval(C('tyq_isuse'))){?>
      <li><a <?php if($output['menu_sign'] == 'tyq'){?>class="current"<?php }?> href="index.php?app=sns_tyq<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><i class="tyq pngFix"></i><?php echo $lang['sns_group'];?></a></li>
      <?php }?>
    </ul>
    <?php if($output['relation'] == '3'){?>
...
$(function(){
  ...
  $(".my-friend").click(function(){
	...
	$('a[nctype="change_skin"]').click(function(){
		ajax_form('change_skin', '<?php echo $lang['sns_change_skin'];?>', SITEURL + '/index.php?app=sns_setting&wwi=change_skin', '480');
	});
});
</script>
</body>
