...
<div class="ncm-container">
  <div class="ncm-header">
    <div class="ncm-header-top">
      <div class="ncm-member-info">
        <div class="avatar"><a href="<?php echo urlMember('member_information', 'avatar');?>" title="修改头像"><img src="<?php echo getMemberAvatar($output['member_info']['member_avatar']);?>">
          ...
          <a href="<?php echo MEMBER_SITE_URL?>/index.php?app=member_message&wwi=message" class="new-message" title="新消息"><?php echo intval($output['message_num']); ?></a>
          <?php }?>
        </div>
        <dl>
    ...
    <div class="ncm-header-nav">
      <ul class="nav-menu">
        <li><a href="<?php echo urlMall('member', 'home');?>" class="current">我的门店</a></li>
        <li class="set"><a href="<?php echo urlMall('member', 'home');?>">我的商城<i></i></a>
          <div class="sub-menu">
            <dl>
        ...
        <li><a href="###">其他应用<i></i></a>
          <div class="sub-menu">
            <dl>
              <dd><a href="<?php echo urlTZX('member_article', 'article_list');?>">我的TZX</a></dd>
              <dd><a href="<?php echo urlTyq('p_center', 'index');?>">我的圈子</a></dd>
              <dd><a href="<?php echo urlTfx('home', 'index', array('member_id' => $_SESSION['member_id']));?>">我的微商城</a></dd>
            </dl>
          </div>
        </li>
      </ul>
