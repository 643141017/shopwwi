...
$(function(){
  ...
  $('.cityItem p a').click(function(){
		...
		var url = '<?php echo MALL_SITE_URL;?>/index.php?app=index&wwi=save_city&city='+city;
...
<nav class="public-nav-layout <?php if($output['channel']) {echo 'channel-'.$output['channel']['channel_style'].' channel-'.$output['channel']['channel_id'];} ?>">
  <div class="wrapper">
    ...
    <div class="navCont">
      ...
      <a href="<?php echo urlMall('pointmall', 'index');?>"> <?php echo $lang['nc_pointprod'];?></a>
      <?php } ?>
            ...
            <a href="<?php echo urlMall('store_list', 'index');?>" <?php if($output['index_sign'] == 'store_list' && $output['index_sign'] != '0') {echo 'class="now"';} ?>>淘店铺</a>
                        <?php if (C('tzx_isuse')){ ?>
            <a href="<?php echo TZX_SITE_URL;?>" <?php if($output['index_sign'] == 'tzx' && $output['index_sign'] != '0') {echo 'class="now"';} ?>>淘资讯</a><?php } ?>
            	<?php if (C('tyq_isuse')){ ?>
