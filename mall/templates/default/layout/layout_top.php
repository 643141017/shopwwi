            ...
            <dl>
              ...
              <dd>
                ...
                <label></label>
                        ...
                        <dl>
              <dt><strong>验证码</strong><a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='index.php?app=seccode&amp;wwi=makecode&amp;nchash=<?php echo getNchash('login','index');?>&amp;t=' + Math.random();">更换验证码</a></dt>
              <dd>
...
$(function() {
    ...
    $("#rtoolbar_cart").click(function(){
        if ($("#content-cart").css('right') == '-210px') {
    		...
    		if (!$("#rtoolbar_cartlist").html()) {
    			$("#rtoolbar_cartlist").load('index.php?app=cart&wwi=ajax_load&type=html');
    		}
        } else {
        	$(".close").click();
        	$(".chat-list").css("display",'none');
    ...
    $('div[nctype="a-barLoginBox"]').click(function(){
        ...
        document.getElementById('codeimage').src='index.php?app=seccode&wwi=makecode&nchash=<?php echo getNchash('login','index');?>&t=' + Math.random();
    });
