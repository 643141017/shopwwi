...
<style>.wwi_store_head { background: url("	<?php if(!empty($output['store_info']['store_banner'])){?> <?php echo getStoreLogo($output['store_info']['store_banner'],'store_logo');?> <?php }else{?><?php echo getStoreLogo('default_top.jpg');?> <?php }?>") no-repeat center 0;</style>
