...
<?php } ?>
<header class="wwist-head-layout w">
	<div class="topbar">
...
<div class="wrapper">
    ...
    <nav class="wwist-nav">
      <dl class="<?php echo $output['current_menu']['model'] == 'index'?'current':'';?>">
        <dt><a href="index.php?app=seller_center&wwi=index">首页</a></dt>
        <dd class="arrow"></dd>
      </dl>
      <?php if(!empty($output['menu']) && is_array($output['menu'])) {?>
      <?php foreach($output['menu'] as $key => $menu_value) {?>
      <dl class="<?php echo $output['current_menu']['model'] == $key?'current':'';?>">
        <dt><a href="index.php?app=<?php echo $menu_value['child'][key($menu_value['child'])]['app'];?>&wwi=<?php echo $menu_value['child'][key($menu_value['child'])]['wwi'];?>"><?php echo $menu_value['name'];?></a></dt>
        <dd>
          <ul>
            <?php if(!empty($menu_value['child']) && is_array($menu_value['child'])) {?>
            <?php foreach($menu_value['child'] as $submenu_value) {?>
            <li> <a href="index.php?app=<?php echo $submenu_value['app'];?>&wwi=<?php echo $submenu_value['wwi'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
            <?php } ?>
            <?php } ?>
          </ul>
        </dd>
...
<div class="wwist-layout wrapper">
    ...
    <div id="sidebar" class="sidebar">
      ...
      <div class="column-menu">
        <ul id="seller_center_left_menu">
          ...
          <li <?php echo $_GET['app'] == 'seller_center'?"id='quicklink_".$submenu_value['app']."'":'';?>class="<?php echo $submenu_value['app'] == $_GET['app']?'current':'';?>"> <a href="index.php?app=<?php echo $submenu_value['app'];?>&wwi=<?php echo $submenu_value['wwi'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
          <?php } ?>
          <?php } else { ?>
  ...
  <div id="layoutRight" class="wwist-layout-right">
    <div class="wwist-path"><i class="icon-desktop"></i>商家管理中心<i class="icon-angle-right"></i><?php echo $output['current_menu']['model_name'];?><i class="icon-angle-right"></i><?php echo $output['current_menu']['name'];?></div>
