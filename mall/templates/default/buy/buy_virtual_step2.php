...
<form action="<?php echo urlMall('buy_virtual','buy_step3');?>" method="POST" id="form_buy" name="form_buy">
  ...
  <div class="ncc-receipt-info">
    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tfoot>
        <tr>
          <td colspan="20"><a href="index.php?app=buy_virtual&wwi=buy_step1&goods_id=<?php echo $_POST['goods_id'];?>&quantity=<?php echo $_POST['quantity'];?>" class="ncc-prev-btn"><i class="icon-angle-left"></i>返回上一步</a><div class="ncc-all-account">订单总金额：<em id="orderTotal"><?php echo $output['goods_info']['goods_total']; ?></em>元</div><a id="submitOrder" href="javascript:void(0)" class="ncc-next-submit ok">提交订单</a></td>
        </tr>
      </tfoot>
    </table>
  </div>
