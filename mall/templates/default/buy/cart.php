  ...
  <form action="<?php echo urlMall('buy','buy_step1');?>" method="POST" id="form_buy" name="form_buy">
    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        ...
        <tr id="cart_item_<?php echo $cart_info['cart_id'];?>" nc_group="<?php echo $cart_info['cart_id'];?>" class="mall-list <?php echo $cart_info['state'] ? '' : 'item_disabled';?>">
...
<?php } ?> /></td>
 ...
 <?php if($cart_info['pf_num3']>0){?><p>数量:≥<?php echo $cart_info['pf_num3']; ?> 单价:<?php echo $cart_info['pf_price3']; ?>元</p><?php }?>
        ...
        <tr class="mall-list <?php echo $cart_info['state'] ? '' : 'item_disabled';?> bundling-list" nc_group="<?php echo $cart_info['cart_id'];?>">
...
$(function() {
    ...
    $('div[nctype="get_voucher"]').on('click', 'a[data-tid]', function(){
        ...
        ajaxget('index.php?app=voucher&wwi=getvouchersave&jump=0&tid=' + _tid);
    });
	//
...
window.jjgCallback = (function(jjgDetails) {
    ...
    var jjgCost = function(id) {
        ...
        var c = 0;
        $items.filter(':checked').parents('tr.mall-list').find("em[nc_type='eachGoodsTotal']").each(function() {
