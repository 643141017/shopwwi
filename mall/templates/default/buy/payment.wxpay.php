...
<div class="ncc-main">
  ...
  <div class="wxpayment"> 
    ...
    <div class="pay-weixin">
      ...
      <div class="p-w-bd">
        <div class="p-w-box">
          <div class="pw-box-hd"> <img width="298" src="<?php echo MALL_SITE_URL?>/index.php?app=payment&wwi=qrcode&data=<?php echo urlencode($output['pay_url']);?>"> </div>
          <div class="pw-box-ft">
            <p>请使用微信扫一扫</p>
            <p>扫描二维码支付</p>
          </div>
...
function queryOrderState(){
    $.ajax({
        type: "GET",
        url: "<?php echo MALL_SITE_URL?>/index.php?app=payment&wwi=query_state&<?php echo $output['args'];?>",
        data: "",
        dataType: "json",
        timeout: 4000,
        async:false,
        success: function(result) {
            if(result.state==1){
                if (result.type == 'r') {
                	...
                	window.location.href = '<?php echo MALL_SITE_URL.'/index.php?app=member_vr_order&wwi=index'?>';
                }
            }
        }
    });
