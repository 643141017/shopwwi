...
<div class="ncc-form-default">
  <form method="POST" id="addr_form" action="index.php">
    ...
    <input type="hidden" value="add_addr" name="wwi">
...
$(document).ready(function(){
	var chain = function(area_id){
	    $.getJSON(SITEURL + '/index.php?app=buy&wwi=load_chain&area_id=' + area_id + '&store_id=' + chain_store_id + '&callback=?',function(data){
