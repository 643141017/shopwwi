...
<div class="wwist-index">
  <div class="top-container">
    <div class="basic-info">
      <dl class="wwist-seller-info">
        <dt class="seller-name">
		 ...
		 <?php }else{
				echo '<a href="index.php?app=seller_center&wwi=distribution" style=" background:#48CFAE;padding:5px; color:#fff;">申请开通分销</a>';
				}
		 }else{
        ...
        <dd class="store-name"><?php echo $lang['store_name'].$lang['nc_colon'];?><a href="<?php echo urlMall('show_store', 'index', array('store_id' => $_SESSION['store_id']), $output['store_info']['store_domain']);?>" ><?php echo $output['store_info']['store_name'];?></a></dd>
        ...
        <dd class="store-validity"><?php echo $lang['store_validity'].$lang['nc_colon'];?><strong><?php echo $output['store_info']['store_end_time_text'];?>
          ...
          <a href="index.php?app=store_info&wwi=reopen">马上续签</a>
          <?php } ?>
          </strong> </dd>
      </dl>
  ...
  <div class="seller-cont">
    <div class="container type-a">
      ...
      <div class="content">
        ...
        <ul>
          <li><a href="index.php?app=store_goods_online&wwi=index"><?php echo $lang['store_goods_selling'];?> <strong id="nc_online"></strong></a></li>
          <?php if (C('goods_verify')) {?>
          <li><a href="index.php?app=store_goods_offline&wwi=index&type=wait_verify&verify=10" title="<?php echo $lang['store_inform30'];?>">发布待平台审核 <strong id="nc_waitverify"></strong></a></li>
          <li><a href="index.php?app=store_goods_offline&wwi=index&type=wait_verify&verify=0" title="<?php echo $lang['store_inform30'];?>">平台审核失败 <strong id="nc_verifyfail"></strong></a></li>
          <?php }?>
          <li><a href="index.php?app=store_goods_offline&wwi=index"><?php echo $lang['store_goods_storage'];?> <strong id="nc_offline"></strong></a></li>
          <li><a href="index.php?app=store_goods_offline&wwi=index&type=lock_up"><?php echo $lang['store_goods_show0'];?> <strong id="nc_lockup"></strong></a></li>
          <li><a href="index.php?app=store_consult&wwi=consult_list&type=to_reply"><?php echo $lang['store_to_consult'];?> <strong id="nc_consult"></strong></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="container type-a">
      ...
      <div class="content">
        <dl class="focus">
          ...
          <dd><a href="index.php?app=store_order"><?php echo $lang['store_order_progressing'];?> <strong id="nc_progressing"></strong></a></dd>
          <dt><?php echo $lang['store_complain_info'].$lang['nc_colon'];?></dt>
          <dd><a href="index.php?app=store_complain&select_complain_state=1"><?php echo $lang['store_complain'];?> <strong id="nc_complain"></strong></a></dd>
        </dl>
        <ul>
          <li><a href="index.php?app=store_order&wwi=index&state_type=state_new"><?php echo $lang['store_order_pay'];?> <strong id="nc_payment"></strong></a></li>
          <li><a href="index.php?app=store_order&wwi=index&state_type=state_pay"><?php echo $lang['store_shipped'];?> <strong id="nc_delivery"></strong></a></li>
          <li><a href="index.php?app=store_refund&lock=2"> <?php echo '售前退款';?> <strong id="nc_refund_lock"></strong></a></li>
          <li><a href="index.php?app=store_refund&lock=1"> <?php echo '售后退款';?> <strong id="nc_refund"></strong></a></li>
          <li><a href="index.php?app=store_return&lock=2"> <?php echo '售前退货';?> <strong id="nc_return_lock"></strong></a></li>
          <li><a href="index.php?app=store_return&lock=1"> <?php echo '售后退货';?> <strong id="nc_return"></strong></a></li>
          <li><a href="index.php?app=store_bill&wwi=index&bill_state=1"> <?php echo '待确认账单';?> <strong id="nc_bill_confirm"></strong></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="container type-d h500">
      ...
      <div class="content">
        ...
        <dl class="xszk">
          <dt class="p-name"><a href="index.php?app=store_promotion_xianshi&wwi=xianshi_list"><?php echo $lang['store_xianshi'];?></a></dt>
          <dd class="p-ico"></dd>
        ...
        <dl class="mjs">
          <dt class="p-name"><a href="index.php?app=store_promotion_mansong&wwi=mansong_list"><?php echo $lang['store_mansong'];?></a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
        ...
        <dl class="zhxs">
          <dt class="p-name"><a href="index.php?app=store_promotion_bundling&wwi=bundling_list"><?php echo $lang['store_bundling'];?></a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
        ...
        <dl class="tjzw">
          <dt class="p-name"><a href="index.php?app=store_promotion_booth&wwi=booth_list">推荐展位</a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
...
$(function(){
    ...
    $.getJSON('index.php?app=seller_center&wwi=statistics&rand='+timestamp, null, function(data){
