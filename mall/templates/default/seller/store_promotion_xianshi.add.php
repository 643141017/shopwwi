...
<div class="wwist-form-default">
    ...
    <form id="add_form" action="index.php?app=store_promotion_xianshi&wwi=xianshi_save" method="post">
    <?php } else { ?>
    <form id="add_form" action="index.php?app=store_promotion_xianshi&wwi=xianshi_edit_save" method="post">
...
<?php } ?>
    ...
    <dl>
      ...
      <dd>
      <div class="wwist-upload-thumb xianshi-pic">
        ...
        <input nctype="xianshi_image" name="xianshi_image" type="hidden" value="<?php echo $output['xianshi_info']['xianshi_image'];?>">
        <div class="wwist-upload-btn">
    ...
    <dl>
      <dt>限时推荐位图片<?php echo $lang['nc_colon'];?></dt>
      <dd>
      <div class="wwist-upload-thumb xianshi-commend-pic">
        ...
        <dl>
      <dt>品牌图片<?php echo $lang['nc_colon'];?></dt>
      <dd>
      <div class="wwist-upload-thumb xianshi-commend-pic2">
      ...
      <dd>
        ...
        <p class="hr8"><a class="des_demo ncbtn" href="index.php?app=store_album&wwi=pic_list&item=groupbuy"><i class="icon-picture"></i>插入相册图片</a></p>
