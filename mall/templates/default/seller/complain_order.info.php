...
<div class="wwist-flow-item">
  ...
  <div class="item-goods">
    ...
    <dl>
      <dt>
        <div class="wwist-goods-thumb-mini"><a href="<?php echo urlMall('goods','index',array('goods_id'=> $val['goods_id'])); ?>" target="_blank"> <img src="<?php echo thumb($val,60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($val,240); ?>>')" onMouseOut="toolTip()" /> </a></div>
      </dt>
  ...
  <div class="item-order">
    ...
    <dl class="line">
      ...
      <dd><a href="<?php echo MALL_SITE_URL;?>/index.php?app=store_order&wwi=show_order&order_id=<?php echo $output['order']['order_id'];?>" target="_blank"> <?php echo $output['order']['order_sn'];?> </a><a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
