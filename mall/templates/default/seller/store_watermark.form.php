...
<div class="wwist-form-default">
  <form method="post" enctype="multipart/form-data" action="index.php?app=store_album&wwi=store_watermark" id="wm_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <div class="wwist-upload-thumb watermark-pic"><p><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_WATERMARK.DS.$output['store_wm_info']['wm_image_name'];?>" id="imgView"/></p><a href="javascript:void(0);" id="del_image" title="<?php echo $lang['store_watermark_del_pic'];?>">X</a>
          <input type="hidden" id="is_del_image" name="is_del_image" value=""/>
        </div>
        <?php }else{?>
        <div class="wwist-upload-thumb watermark-pic"><p><i class="icon-picture"></i></p></div>
        <?php }?>
    ...
    <dl>
      ...
      <dd>
        <ul class="wwist-watermark-pos" id="wm_image_pos">
          <li>
    ...
    <dl>
      ...
      <dd>
        <ul class="wwist-watermark-pos" id="wm_text_pos">
