<link type="text/css" rel="stylesheet" href="<?php echo RESOURCE_SITE_URL."/js/jquery-ui/themes/ui-lightness/jquery.ui.css";?>"/>
  ...
  <div class="tabmenu">
	...
	<div class="wwist-form-default">
	  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=store_voucher&wwi=<?php echo $output['type']=='add'?'templateadd':'templateedit'; ?>">
	  	<input type="hidden" id="app" name="app" value="store_voucher"/>
	  	<?php if ($output['type'] == 'add'){?>
	  	<input type="hidden" id="wwi" name="wwi" value="templateadd"/>
	  	<?php }else {?>
	  	<input type="hidden" id="wwi" name="wwi" value="templateedit"/>
...
<?php } ?>
	    ...
	    <dl>
	      ...
	      <dd>
          <div id="customimg_preview" class="wwist-upload-thumb voucher-pic"><p><?php if ($output['t_info']['voucher_t_customimg']){?>
