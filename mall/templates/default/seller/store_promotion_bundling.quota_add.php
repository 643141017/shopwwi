...
<div class="wwist-form-default">
  ...
  <form id="add_form" action="index.php?app=store_promotion_bundling&wwi=bundling_quota_add" method="post">
  <?php } else {?>
  <form id="add_form" action="index.php?app=store_promotion_bundling&wwi=bundling_renew" method="post">
  <?php }?>
