<?php defined('ByShopWWI') or exit('Access Invalid!');?>
  <form method="get" id="formSearch">
    <table class="search-form">
      ...
      <input type="hidden" id='wwi' name='wwi' value='show_bill' />
...
<table class="wwist-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
       	<a target="_blank" href="index.php?app=store_vr_order&wwi=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
...
$(function(){
    $('#ncexport').click(function(){
    	$('input[name="wwi"]').val('export_order');
    	$('#formSearch').submit();
    });
    $('#ncsubmit').click(function(){
    	$('input[name="wwi"]').val('show_bill');
    	$('#formSearch').submit();
    });
});
</script>