...
<div class="wwist-chat-layout"><table class="search-form">
      <tr><td class="w10"></td>
...
<script>
    ...
    function select_seller(seller_id){
        ...
        var ajaxurl = 'index.php?app=store_im&wwi=get_user_list&seller_id='+select_id;
    ...
    function store_chat_log(user_id){
        var ajaxurl = 'index.php?app=store_im&wwi=get_chat_log&seller_id='+select_id;
