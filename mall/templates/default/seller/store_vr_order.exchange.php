...
<div class="wwist-vr-order-exchange">
    <dl>
      <dt><h3>电子兑换码</h3></dt>
      <dd>
...
$(document).ready(function(){
    ...
    Tpl += "<td>NC_CODE</td>\n";
    Tpl += "<td class=\"w70\"><div class=\"wwist-goods-thumb\"><a target=\"_blank\" href=\"NC_GOODS_URL\"><img onmouseout=\"toolTip()\" onmouseover=\"toolTip('<img src=NC_IMG240>')\" src=\"NC_IMG60\"></a></div></td>\n";
    ...
    function exPost() {
		$('#vr_code_waring').html('');
	    $.getJSON('index.php?app=store_vr_order&wwi=exchange&form_submit=ok&vr_code='+$("#vr_code").val(),null, function(data){
