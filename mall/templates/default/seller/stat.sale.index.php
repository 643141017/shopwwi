...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    ...
    <input type="hidden" name="wwi" value="sale" />
    <tr>
    	<td class="tr">
    		<div class="fr">
...
$(function(){
	...
	$('#statlist').load('index.php?app=statistics_sale&wwi=salelist&t=<?php echo $output['searchtime'];?>&order_type=<?php echo $_REQUEST['order_type'];?>');
});
</script>