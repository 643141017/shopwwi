...
<?php 
$control_flag = false;
if($_GET['wwi'] == 'decoration_edit' || $_GET['wwi'] == 'decoration_block_add') { 
    $control_flag = true;
} 
...
<div id="block_<?php echo $block['block_id'];?>" data-block-id="<?php echo $block['block_id'];?>" nctype="store_decoration_block" class="wwist-decration-block store-decoration-block-1 <?php echo $extend_class;?> tip" title="<?php echo $block_title;?>">
    <div nctype="store_decoration_block_content" class="wwist-decration-block-content store-decoration-block-1-content">
