...
<div class="wwist-flow-layout">
  <div class="wwist-flow-container">
    <div class="title">
      <h3>物流详情</h3>
    </div>
  ...
  <div class="wwist-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="wwist-goods-thumb-mini"><a target="_blank" href="<?php echo urlMall('goods','index',array('goods_id'=>$goods['goods_id']));?>"><img src="<?php echo thumb($goods, 60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($goods,'240'); ?>>')" onMouseOut="toolTip()"/></a></div>
        </dt>
...
$(function(){
	...
	$.getJSON('index.php?app=seller_center&wwi=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
		if(data){
			data = var_send+data;
