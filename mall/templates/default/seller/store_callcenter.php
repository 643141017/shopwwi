...
<div class="wwist-form-default">
  ...
  <form method="post" action="index.php?app=store_callcenter&wwi=save" id="callcenter_form" onsubmit="ajaxpost('callcenter_form','','','onerror')" class="wwi-ss-message">
    <input type="hidden" name="form_submit" value="ok" />
    <dl nctype="pre">
      <dt><?php echo $lang['store_callcenter_presales_service'].$lang['nc_colon']?></dt>
      <dd>
        <div class="wwi-ss-message-title"><span class="name"><?php echo $lang['store_callcenter_service_name'];?></span><span class="tool"><?php echo $lang['store_callcenter_service_tool'];?></span><span class="number"><?php echo $lang['store_callcenter_service_number'];?></span></div>
        <?php if(empty($output['storeinfo']['store_presales'])){?>
        <div class="wwi-ss-message-list"><span class="name tip" title="<?php echo $lang['store_callcenter_name_title'];?>">
    ...
    <dl >
      ...
      <dd>
        <div class="wwi-ss-message-title"><span><?php echo $lang['store_callcenter_working_time_title'];?></span></div>
        <div>
...
function add_service(param){
	...
	var add_html = '';
	add_html += '<div class="wwi-ss-message-list">';
