          ...
          <tfoot>
            <tr>
              <th colspan="10"><span><?php echo $lang['member_printorder_totle'].$lang['nc_colon'];?><?php echo $lang['currency'].$item_v['goods_total_price'];?></span><span><?php echo $lang['member_printorder_freight'].$lang['nc_colon'];?><?php echo $lang['currency'].$item_v['shipping_fee'];?></span><span><?php echo $lang['member_printorder_privilege'].$lang['nc_colon'];?><?php echo $lang['currency'].$item_v['promotion_amount'];?></span><span><?php echo $lang['member_printorder_orderamount'].$lang['nc_colon'];?><?php echo $lang['currency'].$item_v['order_amount'];?></span><span><?php echo $lang['member_printorder_mall'].$lang['nc_colon'];?><?php echo $item_v['store_info']['store_name'];?></span>
                ...
                <span><?php echo $lang['member_printorder_mallww'].$lang['nc_colon'];?><?php echo $item_v['store_info']['store_ww'];?></span>
                <?php }?></th>
            </tr>
          </tfoot>
        </table>
