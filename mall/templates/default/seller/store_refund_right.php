...
<div class="wwist-flow-item">
  ...
  <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="wwist-goods-thumb-mini"><a target="_blank" href="<?php echo urlMall('goods','index',array('goods_id'=> $val['goods_id'])); ?>">
  ...
  <div class="item-order">
    ...
    <dl class="line">
      <dt>订单编号：</dt>
      <dd><a target="_blank" href="index.php?app=store_order&wwi=show_order&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['order_sn'];?></a> <a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
