...
<table class="wwist-default-table order">
  ...
  <tbody>
    ...
    <tr>
      <td class="bdl"></td>
      <td class="w70"><div class="wwist-goods-thumb"><a href="<?php echo urlMall('goods','index',array('goods_id'=>$order['goods_id']));?>" target="_blank"><img src="<?php echo thumb($order,60);?>" onMouseOver="toolTip('<img src=<?php echo thumb($order,240);?>>')" onMouseOut="toolTip()"/></a></div></td>
      ...
      <td class="bdl"><p class="wwist-order-amount"><?php echo $order['order_amount']; ?></p>
