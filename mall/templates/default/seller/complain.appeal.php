...
<div class="wwist-flow-layout" id="ncscComplainFlow">
  <div class="wwist-flow-container">
    ...
    <div class="wwist-form-default">
      ...
      <form action="index.php?app=store_complain&wwi=appeal_save" method="post" id="add_form" enctype="multipart/form-data">
