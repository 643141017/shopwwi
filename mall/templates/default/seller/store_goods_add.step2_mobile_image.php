<a href="javascript:void(0);" nctype="meai_cancel" class="ncbtn mt5"><i class=" icon-tyq-arrow-up"></i>关闭相册</a>
<div class="goods-gallery add-step2"><a class='sample_demo' id="select_submit" href="index.php?app=store_album&wwi=pic_list&item=goods" style="display:none;"><?php echo $lang['nc_submit'];?></a>
...
$(function(){
    ...
    $('#jumpMenu').change(function(){
        $('[nctype="mea_img"]').load('index.php?app=store_album&wwi=pic_list&item=mobile<?php if ($output['type'] == 'replace') {?>&type=replace<?php }?>&id=' + $(this).val());
    });
});
</script>