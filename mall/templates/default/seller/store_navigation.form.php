...
<div class="wwist-form-default">
  <form method="post" action="index.php?app=store_navigation&wwi=navigation_save" target="_parent" name="store_navigation_form" id="store_navigation_form" enctype="multipart/form-data">
