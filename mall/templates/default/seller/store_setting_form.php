...
<div class="wwist-form-default">
  <form method="post"  action="index.php?app=store_setting&wwi=store_setting" enctype="multipart/form-data" id="my_store_form">
    ...
    <dl>
      ...
      <dd>
        <div class="wwist-upload-thumb store-logo" nctype="store_label">
    ...
    <dl>
      ...
      <dd>
        <div class="wwist-upload-thumb store-banner" nctype="store_banner">
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'index.php?app=cut&wwi=pic_upload&form_submit=ok&uploadpath=<?php echo ATTACH_STORE;?>',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['nc_cut'];?>','index.php?app=cut&wwi=pic_cut&x=100&y=100&resize=1&url='+data.url,680);
					}else{
