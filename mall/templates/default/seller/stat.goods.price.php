...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    ...
    <input type="hidden" name="wwi" value="price" />
    <tr>
    	<td class="tr">
    		<div class="fl"><a class="ncbtn-mini tip" title="点击进入设置价格区间页面，下方统计图将根据您设置的价格区间进行统计" href="index.php?app=statistics_general&wwi=pricesetting" target="_blank">设置价格区间</a></div>
    		<div class="fr">
...
<table id="pricerang_table" class="wwist-default-table">
  <tbody>
	<tr id="row_0">
		<td class="tl">
    		...
    		<?php } else { ?>
    		<div class="tc h50 mt10">查看分布情况前，请先设置价格区间。<a href="index.php?app=statistics_general&wwi=pricesetting">马上设置</a></div>
    		<?php }?>
		</td>
	</tr>
  </tbody>
...
$(function(){
	...
	$("[name='searchweek_month']").change(function(){
		...
		$.getJSON('index.php?app=index&wwi=getweekofmonth',{y:year,m:month},function(data){
	        if(data != null){
