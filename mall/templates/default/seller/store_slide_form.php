...
<div class="wwist-form-default"> <div class="alert">
      <ul>
  ...
  <form action="index.php?app=store_setting&wwi=store_slide" id="store_slide_form" method="post" onsubmit="ajaxpost('store_slide_form', '', '', 'onerror');return false;">
    <input type="hidden" name="form_submit" value="ok" />
    <!-- 图片上传部分 -->
    <ul class="wwist-store-slider" id="goods_images">
      <?php for($i=0;$i<5;$i++){?>
