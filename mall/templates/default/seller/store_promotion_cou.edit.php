...
?>
<div class="wwist-form-default">
  <form id="add_form" action="index.php?app=store_promotion_cou&wwi=cou_edit_save" method="post">
    ...
    <dl>
      ...
      <dd>
        <p> <span></span> </p>
        <table class="wwist-default-table mb15">
          <thead>
            <tr>
...
if (empty($g)) continue; ?>
            <tr class="off-shelf" data-product-id="<?php echo $g['goods_id']; ?>">
              ...
              <td class="nscs-table-handle w50"><span> <a href="javascript:;" class="btn-bittersweet" data-cou-sku-remove-button="<?php echo $g['goods_id']; ?>"> <i class="icon-ban-tyq"></i>
                <p>移除</p>
                </a> </span></td>
            </tr>
<?php } ?>
          ...
          <tbody id="cou-sku-item-tpl" style="display:none;">
            <tr class="off-shelf" data-product-id="__id">
              ...
              <td class="nscs-table-handle w50"><span> <a href="javascript:;" class="btn-bittersweet" data-cou-sku-remove-button="__id"> <i class="icon-ban-tyq"></i>
                <p>移除</p>
                </a> </span></td>
            </tr>
          </tbody>
        </table>
        <a id="cou-sku-choose-btn" href="index.php?app=store_promotion_cou&wwi=cou_sku&cou_id=<?php echo $info['id']; ?>" class="ncbtn ncbtn-aqua">选择活动商品</a>
...
<?php foreach ((array) $output['data']['levels'] as $k => $v) { ?>
        <div data-cou-level-item="<?php echo (string) $k; ?>" class="wwist-cou-rule">
          <div class="rule-note">
...
if (empty($g)) continue; ?>
              <tr class="off-shelf" data-cou-level-selected-sku="<?php echo (string) $k2; ?>" data-level="<?php echo (string) $k; ?>">
                ...
                <td class="nscs-table-handle w50"><span> <a href="javascript:;" class="btn-bittersweet" data-cou-level-sku-remove="<?php echo (string) $k2; ?>"> <i class="icon-ban-tyq"></i>
                  <p>移除</p>
                  </a> </span></td>
              </tr>
<?php } ?>
...
<div id="cou-level-newly" style="display:none;">
        <div data-cou-level-item="__level" class="wwist-cou-rule">
          <div class="rule-note">
...
<table style="display:none;">
  <tbody id="cou-level-sku-newly">
    <tr class="off-shelf" data-cou-level-selected-sku="__id" data-level="__level">
      ...
      <td class="nscs-table-handle w50"><span> <a href="javascript:;" class="btn-bittersweet" data-cou-level-sku-remove="__id"> <i class="icon-ban-tyq"></i>
        <p>移除</p>
        </a> </span></td>
    </tr>
  </tbody>
...
$(function() {
    ...
    var couLevelSkuChooseTriggered = function(id, url) {
        $("[data-cou-level-sku-choose-container='"+id+"']").load(
            url || 'index.php?app=store_promotion_cou&wwi=cou_level_sku&level='+id,
            function() {
