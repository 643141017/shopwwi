  ...
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlMall('store_goods_online', 'edit_save_goods');} else { echo urlMall('store_goods_add', 'save_goods');}?>">
    ...
    <div class="wwist-form-goods">
      ...
      <dl>
        ...
        <dd id="gcategory"> <?php echo $output['goods_class']['gc_tag_name'];?> <a class="ncbtn" href="<?php if ($output['edit_goods_sign']) { echo urlMall('store_goods_online', 'edit_class', array('commonid' => $output['goods']['goods_commonid'], 'ref_url' => getReferer())); } else { echo urlMall('store_goods_add', 'add_step_one'); }?>"><?php echo $lang['nc_edit'];?></a>
      ...
      <dl>
        ...
        <dd>
          <div class="wwist-goods-default-pic">
            <div class="goodspic-uplaod">
              ...
              <div class="handle">
                ...
                <a class="ncbtn mt5" nctype="show_image" href="<?php echo urlMall('store_album', 'pic_list', array('item'=>'goods'));?>"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_goods_demo" class="ncbtn mt5" style="display: none;"><i class="icon-tyq-arrow-up"></i>关闭相册</a></div>
            </div>
          </div>
          <div id="demo"></div>
        </dd>
      ...
      <dl style="overflow: visible;">
        ...
        <dd>
          <div class="wwist-brand-select">
            ...
            <div class="wwist-brand-select-container">
              ...
              <div class="tc"><a href="javascript:void(0);" class="ncbtn-mini" onclick="$(this).parents('.wwist-brand-select-container:first').hide();">关闭品牌列表</a></div>
            </div>
          ...
          <div class="tabs">
            ...
            <div id="panel-1" class="ui-tabs-panel">
              ...
              <div class="hr8">
                ...
                <a class="ncbtn mt5" nctype="show_desc" href="index.php?app=store_album&wwi=pic_list&item=des"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a> <a href="javascript:void(0);" nctype="del_desc" class="ncbtn mt5" style="display: none;"><i class=" icon-tyq-arrow-up"></i>关闭相册</a> </div>
              <p id="des_demo"></p>
            </div>
            <div id="panel-2" class="ui-tabs-panel ui-tabs-hide">
              <div class="wwist-mobile-editor">
                <div class="pannel">
              ...
              <div class="wwist-mobile-edit-area" nctype="mobile_editor_area">
                <div nctype="mea_img" class="wwist-mea-img" style="display: none;"></div>
                <div class="wwist-mea-text" nctype="mea_txt" style="display: none;">
      ...
      <dl class="special-01">
        ...
        <dd>
          ...
          <?php }?>
          <ul class="wwist-form-radio-list">
            <li>
