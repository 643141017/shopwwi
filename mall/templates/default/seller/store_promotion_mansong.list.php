...
<form method="get">
  <table class="search-form">
    ...
    <input type="hidden" name="wwi" value="mansong_list" />
    <tr>
      <td>&nbsp;</td>
...
<table class="wwist-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="index.php?app=store_promotion_mansong&wwi=mansong_detail&mansong_id=<?php echo $val['mansong_id'];?>" class="btn-bluejeans"><i class="icon-th-list"></i>
