...
<div class="wwist-oredr-show">
  <div class="wwist-order-info">
    <div class="wwist-order-details">
    ...
    <div class="wwist-order-condition">
      <dl>
    ...
    <div class="wwist-order-condition">
      ...
      <ul>
        ...
        <li>2. 可以在<a href="index.php?app=store_evaluate&wwi=list" class="ncbtn-mini">评价管理</a>查看详细内容。</li>
      </ul>
    </div>
    <?php } else { ?>
    <div class="wwist-order-condition">
  ...
  <div id="order-step" class="wwist-order-step">
  ...
  <div class="wwist-order-contnet">
    <table class="wwist-default-table order">
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td class="tl"><dl class="goods-name">
              ...
              <dd>
                ...
                退款单号：<a target="_blank" href="index.php?app=store_refund&wwi=view&refund_id=<?php echo $output['refund_all']['refund_id'];?>"><?php echo $output['refund_all']['refund_sn'];?></a>
                <?php }else if($goods['extend_refund']['refund_type'] == 1) {?>
                退款单号：<a target="_blank" href="index.php?app=store_refund&wwi=view&refund_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a></dd>
              <?php }else if($goods['extend_refund']['refund_type'] == 2) {?>
              退货单号：<a target="_blank" href="index.php?app=store_return&wwi=view&return_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a>
              </dd>
              <?php } ?>
            </dl></td>
        ...
        <tr class="bd-line">
          <td>&nbsp;</td>
          <td colspan="6" class="tl"><div class="wwist-goods-gift">赠品：
              <ul>
...
$(function(){
    $('#show_shipping').on('hover',function(){
    	...
    	$.getJSON('index.php?app=seller_center&wwi=get_express&e_code=<?php echo $output['order_info']['express_info']['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
    		if(data){
    			data = var_send+data;
