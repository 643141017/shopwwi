...
<ul class="add-goods-step">
  ...
  <li class="<?php $output['step']=="4" ? print "current" : print "";?>"><i class="icon icon-camera-retro "></i>
    <h6>STIP.2</h6>
    <h2>上传图片</h2></li>
      <li class="<?php $output['step']=="5" ? print "current" : print "";?>"><i class="icon icon-ok-tyq "></i>
    <h6>STIP.3</h6>
    <h2>完成导入</h2></li>
</ul>
<!--S 分类选择区域-->
...
<form method="post" action="index.php?app=taobao_import&wwi=index" enctype="multipart/form-data" id="goods_form">
  <div class="wwist-form-goods"  <?php if($output['step'] != '1'){?> style="display:none"<?php }?>>
    <dl>
    ...
    <dl>
      ...
      <dd><span class="new_add"><a href="javascript:void(0)" id="add_sgcategory" class="wwist-btn"><?php echo $lang['store_goods_index_new_class'];?></a> </span>
...
function getClassSpec($this) {
    ...
    $.getJSON('index.php?app=store_spec&wwi=ajax_class&id=' + id + '&deep=' + deep, function(data){
