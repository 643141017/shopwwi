...
<div class="wwist-form-default">
  <form method="post" action="index.php?app=store_setting&wwi=store_mobile" enctype="multipart/form-data" id="my_store_form">
    ...
    <?php } ?>
    <ul class="wwist-store-slider sortable">
...
for ($k = 1; $k <= $output['max_mb_sliders']; $k++) { $v = $mbSliders[$k]; ?>
      <li>
        ...
        <div class="wwist-upload-btn"> <a href="javascript:;"> <span>
...
$(function() {
    ...
    $('input.input-file').change(function() {
        ...
        $.ajaxFileUpload({
            url: 'index.php?app=store_setting&wwi=store_mb_sliders',
            secureuri: false,
            fileElementId: id,
            dataType: 'json',
            data: {id: id},
    ...
    $("a[data-slider-drop]").click(function() {
        ...
        $.getJSON('index.php?app=store_setting&wwi=store_mb_sliders_drop', {id: id}, function(d) {
            if (!d.success) {
                alert(d.error);
                return;
            }
