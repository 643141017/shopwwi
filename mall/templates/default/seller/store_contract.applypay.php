...
<form id="pay_form" method="post" enctype="multipart/form-data" action="index.php?app=store_contract&wwi=applypay">
	<input type="hidden" id="app" name="app" value="store_contract"/>
	<input type="hidden" id="wwi" name="wwi" value="applypay"/>
	...
	<dl>
		...
		<dd>
			<div class="wwist-upload-thumb voucher-pic">
				<p>
	...
	<dl>
		...
		<dd>
			<div id="costimg_preview" class="wwist-upload-thumb voucher-pic">
