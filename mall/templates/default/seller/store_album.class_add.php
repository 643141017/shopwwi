...
<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" action="index.php?app=store_album&wwi=album_add_save">
    ...
    $('#category_form').validate({
        ...
        rules : {
        	name : {
                ...
                maxlength	: 20,
                remote   : {
                    url :'index.php?app=store_album&wwi=ajax_check_class_name&column=ok',
                    type:'get',
                    data:{
                        ac_name : function(){
                            return $('#name').val();
