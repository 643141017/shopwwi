  ...
  <div class="wwist-order-contnet">
    <table class="wwist-default-table order">
      ...
      <tfoot>
        ...
        <tr>
          <th colspan="20"><dl class="wwist-store-sales">
              <?php if(!empty($output['order_info']['voucher_code'])){ ?>
