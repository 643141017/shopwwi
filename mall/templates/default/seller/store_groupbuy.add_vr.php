...
<div class="wwist-form-default">
  <form id="add_form" action="index.php?app=store_groupbuy&wwi=groupbuy_save&vr=1" method="post" enctype="multipart/form-data">
    <dl>
...
<?php } ?>
    ...
    <dl>
      ...
      <dd>
      <div class="wwist-upload-thumb groupbuy-pic">
    ...
    <dl>
      ...
      <dd>
      <div class="wwist-upload-thumb groupbuy-commend-pic">
          <p><i class="icon-picture"></i>
          <img nctype="img_groupbuy_image" style="display:none;" src=""/></p>
      </div>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hr8"><a class="des_demo ncbtn" href="index.php?app=store_album&wwi=pic_list&item=groupbuy"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a></p>
...
$("select[name=class]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?app=store_groupbuy&wwi=ajax_vr_class&class_id='+class_id,
...
$("select[name=city]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?app=store_groupbuy&wwi=ajax_vr_area&area_id='+area_id,
        success:function(json){
            var html = '<option value="">'+'请选择...'+'</option>';
