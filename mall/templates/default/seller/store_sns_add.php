...
<div class="wwist-form-default" nctype="normal" style=" display: none;">
  <form method="post" action="index.php?app=store_sns&wwi=store_sns_save" id="normal_form">
    <input type="hidden" name="type" value="2" />
    <dl>
      <dt><?php echo $lang['store_sns_image'].$lang['nc_colon'];?></dt>
      <dd>
        <div class="wwist-upload-thumb store-sns-pic">
        ...
        <div class="handle">
          <div class="wwist-upload-btn"> <a href="javascript:void(0);"><span>
            ...
            <a class="ncbtn mt5" nctype="get_img" href="index.php?app=store_album&wwi=pic_list&item=store_sns_normal"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_img" class="ncbtn ml5 mt5" style="display: none;"><i class="icon-tyq-arrow-up"></i>关闭相册</a></div>
...
<div class="wwist-form-default" nctype="recommend" style="display: none;">
  <div class="alert">
  ...
  <form method="post" action="index.php?app=store_sns&wwi=store_sns_save" id="recommend_form">
...
<div class="wwist-form-default" nctype="hotsell" style="display: none;" >
  <form method="post" action="index.php?app=store_sns&wwi=store_sns_save" id="hotsell_form">
...
<div class="wwist-form-default" nctype="new" style="display: none;" >
  <form method="post" action="index.php?app=store_sns&wwi=store_sns_save" id="new_form">
...
$(function(){
	...
	$('input[name="sns_type"]').each(function(){
		if($(this).attr('checked')){
			$('.wwist-form-default').hide();
			$('.wwist-form-default[nctype="'+$(this).val()+'"]').show();
		}
	});
	...
	$('#normal_file').unbind().live('change', function(){
		...
		(
			{
				url:'index.php?app=store_sns&wwi=image_upload',
				secureuri:false,
