  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="index.php?app=store_promotion_cou&wwi=cou_level_sku&level=<?php echo $output['level']; ?>" nctype="search_a" class="wwi-ss-btn"><i class="icon-search"></i><?php echo $lang['nc_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
