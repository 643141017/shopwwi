...
<form method="GET">
  ...
  <input type="hidden" name="wwi" value="activity_apply"/>
  ...
  <div class="div-goods-select">
    ...
    <form method="POST" id="apply_form" onsubmit="ajaxpost('apply_form','','','onerror');" action="index.php?app=store_activity&wwi=activity_apply_save">
      <input type="hidden" name="activity_id" value="<?php echo $_GET['activity_id'];?>"/>
