...
<div class="wrap">
  ...
  <div class="wwist-form-default"> 
    ...
    <form id="add_form" method="post" action="index.php?app=store_promotion_bundling&wwi=bundling_add">
      ...
      <dl>
        ...
        <dd>
          ...
          <table class="wwist-default-table mb15">
            ...
            <tbody nctype="bundling_data"  class="bd-line tip" title="<?php echo $lang['bundling_add_goods_explain'];?>">
              ...
              <tr id="bundling_tr_<?php echo $val['goods_id']?>" class="off-shelf">
                ...
                <td class="nscs-table-handle w90"><span><a onclick="bundling_operate_delete($('#bundling_tr_<?php echo $val['goods_id']?>'), <?php echo $val['goods_id']?>)" href="JavaScript:void(0);" class="btn-bittersweet"><i class="icon-ban-tyq"></i>
          ...
          <a id="bundling_add_goods" href="index.php?app=store_promotion_bundling&wwi=bundling_add_goods" class="ncbtn ncbtn-aqua"><?php echo $lang['bundling_goods_add'];?></a>
