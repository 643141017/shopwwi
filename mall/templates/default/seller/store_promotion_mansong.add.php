...
<div class="wwist-form-default">
  ...
  <form id="add_form" action="index.php?app=store_promotion_mansong&wwi=mansong_save" method="post">
...
<?php } ?>
    ...
    <dl>
      ...
      <dd>
        ...
        <ul id="mansong_rule_list" class="wwist-mansong-rule-list">
        </ul>
        ...
        <div class="wwist-mansong-error"><span id="mansong_price_error" style="display:none;"><i class="icon-exclamation-sign"></i>规则金额不能为空且必须为数字</span><span id="mansong_discount_error" style="display:none;"><i class="icon-exclamation-sign"></i>满减金额必须小于规则金额</span></div>
        <div class="wwist-mansong-rule">
        ...
        <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
            ...
            <div class="mt10">
            <a href="javascript:void(0);" id="btn_save_rule" class="ncbtn ncbtn-aqua"><i class="icon-ok-tyq"></i>确定规则设置</a>
            <a href="javascript:void(0);" id="btn_cancel_add_rule" class="ncbtn ncbtn-bittersweet"><i class="icon-ban-tyq"></i>取消</a></div>
        </div>
        <span class="error-message"></span>
