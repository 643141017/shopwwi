<?php defined('ByShopWWI') or exit('Access Invalid!');?>
  ...
  <div class="wwist-form-default">
    <form method="post" action="index.php?app=store_deliver_set&wwi=print_set" enctype="multipart/form-data" id="my_store_form">
      ...
      <dl class="setup">
        ...
        <dd>
          ...
          <div class="wwist-upload-thumb watermark-pic">
          	<p>
