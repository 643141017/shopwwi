...
<table class="wwist-default-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="nscs-table-handle"><span><a id="a_<?php echo $v['activity_id'];?>" href="index.php?app=store_activity&wwi=activity_apply&activity_id=<?php echo $v['activity_id'];?>"  class="btn-mint"><i class="icon-edit"></i>
