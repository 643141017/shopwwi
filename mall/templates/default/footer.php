  ...
  <div class="wrap"> 
  	...
  	<?php if(!empty($output['nav_list']) && is_array($output['nav_list'])){?><?php foreach($output['nav_list'] as $nav){?>
		...
		<a  <?php if($nav['nav_new_open']){?>target="_blank" <?php }?>href="<?php switch($nav['nav_type']){
			...
			<a href="<?php echo urlmall('link');?>">友情链接</a>|<a href="http://www.shopwwi.com">网店运维出品S5完美版</a></p>

   <div class="copy_right">
     ©2016 shopwwi.com 
    <a href="http://www.shopwwi.com/" style="color:#0fcfe1;">网店运维S5标准版</a> <?php echo $output['setting_config']['icp_number']; ?>  客户服务中心(7×24):QQ8988354 Q群：111731672
   </div> 
  </div> 
 </div> 
</div>
...
<?php if (C('debug') == 1){?>
	<div id="think_page_trace" class="trace">
		<fieldset id="querybox"><legend><?php echo $lang['nc_debug_trace_title'];?></legend><div> 
