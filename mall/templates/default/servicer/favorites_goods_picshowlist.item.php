  ...
  <div class="favorite-goods-list">
    <ul>
      ...
      <li class="favorite-pic-list<?php if (!isset($favorites['goods']) || !$favorites['goods']['state']) {?> disable<?php }?>" >
        ...
        <div class="handle"> <a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', 'index.php?app=member_favorite_goods&wwi=delfavorites&type=goods&fav_id=<?php echo $favorites['fav_id'];?>');" class="fr ml5" title="<?php echo $lang['nc_del'];?>"><i class="icon-trash"></i></a>
