...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <li nc_type="tracerow_<?php echo $v['trace_id']; ?>">
      ...
      <dl class="fd-wrap">
        <dt>
          <h3><a href="index.php?app=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank" data-param="{'id':<?php echo $v['trace_memberid'];?>}" nctype="mcard"><?php echo $v['trace_membername'];?></a><?php echo $lang['nc_colon'];?></h3>
  ...
  <div class="sns-norecord"><?php echo $lang['sns_trace_nohave_1'];?><br>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_snsfriend&wwi=follow"><?php echo $lang['sns_trace_nohave_2'];?></a></div>
  <?php }?>
  <?php }?>
</div>