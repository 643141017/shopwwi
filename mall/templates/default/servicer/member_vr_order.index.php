    ...
    <tbody>
      ...
      <tr>
        ...
        <td> <?php if($order_info['if_refund']){ ?>
          <a href="index.php?app=member_vr_refund&wwi=add_refund&order_id=<?php echo $order_info['order_id']; ?>">退款</a>
          <?php } ?></td>
        ...
        <td class="bdl"><p><?php echo $order_info['state_desc'];?></p>
          <p><a href="index.php?app=member_vr_order&wwi=show_order&order_id=<?php echo $order_info['order_id'];?>">订单详情</a></p></td>
        <td class="bdl bdr">

		  <?php if($order_info['if_pay']){ ?>
          <p><a class="ncbtn ncbtn-bittersweet" href="index.php?app=buy_virtual&wwi=pay&order_id=<?php echo $order_info['order_id']; ?>"><i class="icon-shield"></i>订单支付</a></p>
          <?php } ?>
          ...
          <p><a class="ncbtn ncbtn-aqua" href="index.php?app=member_evaluate&wwi=add_vr&order_id=<?php echo $order_info['order_id']; ?>"><i class="icon-thumbs-up-alt"></i><?php echo $lang['member_order_want_evaluate'];?></a></p>
          <?php } ?>
