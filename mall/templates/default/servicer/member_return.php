    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $lang['refund_order_ordersn'].$lang['nc_colon'];?><a href="index.php?app=member_order&wwi=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
          </dl></td>
        ...
        <td class="bdr"><?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 1) { ?>
          <p><a href="index.php?app=member_return&wwi=ship&return_id=<?php echo $val['refund_id']; ?>" class="ncbtn">退货</a></p>
          <?php } else { ?>
          <a href="index.php?app=member_return&wwi=view&return_id=<?php echo $val['refund_id']; ?>" class="ncbtn">查看</a>
          <?php } ?>
          ...
          <p><a href="javascript:void(0)" class="ncbtn ncbtn-bittersweet" nc_type="dialog" dialog_title="延迟时间" dialog_id="return_delay" dialog_width="480"
        	    uri="index.php?app=member_return&wwi=delay&return_id=<?php echo $val['refund_id']; ?>"> 延时 </a></p>
          <?php } ?></td>
      </tr>
      <?php } ?>
      <?php } else { ?>
