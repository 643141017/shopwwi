...
<div class="ncm-oredr-show">
  <div class="ncm-order-info">
    ...
    <div class="ncm-order-condition">
      <dl>
        <dt><i class="icon-ok-tyq green"></i>订单状态：</dt>
      ...
      <ul>
        ...
        <li>1. 您尚未对该订单进行支付，请<a href="index.php?app=buy&wwi=pay&pay_sn=<?php echo $output['order_info']['pay_sn'];?>" class="ncbtn-mini ncbtn-bittersweet"><i></i>支付订单</a>以确保商家及时发货。</li>
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        ...
        <li>2. 将感兴趣的<a href="index.php?app=member_favorite_goods&wwi=fglist" class="ncbtn-mini">收藏商品</a>加入购物车进行购买。</li>
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td class="tl"><dl class="goods-name">
              ...
              <dd>退款单号：<a target="_blank" href="index.php?app=member_refund&wwi=view&refund_id=<?php echo $output['refund_all']['refund_id'];?>"><?php echo $output['refund_all']['refund_sn'];?></a></dd>
              <?php }else if($goods['extend_refund']['refund_type'] == 1) {?>
              <dd>退款单号：<a target="_blank" href="index.php?app=member_refund&wwi=view&refund_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a></dd>
              <?php }else if($goods['extend_refund']['refund_type'] == 2) {?>
              <dd>退货单号：<a target="_blank" href="index.php?app=member_return&wwi=view&return_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a></dd>
              <?php } ?>
            </dl></td>
          <td></td>
          ...
          <td><!-- 退款 -->
            ...
            <p><a href="index.php?app=member_refund&wwi=add_refund&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">退款/退货</a></p>
            <?php }?>
            
            <!-- 投诉 -->
            
            <?php if ($output['order_info']['if_complain']){ ?>
            <p><a href="index.php?app=member_complain&wwi=complain_new&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">交易投诉</a></p>
            <?php } ?></td>
          ...
          <td rowspan="<?php echo $output['order_info']['goods_count'];?>"><?php if ($output['order_info']['if_lock']) { ?>
            ...
            <p><a href="index.php?app=member_refund&wwi=add_refund_all&order_id=<?php echo $output['order_info']['order_id']; ?>" class="ncbtn">订单退款</a></p>
            <?php } ?>
            ...
            <?php if ($output['order_info']['if_evaluation']) { ?>
            <p><a class="ncbtn ncbtn-aqua" href="index.php?app=member_evaluate&wwi=add&order_id=<?php echo $output['order_info']['order_id']; ?>"><?php echo $lang['member_order_want_evaluate'];?></a></p>
            <?php } ?>
...
$(function(){
    $('#show_shipping').on('hover',function(){
    	...
    	$.getJSON('index.php?app=member_order&wwi=get_express&e_code=<?php echo $output['order_info']['express_info']['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
    		if(data){
