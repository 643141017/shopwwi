...
<h3><?php echo $lang['talk_detail'];?></h3>
  ...
  <form action="index.php?app=member_complain&wwi=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?app=member_complain&wwi=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?app=member_complain&wwi=publish_complain_talk',
                cache:false,
