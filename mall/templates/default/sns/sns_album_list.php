...
$(function(){
    ...
    $('#fileupload').fileupload({
        dataType: 'json',
        url: '<?php echo MALL_SITE_URL;?>/index.php?app=sns_album&wwi=swfupload',
        add: function (e,data) {
  ...
  <div id="pictureIndex" class="picture-index">
    ...
    <div class="album-info">
      <div class="build-album">
        <div class="button"><a uri="index.php?app=sns_album&wwi=album_add" nc_type="dialog" dialog_title="<?php echo $lang['album_new_class_add'];?>" class="btn" ><i></i><?php echo $lang['album_new_class_add'];?></a></div>
      </div>
      <div class="upload-photo">
          <div class="button"><a id="open_uploader" href="JavaScript:void(0);" class="wwist-btn wwist-btn-acidblue"><i class="icon-cloud-upload"></i><?php echo $lang['sns_upload_more_pic'];?></a></div>
          <div class="upload-con" id="uploader" style="display: none;">
            <form method="post" action="" id="fileupload" enctype="multipart/form-data">
              ...
              <div class="upload-con-div mt10">
                <div class="wwist-upload-btn"><span>
    ...
    <div class="album-cover">
      <div class="cover"> <span class="thumb size190"><i></i><a href="index.php?app=sns_album&wwi=album_pic_list&id=<?php echo $v['ac_id']?>&mid=<?php echo $output['master_id'];?>">
        <?php if($v['ac_cover'] != ''){ ?>
      ...
      <?php if($output['relation'] == '3'){?>
      <div class="handle"><a href="JavaScript:void(0);" class="edit" nc_type="dialog" dialog_title="<?php echo $lang['album_class_deit'];?>" dialog_id='album_<?php echo $v['ac_id'];?>' dialog_width="480" uri="index.php?app=sns_album&wwi=album_edit&id=<?php echo $v['ac_id'];?>"><i></i><?php echo $lang['album_class_edit'];?></a>
        <?php if($v['is_default'] != '1'){?>
        <a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['album_class_delete_confirm_message'];?>', 'index.php?app=sns_album&wwi=album_del&id=<?php echo $v['ac_id'];?>');" class="del"><i></i><?php echo $lang['album_class_delete'];?></a>
        <?php }?>
      </div>
      <?php }?>
    </div>
