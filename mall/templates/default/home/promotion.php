<?php defined('ByShopWWI') or exit('Access Invalid!');?><link href="<?php echo MALL_TEMPLATES_URL;?>/css/layout.css" rel="stylesheet" type="text/css"><link href="<?php echo MALL_TEMPLATES_URL;?>/css/wwi-main.css" rel="stylesheet" type="text/css"><script type="text/javascript" src="<?php echo MALL_RESOURCE_SITE_URL;?>/js/home_index.js" charset="utf-8"></script>
	<style>
