...
<div class="wwi-s-bdc-layout" style="display: block;">
  <div class="wwi-s-bdc wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo urlMall(); ?>">首页</a> </span> <span class="arrow">></span>
...
$(function(){
    ...
    <?php if ($output['groupbuy_info']['is_vr']) { ?>
    $("#nc-store-map").load('index.php?app=show_map&wwi=index&w=420&h=400&store_id=<?php echo $output['groupbuy_info']['store_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
