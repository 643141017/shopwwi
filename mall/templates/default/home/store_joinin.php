      ...
      <form id="login_form" action="<?php echo urlLogin('login')?>" method="post">
        ...
        <dl>
          ...
          <dd>
            ...
            <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?app=seccode&wwi=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['login_index_change_checkcode'];?>">
            <img src="index.php?app=seccode&wwi=makecode&nchash=<?php echo getNchash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
