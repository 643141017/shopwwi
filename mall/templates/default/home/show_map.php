...
<div class="wwi-ss-store-map-content">
  <div class="wwi-ss-store-map-baidu" id="baidu_map" style="width:<?php echo $_GET['w']; ?>px;height:<?php echo $_GET['h']; ?>px;"></div>
  <div class="wwi-ss-store-map-info">
