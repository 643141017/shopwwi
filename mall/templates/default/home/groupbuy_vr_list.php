...
<li><div class="commodity-intro">    <a target="_blank" href="<?php echo $groupbuys['goods_url'];?>" title="<?php echo $groupbuys['groupbuy_name'];?>" class="commodity-link"><img shopwwi-url="<?php echo gthumb($groupbuys['groupbuy_image'],'mid');?>" rel='lazy' src="<?php echo MALL_SITE_URL;?>/img/loading.gif" alt="" width="160" height="160" class="transform"><span class="readyStart"></span></a>    <p class="commodity-name">        <span class="country-logo-small -small"></span>        <a target="_blank" href="<?php echo $groupbuys['goods_url'];?>" title="<?php echo $groupbuys['groupbuy_name'];?>"><?php echo $groupbuys['groupbuy_name'];?></a>    </p>    <div class="discount">        <i class="front">5</i><i class="behind">.1</i><i class="text">折</i>    </div></div><div class="commodity-detail">    <p class="time-left j-time"> <span><i class="icon-time"></i><b>距抢购开始：</b><span class="time-remain" count_down="<?php echo $groupbuys['start_time']-TIMESTAMP; ?>"> <em time_id="d">0</em><i><?php echo $lang['text_tian'];?></i><em time_id="h">0</em><i>:</i><em time_id="m">0</em><i>:</i><em time_id="s">0</em> </span>    </p><?php list($integer_part, $decimal_part) = explode('.', ncPriceFormat($groupbuys['groupbuy_price']));?><span class="price"><i class="price-logo">¥</i><em><?php echo $integer_part;?></em><i class="price-last">.<?php echo $decimal_part;?></i></span>    <p class="consult-price">市场参考价：<span><i class="price-logo">¥</i><em><?php echo ncPriceFormat($groupbuys['goods_price']);?></em></span></p>    <a name="hwg_sg427_bktj_jrgwcan01" href="#" class="join-cart" partnumber="129823137" vendor="0070088130" grppurid="814024">即将开始</a></div></li><?php } ?>
...
<div class="theNewitem item-hover">      <div class="commodity-introduce">          <span class="country-logo-big USA-big"></span></div>      <img class="commodity-img" shopwwi-url="<?php echo gthumb($groupbuy['groupbuy_image'],'mid');?>" rel='lazy' src="<?php echo MALL_SITE_URL;?>/img/loading.gif" alt="<?php echo $groupbuy['groupbuy_name'];?>" width="260" height="260" style="opacity: 1;">      <div class="commodity-detail">          <p class="commodity-name"><?php echo $groupbuy['groupbuy_name'];?></p>          <p class="commodity-text"><?php echo $groupbuy['remark'];?></p>          <p class="time-left j-time">              <span class="logo"></span>              <span class="text"><!-- 倒计时 距离本期结束 --><i class="icon-time"></i><b>距抢购结束：</b><span class="time-remain" count_down="<?php echo $groupbuy['end_time']-TIMESTAMP; ?>"> <em time_id="d">0</em><i><?php echo $lang['text_tian'];?></i><em time_id="h">0</em><i>:</i><em time_id="m">0</em><i>:</i><em time_id="s">0</em></span></p>          <div class="price-wrapper">              <span class="discount"><?php list($integers_part, $decimals_part) = explode('.', ncPriceFormat($groupbuy['groupbuy_rebate']));?> <i class="front"><?php echo $integers_part;?></i><i class="behind">.<?php echo $decimals_part;?></i><i class="text">折</i>              </span><?php list($integer_part, $decimal_part) = explode('.', ncPriceFormat($groupbuy['groupbuy_price']));?><span class="price"><i class="price-logo">¥</i><em><?php echo $integer_part;?></em><i class="price-last">.<?php echo $decimal_part;?></i></span>               <p class="consult-price">市场参考价：<span><i class="price-logo">¥</i><em><?php echo ncPriceFormat($groupbuy['goods_price']);?></em></span></p>          </div>          <p class="buy-number"><i><?php echo $groupbuy['buy_quantity']+$groupbuy['virtual_quantity'];?></i>人已抢购！</p>      </div><div></div>      <a target="_blank" href="<?php echo $groupbuy['goods_url'];?>" class="overseas-itemlink"></a>      <a href="<?php echo $groupbuy['goods_url'];?>" class="join-cart" >立即抢购</a>  </div><?php } ?>
...
<div class="item"><div class="scope">
    <dl class="goods"><dt class="goods-thumb"> <a title="<?php echo $groupbuy['groupbuy_name'];?>" target="_blank" href="<?php echo $groupbuy['groupbuy_url'];?>"><img shopwwi-url="<?php echo gthumb($groupbuy['groupbuy_image'],'mid');?>" rel='lazy' src="<?php echo MALL_SITE_URL;?>/img/loading.gif" /></a> </dt>
