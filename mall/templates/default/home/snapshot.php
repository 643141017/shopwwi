...
<div class="wrapper">
  ...
  <div class="wwi-s-main<?php if ($output['store_info']['is_own_mall']) echo ' ownmall'; ?>">
    ...
    <div class="wwi-ss-info">
      <div class="title">
        <h4><?php echo $output['store_info']['store_name']; ?></h4>
      </div>
      <div class="content">
        <div class="wwi-s-main-rate">
          <ul>
  ...
  <div id="content" class="wwi-ss-goods-layout" >
    <div class="title"><span>订单详情</span></div>
    <div class="wwi-ss-intro" id="ncGoodsIntro">
