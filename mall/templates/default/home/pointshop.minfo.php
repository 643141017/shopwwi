...
<div class="ncp-member-point">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_voucher&wwi=index" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_pointorder&wwi=orderlist" target="_blank">
