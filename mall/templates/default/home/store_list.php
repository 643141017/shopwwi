...
//]]>
	    ...
	    <div class="wwi-module wwi-new-list zoom">
    	<div class="pageTab">
   ...
   <div class="filter-item area">
            <div class="item-cont">
                <span class="item-tit wwi-left">分类</span>
                <dl class="wwi-left item-links">
                    <dt class="wwi-left all"><a href="<?php echo urlMall('store_list','index');?>" class="now">不限</a></dt>
                    <dd class="wwi-left eachLink leftA">
                        <div class="clearfix">
    ...
    <div class="filter-item moreItem">
        ...
        <input type="hidden" name="cate_id" value="<?php echo $_GET['cate_id'];?>"/>
                <?php if (!C('fullindexer.open')){?> <div class="wwi-left pos-re wwi-m">
                <input id="area_info" name="area_info" type="hidden" value=""/>
<div class="wwi-newinput">
                       <input class="text" type="text" name="keyword" value="<?php echo $_GET['keyword'];?>" placeholder="请输入店铺名称"/>
                    </div>
                </div>
                 <input class="btn" type="submit" value="<?php echo $lang['nc_search'];?>" /><?php }?>
                <div class="clear"></div>
            </div>
        </div>
        </form>
...
<div class="wrapper  wwi-new-st">
        <div class="wwi-left w965">
            <!--排序-->
                    ...
                    <dt class="storesinfo clearfix">
                        ...
                        <div class="storesrelated">
                            ...
                            <a target="_blank" href="<?php echo urlMall('show_store','index', array('store_id'=>$store['store_id']),$store['store_domain']);?>" class="item3">查看店铺</a>
                                                ...
                                                <div class="storescase wwi-right">
                            <div class="wwi-left">
...
<div class="checkMore"><a target="_blank" href="<?php echo urlMall('show_store','index', array('store_id'=>$store['store_id']),$store['store_domain']);?>">更多<?php echo ($tmp = $store['goods_count']) ? $tmp  : $lang['nc_common_goods_null'];?>款商品，买吗&gt;&gt;</a></div>
                                            </dd><?php }?>
                                    </dl><?php }?>
<?php }?>
...
<div class="pagination"> <?php echo $output['show_page'];?> </div>
        ...
        <div class="wwi-right w220">
            <div class="mb15">
                <a href="http://www.shopwwi.com" target="_blank"><img src="<?php echo MALL_SITE_URL;?>/img/whyYw.jpg" alt="为什么选择网店运维" class="mb15"></a>
            </div>
            <!--销量排行-->
            <?php if(!empty($output['goods_list']) && is_array($output['goods_list'])){$i=0?>
            <div class="w218 sales wwi-bs">
            ...
            <div class="for-fix">
                <div class="mb15">
                    <a href="http://s5.shopwwi.com" target="_blank"><img src="<?php echo MALL_SITE_URL;?>/img/taoListApp.jpg" alt="网店运维S5"></a>
                </div>
                <div class="mb15">
                    <a href="http://www.shopwwi.com" target="_blank"><img src="<?php echo MALL_SITE_URL;?>/img/pei.jpg" alt="网店运维代运营"></a>
                </div>
            </div>
        </div>
    </div>
