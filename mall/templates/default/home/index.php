...
<div class="wwi-new-tabcron wrapper">
...
<div class="boxItem4">
            ...
            <div class="inner wwi-new-slider">
            	<ul>
            		<li>    <div class="hotCont" style="display: block;">
        <a class="checkMore">换一换<i></i></a>
  <div class="wwi-tab-zt">
  	    	<?php if(!empty($output['special_list']) && is_array($output['special_list'])) {?>
    		<?php foreach($output['special_list'] as $value) {?>
  	<a href="<?php echo $value['special_link'];?>"><img  shopwwi-url="<?php echo getTZXSpecialImageUrl($value['special_image']);?>" rel='lazy' src="<?php echo MALL_SITE_URL;?>/img/loading.gif" alt="<?php echo $value['special_title'];?>"><div class="item-text" ><?php echo $value['special_title'];?></div></a><?php }} ?>
  </div>
        <div class="items docItem">
        	...
        	<?php foreach($output['brand_r'] as $key=>$brand_r){ if ($i == 4){ echo '</div><div class="showItem">'; $i = 1;} else{ echo ' '; $i++; }?>
        		 ...
        		 <a href="<?php echo urlMall('brand', 'list',array('brand'=>$brand_r['brand_id']));?>" target="_blank">
                    <p class="doc-img"><span><img shopwwi-url="<?php echo brandImage($brand_r['brand_pic']);?>"  rel='lazy' src="<?php echo MALL_SITE_URL;?>/img/loading.gif" alt="<?php echo $brand_r['brand_name'];?>"></span><i></i></p>
                    <p class="doc-name"><?php echo $brand_r['brand_name'];?></p>
               </a>
        			<?php }?></div> 
        		<?php } ?>
                    </div>
       <div class="wwi-tab-tg">
...
<?php foreach($output['group_list'] as $val) { ?>
       	<dl> <dt class="goods-name"><a target="_blank" href="<?php echo urlMall('show_groupbuy','groupbuy_detail',array('group_id'=> $val['groupbuy_id']));?>" title="<?php echo $val['groupbuy_name']; ?>">
                                          ...
                                          <dd class="goods-thumb">
                                          	...
                                          	<img alt="<?php echo $val['groupbuy_name']; ?>" shopwwi-url="<?php echo gthumb($val['groupbuy_image1'], 'small');?>" rel='lazy' src="<?php echo MALL_SITE_URL;?>/img/loading.gif"  style="display: block;">
                                          	</a></dd>
