...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <table class="ncc-table-style">
      ...
      <tfoot>
        <tr>
          <td colspan="20"><div class="ncc-all-account"><?php echo $lang['pointcart_cart_allpoints']; ?><em id="pcart_amount"><?php echo $output['pgoods_pointall']; ?></em><?php echo $lang['points_unit']; ?></div><a href="index.php?app=pointcart&wwi=step1" class="ncc-next-submit ok"><?php echo $lang['pointcart_cart_submit']; ?></a></td>
        </tr>
      </tfoot>
    </table>
  </div>
