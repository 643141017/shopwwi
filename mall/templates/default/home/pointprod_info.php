...
function add_to_cart()
{
	...
	if(checkresult == false){
		...
		$.getJSON('<?php echo MALL_SITE_URL; ?>/index.php?app=pointcart&wwi=add&pgid=<?php echo $output['prodinfo']['pgoods_id']; ?>&quantity='+quantity, function(result){
	        if(result.done){
