...
$(function(){
    $('#region').nc_region({last_click:function (area_id){
        ...
        $('.wwi-ss-chain-no-date').remove();
        if (typeof(_chain_check) == 'undefined') {
            $('<div class="wwi-ss-chain-no-date">很抱歉，该区域暂无门店有货，正努力补货中•••</div>').insertAfter('ul[nctype="chain_see"]');
            return false;
        }
