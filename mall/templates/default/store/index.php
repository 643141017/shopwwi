...
<div class="content wwi-ss-goods-list wwi-new-cc">
...
<div class="wrapper mt10">
  <div class="wwi-ss-main">
    ...
    <div class="wwi-ss-main-container">
      <div class="title"> <span><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $_GET['store_id']));?>" class="more"><?php echo $lang['nc_more'];?></a></span>
        <h4><?php echo $lang['show_store_index_recommend'];?></h4>
      </div>
      <div class="content wwi-ss-goods-list">
        <?php if(!empty($output['recommended_goods_list']) && is_array($output['recommended_goods_list'])){?>
        <ul>
          <?php foreach($output['recommended_goods_list'] as $value){?>
          <li>
