...
<div class="wwi-ss-info">
	...
	<div class="ft12 c999 hosarea">
      ...
      <div class="joinins"><span><?php echo $output['store_info']['area_info'];?><?php echo $output['store_info']['store_address'];?><a href="javascript:void(0)">查看地图</a></span>
       <div class="map-box"><div class="wwi-info-map" id="map_container" style="width:208px;height:208px;"></div></div> 
       </div>
...
$(function(){
	...
	var op  = "<?php echo trim($_GET['wwi']) != ''?trim($_GET['wwi']):'index'; ?>";
	$.getJSON("index.php?app=show_store&wwi=ajax_flowstat_record",{store_id:store_id,goods_id:goods_id,app_param:app,op_param:op});
});
</script> 