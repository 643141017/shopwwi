...
<div class="wrapper pr">
  ...
  <div class="wwi-s-main<?php if ($output['store_info']['is_own_mall']) echo ' ownmall'; ?>"> 
  	<!-- 店铺信息 -->
  	
  	<!-- 店铺信息 -->
   <!-- 焦点图 -->
	    <div id="wwi-item-pics" class="wwi-item-pics">
      ...
      <?php if (isset($output['goods']['promotion_type']) || !empty($output['goods']['jjg_explain']) || !empty($output['mansong_info'])) {?>
        <dl>
          ...
          <dd class="promotion-info">
            ...
            <div class="wwi-ss-mansong"> <span class="sale-name">满即送</span> <span class="sale-rule">
            ...
            <div class="wwi-ss-jjg"> <span class="sale-name">加价购</span> <span class="sale-rule"><?php echo $output['goods']['jjg_explain']; ?></span> <span nctype="show-rule" class="sale-rule-more"><a href="javascript:void(0);">共<strong><?php echo count($output['goods']['jjg_info']['levels']);?></strong>项，展开查看<i></i></a></span>
              <div class="sale-rule-content" style="display: none;" nctype="rule-content">
...
$shownLevelSkus[$sku] = true; ?>
      ...
      <div class="wwi-ss-logistics"><!-- S 物流与运费新布局展示 ByShopWWI网店运维 -->
        <?php if($output['goods']['goods_state'] == 1 && $output['goods']['goods_verify'] == 1 && $output['goods']['is_virtual'] == 0){ ?>
        <dl id="wwi-ss-freight" class="wwi-ss-freight">
          <dt>配&nbsp;&nbsp;送&nbsp;&nbsp;至：</dt>
          <dd class="wwi-ss-freight_box">
            <div id="wwi-ss-freight-selector" class="wwi-ss-freight-select">
              <div class="text">
                ...
                <b>∨</b> </div>
              <div class="content">
                <div id="wwi-ss-stock" class="wwi-ss-stock" data-widget="tabs">
                  <div class="mt">
                    <ul class="tab">
              ...
              <a href="javascript:;" class="close" onclick="$('#wwi-ss-freight-selector').removeClass('hover')">关闭</a> </div>
            <div id="wwi-ss-freight-prompt"> <strong><?php echo $output['goods']['goods_storage'] > 0 ? '有货' : '无货'?></strong>
      ...
      <div class="wwi-ss-buy">
        ...
        <div class="wwi-ss-point" style="display: none;"><i></i> 
          <!-- S 库存 --> 
        ...
        <!-- S 提示已选规格及库存不足无法购买 -->
        <?php if ($output['goods']['goods_state'] == 0 || $output['goods']['goods_storage'] <= 0) {?>
        <div nctype="goods_prompt" class="wwi-ss-point"><i></i> <span>您选择的商品<strong>库存不足</strong>；请选择店内其它商品或申请<a href="javascript:void(0);" nctype="arrival_notice" class="arrival" title="到货通知">到货通知</a>提示。</span> </div>
        <?php }?>
        <!-- E 提示已选规格及库存不足无法购买 --> 
        <!-- S 购买按钮 -->
        <div class="wwi-ss-btn">
          ...
          <?php }?>
          <!-- S 加入购物车弹出提示框 -->
          <div class="wwi-ss-cart-popup">
            <dl>
              <dt><?php echo $lang['goods_index_cart_success'];?><a title="<?php echo $lang['goods_index_close'];?>" onClick="$('.wwi-ss-cart-popup').css({'display':'none'});">X</a></dt>
    ...
    <div class="wwi-ss-handle">
      ...
      <!-- S 对比 --> 
      <a href="javascript:void(0);" class="compare" nc_type="compare_<?php echo $output['goods']['goods_id'];?>" data-param='{"gid":"<?php echo $output['goods']['goods_id'];?>"}'><i></i>对比</a><!-- S 举报 -->
      <?php if($output['inform_switch']) { ?>
      <a href="<?php if ($_SESSION['is_login']) {?>index.php?app=member_inform&wwi=inform_submit&goods_id=<?php echo $output['goods']['goods_id'];?><?php } else {?>javascript:login_dialog();<?php }?>" title="<?php echo $lang['goods_index_goods_inform'];?>" class="inform"><i></i><?php echo $lang['goods_index_goods_inform'];?></a>
      <?php } ?>
      <!-- End --> </div>
...
<!-- S 优惠套装 -->
<div class="wwi-ss-promotion" id="nc-bundling" style="display:none;"></div>
<!-- E 优惠套装 -->
<div id="content" class="wwi-ss-goods-layout expanded" >
  <div class="wwi-ss-goods-main" id="main-nav-holder">
    <div class="tabbar pngFix" id="main-nav">
      <div class="wwi-ss-goods-title-nav">
        <ul id="categorymenu">
    ...
    <div class="wwi-ss-intro">
      <div class="content bd" id="ncGoodsIntro">
        ...
        <?php }?>
        <div class="wwi-ss-goods-info-content">
    ...
    <?php if ($output['goods']['is_virtual'] == 1) {?>
    <!-- S 店铺地址地图 -->
    <div class="wwi-ss-mall-map">
      <div class="wwi-ss-goods-title-bar hd">
    ...
    <!-- E 店铺地址地图 -->
    <?php }?>
    <div class="wwi-ss-comment">
      <div class="wwi-ss-goods-title-bar hd">
        <h4><a href="javascript:void(0);"><?php echo $lang['goods_index_evaluation'];?></a></h4>
      </div>
      <div class="wwi-ss-goods-info-content bd" id="ncGoodsRate">
        <div class="top">
          <div class="rate">
        ...
        <!-- 商品评价内容部分 -->
        <div id="goodseval" class="wwi-ss-commend-main"></div>
      </div>
    </div>
    <div class="ncg-salelog">
      ...
      <div class="wwi-ss-goods-info-content bd" id="ncGoodsTraded">
        <div class="top">
        ...
        <!-- 成交记录内容部分 -->
        <div id="salelog_demo" class="wwi-ss-loading"> </div>
      </div>
    </div>
    <div class="wwi-ss-consult">
      <div class="wwi-ss-goods-title-bar hd">
        <h4><a href="javascript:void(0);"><?php echo $lang['goods_index_goods_consult'];?></a></h4>
      </div>
      <div class="wwi-ss-goods-info-content bd" id="ncGuestbook"> 
        <!-- 咨询留言内容部分 -->
        <div id="consulting_demo" class="wwi-ss-loading"> </div>
      </div>
    </div>
<!-- shopwwi-->
<!--youce-->
  ...
  <div class="wwi-ss-sidebar">
    ...
    <!-- 最近浏览 -->
    <div class="wwi-ss-sidebar-container wwi-ss-top-bar">
      <div class="title">
        <h4>最近浏览</h4>
      </div>
      <div class="content">
        <div id="hot_sales_list" class="wwi-ss-top-panel">
          <ol>
        ...
        <p><a href="<?php echo MALL_SITE_URL;?>/index.php?app=member_goodsbrowse&wwi=list" class="nch-sidebar-all-viewed">全部浏览历史</a></p> </div>
    </div>
    <?php } ?>
  </div>
</div>
...
<form id="buynow_form" method="post" action="<?php echo MALL_SITE_URL;?>/index.php">
  ...
  <input id="wwi" name="wwi" type="hidden" value="buy_step1" />
...
$(function(){
    ...
    $(".wwi-look-slider .picScroll-top").slide({
	   titCell:".hd ul",
	   mainCell:".bd ul",
	   autoPage:true,
	   effect:"top",
...
$(function(){
    ...
    $('#transport_pannel>a').click(function(){
	    ...
	    var url = 'index.php?app=goods&wwi=calc&rand='+Math.random();
    ...
    $("#nc-bundling").load('index.php?app=goods&wwi=get_bundling&goods_id=<?php echo $output['goods']['goods_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
    <?php if ($output['goods']['is_virtual'] == 1) {?>
    $("#ncStoreMap").load('index.php?app=show_map&wwi=index&w=420&h=400&store_id=<?php echo $output['goods']['store_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
    <?php } ?>
    $("#salelog_demo").load('index.php?app=goods&wwi=salelog&goods_id=<?php echo $output['goods']['goods_id'];?>&store_id=<?php echo $output['goods']['store_id'];?>&vr=<?php echo $output['goods']['is_virtual'];?>', function(){
        // Membership card
        $(this).find('[nctype="mcard"]').membershipCard({type:'mall'});
    });
	$("#consulting_demo").load('index.php?app=goods&wwi=consulting&goods_id=<?php echo $output['goods']['goods_id'];?>&store_id=<?php echo $output['goods']['store_id'];?>', function(){
		// Membership card
		$(this).find('[nctype="mcard"]').membershipCard({type:'mall'});
	});
...
/** goods.php **/
	// 商品内容部分折叠收起侧边栏控制
	$('#fold').click(function(){
  		$('.wwi-ss-goods-layout').toggleClass('expanded');
	});
	// 商品内容介绍Tab样式切换控制
	...
	//商品排行Tab切换
	$(".wwi-ss-top-tab > li > a").mouseover(function(e) {
		if (e.target == this) {
			var tabs = $(this).parent().parent().children("li");
			var panels = $(this).parent().parent().parent().children(".wwi-ss-top-panel");
	...
	//信用评价动态评分打分人次Tab切换
	$(".wwi-ss-rate-tab > li > a").mouseover(function(e) {
		if (e.target == this) {
			var tabs = $(this).parent().parent().children("li");
			var panels = $(this).parent().parent().parent().children(".wwi-ss-rate-panel");
			var index = $.inArray(this, $(this).parent().parent().find("a"));
			if (panels.eq(index)[0]) {
				tabs.removeClass("current ").eq(index).addClass("current ");
				panels.addClass("hide").eq(index).removeClass("hide");
...
//触及显示缩略图
    ...
    //记录浏览历史
	$.get("index.php?app=goods&wwi=addbrowse",{gid:<?php echo $output['goods']['goods_id'];?>});
	//初始化对比按钮
	initCompare();

    $('[nctype="show_chain"]').click(function(){
        _goods_id = $(this).attr('data-goodsid');
        ajax_form('show_chain', '查看门店', 'index.php?app=goods&wwi=show_chain&goods_id=' + _goods_id, 640);
    });
    ...
    $('.wwi-ss-buy').bind({
        mouseover:function(){$(".wwi-ss-point").show();},
        mouseout:function(){$(".wwi-ss-point").hide();}
    });
...
function addcart_callback(data){
    ...
    $('.wwi-ss-cart-popup').fadeIn('fast');
}

<?php if($output['goods']['goods_state'] == 1 && $output['goods']['goods_verify'] == 1 && $output['goods']['is_virtual'] == 0){ ?>
var $cur_area_list,$cur_tab,next_tab_id = 0,cur_select_area = [],calc_area_id = '',calced_area = [],cur_select_area_ids = [];
$(document).ready(function(){
	$("#wwi-ss-freight-selector").hover(function() {
		//如果店铺没有设置默认显示区域，马上异步请求
		<?php if (!$output['store_info']['deliver_region']) { ?>
		if (typeof nc_a === "undefined") {
	 		$.getJSON(SITEURL + "/index.php?app=index&wwi=json_area&callback=?", function(data) {
	 			nc_a = data;
	 			$cur_tab = $('#wwi-ss-stock').find('li[data-index="0"]');
	 			_loadArea(0);
	 		});
		}
		<?php } ?>
	...
	$('ul[class="area-list"]').on('click','a',function(){
		$('#wwi-ss-freight-selector').unbind('mouseleave');
		...
		$cur_tab = $('#wwi-ss-stock').find('li[data-index="'+tab_id+'"]');
		...
		if (tab_id < 2) {
			...
			cur_select_area.push($(this).html());
			cur_select_area_ids.push(area_id);
			$('#wwi-ss-freight-selector > div[class="text"] > div').html(cur_select_area.join(''));
			$('#wwi-ss-freight-selector').removeClass("hover");
			_calc();
		}
		$('#wwi-ss-stock').find('li[data-widget="tab-item"]').on('click','a',function(){
			var tab_id = parseInt($(this).parent().attr('data-index'));
			if (tab_id < 2) {
				$(this).parent().nextAll().remove();
				$(this).addClass('hover');
				$('#wwi-ss-stock').find('div[data-widget="tab-content"]').each(function(){
	...
	function _loadArea(area_id){
		if (nc_a[area_id] && nc_a[area_id].length > 0) {
			...
			$('#wwi-ss-freight-selector > div[class="text"] > div').html(cur_select_area);
			$('#wwi-ss-freight-selector').removeClass("hover");
			_calc();
		}
	}
	...
	function _calc() {
		...
		if (_args != '') {
			...
			if (typeof calced_area[calc_area_id] == 'undefined') {
				//需要请求配送区域设置
				$.getJSON(SITEURL + "/index.php?app=goods&wwi=calc&" + _args + "&myf=<?php echo $output['store_info']['store_free_price']?>&callback=?", function(data){
					allow_buy = data.total ? true : false;
					calced_area[calc_area_id] = data.total;
					if (data.total === false) {
						$('#wwi-ss-freight-prompt > strong').html('无货').next().remove();
						$('a[nctype="buynow_submit"]').addClass('no-buynow');
						$('a[nctype="addcart_submit"]').addClass('no-buynow');
					} else {
						$('#wwi-ss-freight-prompt > strong').html('有货 ').next().remove();
						$('#wwi-ss-freight-prompt > strong').after('<span>' + data.total + '</span>');
				...
				if (calced_area[calc_area_id] === false) {
					...
					$('#wwi-ss-freight-prompt > strong').html('有货 ').next().remove();
					$('#wwi-ss-freight-prompt > strong').after('<span>' + calced_area[calc_area_id] + '</span>');
					$('a[nctype="buynow_submit"]').removeClass('no-buynow');
					$('a[nctype="addcart_submit"]').removeClass('no-buynow');
				}
			}
