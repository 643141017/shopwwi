...
<div class="wwi-ss-goods-title-nav" nctype="gbc_nav">
  <ul>
...
<div class="wwi-ss-goods-info-content" nctype="gbc_content">
  <?php if (!empty($output['bundling_array']) && !empty($output['b_goods_array'])) {?>
  <div class="wwi-ss-bundling-box"> 
    <!--S 组合销售 -->
    <div class="wwi-ss-bundling-tab">
    ...
    <div class="wwi-ss-bundling-container">
      <?php $i=0;foreach($output['bundling_array'] as $val){?>
      ...
      <div <?php if ($i != 0) {?>style="display: none;"<?php }?> data-id="<?php echo $val['id'];?>">
        ...
        <div class="wwi-ss-bundling-price">
        <ul>
  ...
  <?php }?>
  <?php if (!empty($output['gcombo_list'])) {?>
  <div <?php if ($current) {?>style="display:none;"<?php }?> class="wwi-ss-combo-box">
    ...
    <div class="combo-goods">
      <div class="wwi-ss-combo-tab"> <span class="selected"><a href="javascript:;" data-id="all">全部</a></span>
...
function addcombcart(goods_ids)
{
    ...
    var url = 'index.php?app=cart&wwi=add_comb';
