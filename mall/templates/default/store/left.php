...
<div class="wwi-ss-sidebar-container wwi-ss-class-bar">
  <div class="title">
    <h4><?php echo $lang['nc_goods_class'];?></h4>
  </div>
  <div class="content">
    <p><span><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '1', 'order' => '2'));?>"><?php echo $lang['nc_by_new'];?></a></span><span><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '2', 'order' => '2'));?>"><?php echo $lang['nc_by_price'];?></a></span><span><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '3', 'order' => '2'));?>"><?php echo $lang['nc_by_sale'];?></a></span><span><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '5', 'order' => '2'));?>"><?php echo $lang['nc_by_click'];?></a></span></p>
    <div class="wwi-ss-search">
      <form id="" name="searchMall" method="get" action="index.php" >
        <input type="hidden" name="app" value="show_store" />
        <input type="hidden" name="wwi" value="goods_all" />
        ...
        <a href="javascript:document.searchMall.submit();" class="ncbtn"><?php echo $lang['nc_search'];?></a>
      </form>
    </div>
    <ul class="wwi-ss-submenu">
      <li><span class="ico-none"><em>-</em></span><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id']));?>"><?php echo $lang['nc_whole_goods'];?></a></li>
   ...
   <?php if(!empty($output['goods_commend']) && is_array($output['goods_commend']) && count($output['goods_commend'])>1){?>
    <div class="wwi-ss-sidebar-container shopwwi-look-look">
      <div class="title">
        <h4>店铺热卖</h4>
      </div>
      <div class="content">
...
<div class="wwi-ss-sidebar-container wwi-ss-top-bar">
  ...
  <div class="content">
    <ul class="wwi-ss-top-tab pngFix">
      <li id="hot_sales_tab" class="current"><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '3', 'order' => '2'));?>"><?php echo $lang['nc_hot_goods_rankings'];?></a></li>
      <li id="hot_collect_tab"><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '4', 'order' => '2'));?>"><?php echo $lang['nc_hot_collect_rankings'];?></a></li>
    </ul>
    ...
    <div id="hot_collect_list" class="wwi-ss-top-panel hide">
    ...
    <p><a href="<?php echo urlMall('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id']));?>"><?php echo $lang['nc_look_more_store_goods'];?></a></p>
  </div>
</div>
