...
<div class="tzx-sns">
  <div class="tzx-sns-left">
    <div class="tzx-sns-tabmene">
      <ul>
    ...
    <div class="tzx-sns-content">
      <?php if(!empty($output['strace_array'])){?>
      <ul class="tzx-sns-content-list">
              ...
              <div id="forward_<?php echo $val['strace_id'];?>" style="display:none;">
                <div class="forward-widget">
                  <div class="forward-edit">
                    <form id="forwardform_<?php echo $val['strace_id'];?>" method="post" action="index.php?app=store_snshome&wwi=addforward">
  ...
  <div class="tzx-sns-right">
    <div class="tzx-sns-right-container">
      <div class="tzx-store-pic"><a><img src="<?php echo getStoreLogo($output['store_info']['store_avatar']);?>" alt="<?php echo $output['store_info']['store_name'];?>" title="<?php echo $output['store_info']['store_name'];?>" /></a></div>
      <dl class="tzx-store-info">
        <dt><?php echo $output['store_info']['store_name']; ?></dt>
        <dd>已收藏：<em nctype="store_collect"><?php echo $output['store_info']['store_collect']?></em></dd>
      </dl>
      <div class="tzx-store-favorites"><a href="javascript:collect_store('<?php echo $output['store_info']['store_id'];?>','count','store_collect')" ><i class="icon-plus"></i>收藏店铺</a></div>
    </div>
    <div class="tzx-sns-right-container">
      <?php if (!empty($output['favorites_list'])) {?>
      <div class="title">最新收藏用户</div>
      <div class="tzx-favorites-user">
        <ul>
