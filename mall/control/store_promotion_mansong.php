...
class store_promotion_mansongControl extends BaseSellerControl {
    ...
    public function indexWwi() {
        $this->mansong_listWwi();
    }

    /**
     * 发布的满就送活动列表
     **/
    public function mansong_listWwi() {
     ...
     * 添加满就送活动
     **/
    public function mansong_addWwi() {
        $model_mansong_quota = Model('p_mansong_quota');
        $model_mansong = Model('p_mansong');
     ...
     * 保存添加的满就送活动
     **/
    public function mansong_saveWwi() {
     ...
     * 满就送活动详细信息
     **/
    public function mansong_detailWwi() {
     ...
     * 满就送活动删除
     **/
    public function mansong_delWwi() {
        ...
        if($result) {
            ...
            showDialog(L('nc_common_op_succ'), urlMall('store_promotion_mansong', 'mansong_list'), 'succ');
        } else {
     ...
     * 满就送套餐购买
     **/
    public function mansong_quota_addWwi() {
     ...
     * 满就送套餐购买保存
     **/
    public function mansong_quota_add_saveWwi() {
