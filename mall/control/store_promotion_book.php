...
class store_promotion_bookControl extends BaseSellerControl {
     ...
     * 购买套餐
     */
    public function book_quota_addWwi() {
        if (chksubmit()) {
    ...
    public function book_renewWwi() {
        if (chksubmit()) {
            ...
            if ($return) {
                ...
                showDialog('购买成功', urlMall('store_promotion_book', 'book_list'), 'succ');
            } else {
                showDialog('购买失败', urlMall('store_promotion_book', 'book_quota_add'));
            }
        }
     ...
     * 选择商品
     */
    public function book_select_goodsWwi() {
