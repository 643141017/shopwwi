...
class store_promotion_soleControl extends BaseSellerControl {
    ...
    public function indexWwi() {
        $this->sole_goods_listWwi();
    }

    /**
     * 套餐商品列表
     */
    public function sole_goods_listWwi() {
     ...
     * 选择商品
     */
    public function sole_select_goodsWwi() {
     ...
     * 购买套餐
     */
    public function sole_quota_addWwi() {
        if (chksubmit()) {
     ...
     * 保存选择商品
     */
    public function choosed_goods_saveWwi() {
        $model_sole = Model('p_sole');
        if (!checkPlatformStore()) {
            // 验证套餐时候过期
