...
class store_mapControl extends BaseSellerControl {
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'store_map':
                $menu_array = array(
                    array('menu_key'=>'index','menu_name'=>'地图显示 ',  'menu_url'=>'index.php?app=store_map&wwi=index'),
                    array('menu_key'=>'list','menu_name'=>'列表显示 ',  'menu_url'=>'index.php?app=store_map&wwi=list')
                );
                break;
        }
