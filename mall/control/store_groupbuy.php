...
class store_groupbuyControl extends BaseSellerControl {
     ...
     * 团购套餐购买
     **/
    public function groupbuy_quota_addWwi() {
        //输出导航
     ...
     * 团购套餐购买保存
     **/
    public function groupbuy_quota_add_saveWwi() {
     ...
     * 添加团购页面
     **/
    public function groupbuy_addWwi() {
        $model_groupbuy_quota = Model('groupbuy_quota');
     ...
     * 团购保存
     **/
    public function groupbuy_saveWwi() {
        //获取提交的数据
    ...
    public function groupbuy_goods_infoWwi() {
    ...
    public function check_groupbuy_goodsWwi() {
     ...
     * 选择活动商品
     **/
    public function search_goodsWwi() {
        $model_goods = Model('goods');
        $condition = array();
        $condition['store_id'] = $_SESSION['store_id'];
     ...
     * 添加虚拟团购页面
     */
    public function groupbuy_add_vrWwi()
    {
        $model_groupbuy_quota = Model('groupbuy_quota');
    ...
    public function ajax_vr_classWwi()
    {
    ...
    public function ajax_vr_areaWwi()
    {
     ...
     * 选择活动虚拟商品
     */
    public function search_vr_goodsWwi()
    {
        $model_goods = Model('goods');
        $condition = array();
        $condition['store_id'] = $_SESSION['store_id'];
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'groupbuy_list','menu_name'=>L('nc_member_path_group_list'),'menu_url'=>urlMall('store_groupbuy', 'groupbuy_list'))
        );
        switch ($menu_key){
        case 'groupbuy_add':
            $menu_array[] = array('menu_key'=>'groupbuy_add','menu_name'=>L('nc_member_path_new_group'),'menu_url'=>'index.php?app=store_groupbuy&wwi=groupbuy_add');
            break;
        case 'groupbuy_add_vr':
            $menu_array[] = array('menu_key'=>'groupbuy_add_vr','menu_name'=>'新增虚拟团购','menu_url'=>'index.php?app=store_groupbuy&wwi=groupbuy_add_vr');
            break;
        case 'groupbuy_quota_add':
            ...
            break;
        case 'groupbuy_edit':
            $menu_array[] = array('menu_key'=>'groupbuy_edit','menu_name'=>L('nc_member_path_edit_group'),'menu_url'=>'index.php?app=store_groupbuy');
            break;
        case 'cancel':
