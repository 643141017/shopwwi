...
class store_promotion_xianshiControl extends BaseSellerControl {
    ...
    const LINK_XIANSHI_LIST = 'index.php?app=store_promotion_xianshi&wwi=xianshi_list';
    const LINK_XIANSHI_MANAGE = 'index.php?app=store_promotion_xianshi&wwi=xianshi_manage&xianshi_id=';
     ...
     * 添加限时折扣活动
     **/
    public function xianshi_addWwi() {
        if (checkPlatformStore()) {
            Tpl::output('isOwnMall', true);
        } else {
            $model_xianshi_quota = Model('p_xianshi_quota');
     ...
     * 保存添加的限时折扣活动
     **/
    public function xianshi_saveWwi() {
        //验证输入
     ...
     * 编辑限时折扣活动
     **/
    public function xianshi_editWwi() {
        $model_xianshi = Model('p_xianshi');
     ...
     * 编辑保存限时折扣活动
     **/
    public function xianshi_edit_saveWwi() {
    ...
    public function xianshi_delWwi() {
        ...
        if($result) {
            ...
            showDialog(L('nc_common_op_succ'), urlMall('store_promotion_xianshi', 'xianshi_list'), 'succ');
        } else {
     ...
     * 限时折扣活动管理
     **/
    public function xianshi_manageWwi() {
        $model_xianshi = Model('p_xianshi');
        $model_xianshi_goods = Model('p_xianshi_goods');
     ...
     * 限时折扣套餐购买
     **/
    public function xianshi_quota_addWwi() {
        //输出导航
     ...
     * 限时折扣套餐购买保存
     **/
    public function xianshi_quota_add_saveWwi() {
     ...
     * 选择活动商品
     **/
    public function goods_selectWwi() {
     ...
     * 限时折扣商品添加
     **/
    public function xianshi_goods_addWwi() {
     ...
     * 限时折扣商品价格修改
     **/
    public function xianshi_goods_price_editWwi() {
     ...
     * 限时折扣商品删除
     **/
    public function xianshi_goods_deleteWwi() {
        $model_xianshi_goods = Model('p_xianshi_goods');
        $model_xianshi = Model('p_xianshi');
   ...
   /**
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'xianshi_list','menu_name'=>Language::get('promotion_active_list'),'menu_url'=>'index.php?app=store_promotion_xianshi&wwi=xianshi_list'),
        );
        switch ($menu_key){
            case 'xianshi_add':
                $menu_array[] = array('menu_key'=>'xianshi_add','menu_name'=>Language::get('promotion_join_active'),'menu_url'=>'index.php?app=store_promotion_xianshi&wwi=xianshi_add');
                break;
            case 'xianshi_edit':
                $menu_array[] = array('menu_key'=>'xianshi_edit','menu_name'=>'编辑活动','menu_url'=>'javascript:;');
                break;
            case 'xianshi_quota_add':
                $menu_array[] = array('menu_key'=>'xianshi_quota_add','menu_name'=>Language::get('promotion_buy_product'),'menu_url'=>'index.php?app=store_promotion_xianshi&wwi=xianshi_quota_add');
                break;
            case 'xianshi_manage':
                $menu_array[] = array('menu_key'=>'xianshi_manage','menu_name'=>Language::get('promotion_goods_manage'),'menu_url'=>'index.php?app=store_promotion_xianshi&wwi=xianshi_manage&xianshi_id='.$_GET['xianshi_id']);
                break;
        }
