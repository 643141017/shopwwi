...
class goodsControl extends BaseGoodsControl {
     ...
     * 商品评价详细页
     */
    public function comments_listWwi() {
        $goods_id = intval($_GET['goods_id']);
     ...
     * 产品咨询
     */
    public function consulting_listWwi() {
     ...
     * 商品咨询添加
     */
    public function save_consultWwi(){
        //检查是否可以评论
     ...
     * 异步显示优惠套装/推荐组合
     */
    public function get_bundlingWwi() {
        $goods_id = intval($_GET['goods_id']);
        if ($goods_id <= 0) {
            exit();
        }
     ...
     * 到货通知
     */
    public function arrival_noticeWwi() {
     ...
     * 到货通知表单
     */
    public function arrival_notice_submitWwi() {
     ...
     * 到货通知添加成功
     */
    public function arrival_notice_succWwi() {
        // 可能喜欢的商品
