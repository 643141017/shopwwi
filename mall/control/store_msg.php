...
class store_msgControl extends BaseSellerControl {
     ...
     * AJAX标记为已读
     */
    public function mark_as_readWwi() {
        $smids = $_GET['smids'];
     ...
     * 消息接收设置
     */
    public function msg_settingWwi() {
        // 验证是否为管理员
        if (!$this->checkIsAdmin()) {
            showDialog(L('para_error'), '', 'error');
        }
     ...
     * 编辑店铺消息接收设置
     */
    public function edit_msg_settingWwi() {
        // 验证是否为管理员
        if (!$this->checkIsAdmin()) {
            showDialog(L('para_error'), '', 'error');
        }
     ...
     * 保存店铺接收设置
     */
    public function save_msg_settingWwi() {
        // 验证是否为管理员
        if (!$this->checkIsAdmin()) {
            showDialog(L('para_error'), '', 'error');
        }
