...
class store_waybillControl extends BaseSellerControl{
     ...
     * 模板管理
     */
    public function waybill_manageWwi() {
     ...
     * 绑定运单打印模板
     */
    public function waybill_bindWwi() {
     ...
     * 绑定运单打印模板保存
     */
    public function waybill_bind_saveWwi() {
     ...
     * 解绑运单打印模板
     */
    public function waybill_unbindWwi() {
     ...
     * 运单模板设置
     */
    public function waybill_settingWwi() {
     ...
     * 运单模板设置保存
     */
    public function waybill_setting_saveWwi() {
        $store_waybill_id = intval($_POST['store_waybill_id']);
        ...
        if($result) {
            showDialog(L('nc_common_save_succ'), urlMall('store_waybill', 'waybill_manage'), 'succ');
        } else {
     ...
     * 运单打印测试
     */
    public function waybill_testWwi() {
        $model_waybill = Model('waybill');
     ...
     * 设置默认打印模板
     */
    public function waybill_set_defaultWwi() {
        $store_waybill_id = intval($_POST['store_waybill_id']);
     ...
     * 模板列表
     */
    public function waybill_listWwi() {
        $model_waybill = Model('waybill');
     ...
     * 添加运单模板
     */
    public function waybill_addWwi() {
        $model_express = Model('express');
     ...
     * 保存运单模板
     */
    public function waybill_saveWwi() {
        $model_waybill = Model('waybill');
        $result = $model_waybill->saveWaybill($_POST, $_SESSION['store_id']);

        if($result) {
            showDialog(L('nc_common_save_succ'), urlMall('store_waybill', 'waybill_list'), 'succ');
        } else {
            showDialog(L('nc_common_save_fail'), urlMall('store_waybill', 'waybill_list'));
        }
    }
     ...
     * 删除运单模板
     */
    public function waybill_delWwi() {
     ...
     * 编辑运单模板
     */
    public function waybill_editWwi() {
        $model_express = Model('express');
        $model_waybill = Model('waybill');
     ...
     * 设计运单模板
     */
    public function waybill_designWwi() {
        $model_waybill = Model('waybill');
     ...
     * 设计运单模板保存
     */
    public function waybill_design_saveWwi() {
        $model_waybill = Model('waybill');
