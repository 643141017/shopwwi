...
class store_transportControl extends BaseSellerControl {
     ...
     *
     */
    public function offpay_areaWwi()
    {
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            ...
            case 'offpay_area':
                $menu_array = array(
                1=>array('menu_key'=>'transport',   'menu_name'=>Language::get('nc_member_path_postage'),       'menu_url'=>'index.php?app=store_transport'),
                );
                if (checkPlatformStore()) {
                    $menu_array[] = array(
                        'menu_key' => 'offpay_area',
                        'menu_name' => '货到付款地区',
                        'menu_url' => 'index.php?app=store_transport&wwi=offpay_area'
                    );
                }
                break;
        }
