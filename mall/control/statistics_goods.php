...
class statistics_goodsControl extends BaseSellerControl {
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (in_array($this->search_arr['wwi'],array('price','hotgoods'))){
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'goodslist','menu_name'=>'商品详情',   'menu_url'=>'index.php?app=statistics_goods&wwi=goodslist'),
            2=>array('menu_key'=>'price','menu_name'=>'价格销量',   'menu_url'=>'index.php?app=statistics_goods&wwi=price'),
            3=>array('menu_key'=>'hotgoods','menu_name'=>'热卖商品',    'menu_url'=>'index.php?app=statistics_goods&wwi=hotgoods'),
        );
