...
{
    const LINK_COU_LIST = 'index.php?app=store_promotion_cou&wwi=cou_list';
     ...
     * 加价购套餐购买
     */
    public function cou_quota_addWwi()
    {
        // 输出导航
     ...
     * 加价购套餐购买保存
     */
    public function cou_quota_add_saveWwi()
    {
     ...
     * 保存添加的加价购活动
     */
    public function cou_add_saveWwi()
    {
        // 验证输入
        ...
        if ($result) {
            ...
            $editUrl = 'index.php?app=store_promotion_cou&wwi=cou_edit&cou_id=' . $result;
     ...
     * 保存编辑的加价购活动
     */
    public function cou_edit_saveWwi()
    {
        // 验证输入
     ...
     * 异步设置加价购活动规则中的换购商品
     */
    public function cou_level_skuWwi()
    {
    ...
    private function profile_menu($menu_key='')
    {
        $menu_array = array(
            1 => array(
                'menu_key' => 'cou_list',
                'menu_name' => '活动列表',
                'menu_url' => 'index.php?app=store_promotion_cou&wwi=cou_list',
            ),
        );
        switch ($menu_key) {
            case 'cou_quota_add':
                $menu_array[] = array(
                    ...
                    'menu_name' => '购买套餐',
                    'menu_url' => 'index.php?app=store_promotion_cou&wwi=cou_add',
                );
                break;
            case 'cou_add':
                $menu_array[] = array(
