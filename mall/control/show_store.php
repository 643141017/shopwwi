...
class show_storeControl extends BaseStoreControl {
    ...
    public function show_articleWwi() {
        //判断是否为导航页面
     ...
     * ajax获取动态数量
     */
    function ajax_store_trend_countWwi(){
     ...
     * ajax 店铺流量统计入库
     */
    public function ajax_flowstat_recordWwi(){
