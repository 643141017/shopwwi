...
class Control{
    ...
    protected function checkLogin(){
        if ($_SESSION['is_login'] !== '1'){
            if (trim($_GET['wwi']) == 'favoritegoods' || trim($_GET['wwi']) == 'favoritestore'){
...
class BaseSellerControl extends Control {
    ...
    public function __construct(){
        ...
        if ($_GET['app'] !== 'seller_login') {
            ...
            if(empty($_SESSION['seller_id'])) {
                @header('location: index.php?app=seller_login&wwi=show_login');die;
            }
            ...
            if (checkPlatformStore()) {
                $this->store_grade = array(
                    ...
                    // see also store_settingControl.themeWwi()
    ...
    protected function recordSellerLog($content = '', $state = 1){
        ...
        $seller_info['log_url'] = $_GET['app'].'&'.$_GET['wwi'];
    ...
    private function _getMenuList() {
        $menu_list = array(
            'goods' => array('name' => '商品', 'child' => array(
                ...
                array('name' => '图片空间', 'app'=>'store_album', 'wwi'=>'album_cate'),
            )),
            'order' => array('name' => '订单', 'child' => array(
                array('name' => '实物交易订单', 'app'=>'store_order', 'wwi'=>'index'),
                array('name' => '虚拟兑码订单', 'app'=>'store_vr_order', 'wwi'=>'index'),
                array('name' => '发货', 'app'=>'store_deliver', 'wwi'=>'index'),
                array('name' => '发货设置', 'app'=>'store_deliver_set', 'wwi'=>'daddress_list'),
                array('name' => '运单模板', 'app'=>'store_waybill', 'wwi'=>'waybill_manage'),
                array('name' => '评价管理', 'app'=>'store_evaluate', 'wwi'=>'list'),
                array('name' => '物流工具', 'app'=>'store_transport', 'wwi'=>'index'),
				array('name' => '来单提醒', 'app'=>'order_call', 'wwi'=>'index'),
            )),
            'promotion' => array('name' => '促销', 'child' => array(
                array('name' => '团购管理', 'app'=>'store_groupbuy', 'wwi'=>'index'),
                array('name' => '加价购', 'app'=>'store_promotion_cou', 'wwi'=>'cou_list'),
                array('name' => '限时折扣', 'app'=>'store_promotion_xianshi', 'wwi'=>'xianshi_list'),
                array('name' => '满即送', 'app'=>'store_promotion_mansong', 'wwi'=>'mansong_list'),
                array('name' => '优惠套装', 'app'=>'store_promotion_bundling', 'wwi'=>'bundling_list'),
                array('name' => '推荐展位', 'app' => 'store_promotion_booth', 'wwi' => 'booth_goods_list'),
                array('name' => '预售商品', 'app' => 'store_promotion_book', 'wwi' => 'index'),
                array('name' => 'F码商品', 'app' => 'store_promotion_fcode', 'wwi' => 'index'),
                array('name' => '推荐组合', 'app' => 'store_promotion_combo', 'wwi' => 'index'),
                array('name' => '手机专享', 'app' => 'store_promotion_sole', 'wwi' => 'index'),
                array('name' => '代金券管理', 'app'=>'store_voucher', 'wwi'=>'templatelist'),
                array('name' => '活动管理', 'app'=>'store_activity', 'wwi'=>'store_activity'),
            )),
            'store' => array('name' => '店铺', 'child' => array(
                array('name' => '店铺设置', 'app'=>'store_setting', 'wwi'=>'store_setting'),
                array('name' => '店铺装修', 'app'=>'store_decoration', 'wwi'=>'decoration_setting'),
                array('name' => '店铺导航', 'app'=>'store_navigation', 'wwi'=>'navigation_list'),
                array('name' => '店铺动态', 'app'=>'store_sns', 'wwi'=>'index'),
                array('name' => '店铺信息', 'app'=>'store_info', 'wwi'=>'bind_class'),
                array('name' => '店铺分类', 'app'=>'store_goods_class', 'wwi'=>'index'),
                array('name' => '品牌申请', 'app'=>'store_brand', 'wwi'=>'brand_list'),
                array('name' => '供货商', 'app'=>'store_supplier', 'wwi'=>'sup_list'),
                array('name' => '实体店铺', 'app'=>'store_map', 'wwi'=>'index'),
                array('name' => '消费者保障服务', 'app'=>'store_contract', 'wwi'=>'index'),
            )),
            'consult' => array('name' => '售后', 'child' => array(
                array('name' => '咨询管理', 'app'=>'store_consult', 'wwi'=>'consult_list'),
                array('name' => '投诉管理', 'app'=>'store_complain', 'wwi'=>'list'),
                array('name' => '退款记录', 'app'=>'store_refund', 'wwi'=>'index'),
                array('name' => '退货记录', 'app'=>'store_return', 'wwi'=>'index'),
            )),
            'statistics' => array('name' => '运营', 'child' => array(
                array('name' => '店铺概况', 'app'=>'statistics_general', 'wwi'=>'general'),
                array('name' => '商品分析', 'app'=>'statistics_goods', 'wwi'=>'goodslist'),
                array('name' => '运营报告', 'app'=>'statistics_sale', 'wwi'=>'sale'),
                array('name' => '行业分析', 'app'=>'statistics_industry', 'wwi'=>'hot'),
                array('name' => '流量统计', 'app'=>'statistics_flow', 'wwi'=>'storeflow'),
                array('name' => '实物结算', 'app'=>'store_bill', 'wwi'=>'index'),
                array('name' => '虚拟结算', 'app'=>'store_vr_bill', 'wwi'=>'index'),
            )),
            'message' => array('name' => '客服', 'child' => array(
                array('name' => '客服设置', 'app'=>'store_callcenter', 'wwi'=>'index'),
                array('name' => '系统消息', 'app'=>'store_msg', 'wwi'=>'index'),
                array('name' => '聊天记录查询', 'app'=>'store_im', 'wwi'=>'index'),
            )),
            'account' => array('name' => '账号', 'child' => array(
                array('name' => '账号列表', 'app'=>'store_account', 'wwi'=>'account_list'),
                array('name' => '账号组', 'app'=>'store_account_group', 'wwi'=>'group_list'),
                array('name' => '账号日志', 'app'=>'seller_log', 'wwi'=>'log_list'),
                array('name' => '店铺消费', 'app'=>'store_cost', 'wwi'=>'cost_list'),
                array('name' => '门店账号', 'app'=>'store_chain', 'wwi'=>'index'),
            )),
			'shopwwi' => array('name' => '运维', 'child' => array(
                array('name' => 'CSV导入', 'app'=>'taobao_import', 'wwi'=>'index'),
                array('name' => '淘宝在线采集', 'app'=>'taobao_caiji', 'wwi'=>'index'),
            ))
        );
        return $menu_list;
    }
