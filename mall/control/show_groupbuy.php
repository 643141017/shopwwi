...
class show_groupbuyControl extends BaseHomeControl {
     ...
     * 选择城市
     */
    public function select_cityWwi()
    {
     ...
     * 进行中的虚拟抢购
     */
    public function vr_groupbuy_listWwi()
    {
        Tpl::output('current', 'online');
     ...
     * 即将开始的虚拟抢购
     */
    public function vr_groupbuy_soonWwi()
    {
     ...
     * 往期虚拟抢购
     */
    public function vr_groupbuy_historyWwi()
    {
     ...
     * 即将开始的抢购
     **/
    public function groupbuy_soonWwi() {
        Tpl::output('current', 'soon');
        Tpl::output('buy_button', '未开始');
     ...
     * 往期抢购
     **/
    public function groupbuy_historyWwi() {
        Tpl::output('current', 'history');
        Tpl::output('buy_button', '已结束');
 ...
 // 轮播图片
     ...
     * 抢购详细信息
     **/
    public function groupbuy_detailWwi() {
     ...
     * 购买记录
     */
    public function groupbuy_orderWwi() {
        $group_id = intval($_GET['group_id']);
        if ($group_id > 0) {
            if (!$_GET['is_vr']) {
                //获取购买记录
     ...
     * 商品评价
     */
    public function groupbuy_evaluateWwi() {
