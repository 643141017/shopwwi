...
class store_settingControl extends BaseSellerControl {
     ...
     * @return
     */
    public function store_settingWwi(){
        /**
         * 实例化模型
         */
        ...
        if (chksubmit()){
            ...
            $model_class->editStore($param, array('store_id' => $store_id));
            showDialog(Language::get('nc_common_save_succ'),'index.php?app=store_setting&wwi=store_setting','succ');
        }
        /**
         * 实例化店铺等级模型
         */
     ...
     * 店铺幻灯片
     */
    public function store_slideWwi() {
        /**
         * 模型实例化
         */
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            showDialog(Language::get('nc_common_save_succ'),'index.php?app=store_setting&wwi=store_slide','succ');
        }
     ...
     * 店铺幻灯片ajax上传
     */
    public function silde_image_uploadWwi(){
        $upload = new UploadFile();
    ...
    public function store_mb_slidersWwi()
    {
        try {
    ...
    public function store_mb_sliders_dropWwi()
    {
        try {
            $id = (int) $_REQUEST['id'];
    ...
    public function store_mobileWwi()
    {
        ...
        if (chksubmit()) {
            ...
            showDialog('保存成功', 'index.php?app=store_setting&wwi=store_mobile', 'succ');
        }
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
            1=>array('menu_key'=>'store_setting','menu_name'=>Language::get('nc_member_path_store_config'),'menu_url'=>'index.php?app=store_setting&wwi=store_setting'),
            4=>array('menu_key'=>'store_slide','menu_name'=>Language::get('nc_member_path_store_slide'),'menu_url'=>'index.php?app=store_setting&wwi=store_slide'),
            5=>array('menu_key'=>'store_theme','menu_name'=>'店铺主题','menu_url'=>'index.php?app=store_setting&wwi=theme'),

            7 => array(
                'menu_key' => 'store_mobile',
                'menu_name' => '手机店铺设置',
                'menu_url' => 'index.php?app=store_setting&wwi=store_mobile',
            ),
        );
