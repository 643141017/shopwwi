...
class store_snsControl extends BaseSellerControl{
     ...
     * 保存动态
     */
    public function store_sns_saveWwi(){
        /**
         * 验证表单
         */
        ...
        if($rs){
            showDialog(Language::get('nc_common_op_succ'), 'index.php?app=store_sns', 'succ');
        }else{
    ...
    private function profile_menu($menu_key) {
        $menu_array = array(
                1=>array('menu_key'=>'store_sns_add', 'menu_name'=>Language::get('store_sns_add'), 'menu_url'=>'index.php?app=store_sns&wwi=add'),
                2=>array('menu_key'=>'store_sns_setting', 'menu_name'=>Language::get('store_sns_setting'), 'menu_url'=>'index.php?app=store_sns&wwi=setting'),
