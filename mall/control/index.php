...
class indexControl extends BaseHomeControl{
     ...
     * 根据ID返回所有父级地区名称
     */
    public function json_area_showWwi()
    {
 ...
 */
     ...
     * 头部最近浏览的商品
     */
    public function viewed_infoWwi(){
        $info = array();
