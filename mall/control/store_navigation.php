...
class store_navigationControl extends BaseSellerControl {
    ...
    public function navigation_listWwi() {
    ...
    public function navigation_saveWwi() {
        $sn_info = array(
        ...
        showDialog(L('nc_common_op_succ'), urlMall('store_navigation', 'navigation_list'), 'succ');
    }
    ...
    public function navigation_delWwi() {
        ...
        if($sn_id > 0) {
            ...
            showDialog(L('nc_common_op_fail'), urlMall('store_navigation', 'navigation_list'), 'error');
        }
    }
