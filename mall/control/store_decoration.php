...
class store_decorationControl extends BaseSellerControl {
     ...
     * 店铺装修设置
     */
    public function decoration_settingWwi() {
     ...
     * 店铺装修设置保存
     */
    public function decoration_setting_saveWwi() {
        $model_store_decoration = Model('store_decoration');
     ...
     * 装修图库列表
     */
    public function decoration_albumWwi() {
     ...
     * 图片上传
     */
    public function decoration_album_uploadWwi() {
     ...
     * 图片删除
     */
    public function decoration_album_delWwi() {
     ...
     * 店铺装修
     */
    public function decoration_editWwi() {
     ...
     * 保存店铺装修背景设置
     */
    public function decoration_background_setting_saveWwi() {
     ...
     * 装修导航保存
     */
    public function decoration_nav_saveWwi() {
        $decoration_id = intval($_POST['decoration_id']);
        $nav = array();
     ...
     * 装修banner保存
     */
    public function decoration_banner_saveWwi() {
        $decoration_id = intval($_POST['decoration_id']);
        $banner = array();
     ...
     * 装修添加块
     */
    public function decoration_block_addWwi() {
        $decoration_id = intval($_POST['decoration_id']);
     ...
     * 装修块删除
     */
    public function decoration_block_delWwi() {
     ...
     * 装修块保存
     */
    public function decoration_block_saveWwi() {
        $block_id = intval($_POST['block_id']);
     ...
     * 装修块排序
     */
    public function decoration_block_sortWwi() {
     ...
     * 商品搜索
     */
    public function goods_searchWwi() {
     ...
     * 装修预览
     */
    public function decoration_previewWwi() {
        $decoration_id = intval($_GET['decoration_id']);
     ...
     * 装修静态文件生成
     */
    public function decoration_buildWwi() {
        //静态文件路径
