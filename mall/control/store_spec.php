...
class store_specControl extends BaseSellerControl {
     ...
     * ajax删除规格值
     */
    public function ajax_delspecWwi(){
    ...
    private function _profile_menu($menu_type, $menu_key) {
        ...
        switch ($menu_type) {
            case 'spec':
                $menu_array = array(
                    array('menu_key' => 'spec', 'menu_name' => L('nc_member_path_store_spec'), 'menu_url' => 'index.php?app=store_spec')
                );
            break;
        }
