$(function(){
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url: SITEURL + '/index.php?app=store_goods_add&wwi=image_upload&upload_type=uploadedfile',
    ...
    $('#add_album').fileupload({
        dataType: 'json',
        url: SITEURL+'/index.php?app=store_goods_add&wwi=image_upload',
    ...
    $('ul[nctype="brand_list"]').on('click', 'li', function(){
        ...
        $('.wwist-brand-select > .wwist-brand-select-container').hide();
    });
    //搜索品牌列表滚条绑定
    ...
    $('input[name="b_name"]').focus(function(){
        $('.wwist-brand-select > .wwist-brand-select-container').show();
    });
    ...
    $('div[nctype="mobile_pannel"]').on('click', '[nctype="mp_edit"]', function(){
        ...
        $(this).parents('.module:first').html('')
            ...
            .append('<div class="wwist-mea-text" nctype="mea_txt"></div>')
            ...
            .append('<div class="button"><a class="wwist-btn wwist-btn-blue" nctype="meat_edit_submit" href="javascript:void(0);">确认</a><a class="wwist-btn ml10" nctype="meat_edit_cancel" href="javascript:void(0);">取消</a></div>')
    ...
    $('a[nctype="mb_add_img"]').click(function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?app=store_album&wwi=pic_list&item=mobile');
    });
    // 关闭 图片选择
    ...
    $('div[nctype="mobile_pannel"]').on('click', 'a[nctype="mp_rpl"]', function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?app=store_album&wwi=pic_list&item=mobile&type=replace');
    });
    // 插图图片
