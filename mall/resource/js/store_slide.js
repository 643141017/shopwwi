...
$(function(){
    ...
    /* 商品图片ajax上传 */
    var url = SITEURL + '/index.php?app=store_setting&wwi=silde_image_upload';
    $('.wwist-upload-btn').find('input[type="file"]').unbind().change(
        function() {
            var id = $(this).attr('id');
    ...
    $('a[nctype="del"]').unbind().click(
        function() {
            ...
            $.getJSON('index.php?app=store_setting&wwi=dorp_img', {file_id : file_id, img_src : img_src}, function(data) {
