...
function update_screen_focus() {
	...
	"" != b && $.ajax({
		...
		url: MALL_SITE_URL + "/index.php?app=adv&wwi=get_adv_list" + b,
		dataType: "jsonp",
		async: !0,
		success: function(a) {
			$(".full-screen-slides li[ap_id]").each(function() {
...
$(function(){
	...
	$(".bannerImg li img").mouseover(function(){
		$(".wwi-prev,.wwi-next").fadeIn();	
	});
	$(".banner").mouseleave(function(){
		$(".wwi-prev,.wwi-next").hide();	
	});
	//上翻
	$(".wwi-prev").click(function(){ 
		$(".banner li img").removeClass("now");
		var nIn=$(".bannerImg .current").index();
