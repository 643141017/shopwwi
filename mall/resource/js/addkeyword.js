...
function zsc_show(id){
	...
	if(zsc_class!='add'){
		...
		var url = "index.php?app=seller_wechat&wwi=addkeyword_ajax&kid="+zsc_id;
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		if(count==0){
			//var url = "/biz.php?ctl=wechat&app=keyword_index&wwi=add";
			var url = "index.php?app=seller_wechat&wwi=keyword_index&opt=add";
			...
			//var url = "/biz.php?ctl=wechat&app=keyword_index&wwi=update";
			var url = "index.php?app=seller_wechat&wwi=keyword_index&opt=update";
			var kid = $('#zsc_iid').val();
...
function zscdel(num){
	...
	var url = "index.php?app=seller_wechat&wwi=keyword_index&opt=del";
	//var url = "/biz.php?ctl=wechat&app=keyword_index&wwi=del";
		   ...
		   (
			   {
					...
					url:"index.php?app=seller_wechat&wwi=upload_fm",
