...
$html_title = 'ShopWWI【S5.1】 - 安装向导';

$html_header = <<<EOF
<div class="header">
  <div class="layout">
    <div class="title">
      <h5>ShopWWI【S5.1】正式版</h5>
      <h2>系统安装向导</h2>
    </div>
    <div class="version">版本: 2016.10.30.0669</div>
  </div>
</div>
...
function step3(&$install_error,&$install_recover){
    ...
    $sql .= "\r\n".file_get_contents("data/{$_charset}_tzx.sql");
    $sql .= "\r\n".file_get_contents("data/{$_charset}_tyq.sql");
    $sql .= "\r\n".file_get_contents("data/{$_charset}_tfx.sql");
