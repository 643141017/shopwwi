...
<div class="main">
  ...
  <div class="final-site-nav">
    ...
    <ul>
      ...
      <li class="cms">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/tzx" target="_blank">资讯</a></h5>
        <h6>CMS资讯、画报、专题...</h6>
      </li>
      <li class="circle">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/tyq" target="_blank">圈子</a></h5>
        <h6>主题、圈友、商品...</h6>
      </li>
      <li class="microshop">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/tfx" target="_blank">微商城</a></h5>
        <h6>随心看、个人秀、店铺街</h6>
      </li>
      <li class="admin">
        <div class="ico"></div>
