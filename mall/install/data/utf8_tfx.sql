...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='微商城商品评论表';
...
CREATE TABLE `#__micro_like` (
  ...
  PRIMARY KEY (`like_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='微商城喜欢表';
...
CREATE TABLE `#__micro_personal` (
  ...
  `tfx_commend` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '首页推荐 0-否 1-推荐',
  `tfx_sort` tinyint(3) unsigned NOT NULL DEFAULT '255' COMMENT '排序',
  PRIMARY KEY (`personal_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='微商城个人秀表';
...
CREATE TABLE `#__micro_store` (
  `tfx_store_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '店铺街店铺编号',
  `mall_store_id` int(11) unsigned NOT NULL COMMENT '商城店铺编号',
  `tfx_sort` tinyint(1) unsigned DEFAULT '255' COMMENT '排序',
  `tfx_commend` tinyint(1) unsigned DEFAULT '1' COMMENT '推荐首页标志 1-正常 2-推荐',
  `like_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '喜欢数',
  `comment_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '评论数',
  `click_count` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`tfx_store_id`)
