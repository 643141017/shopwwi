CREATE TABLE `#__tyq` (
  `tyq_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '圈子id',
  `tyq_name` varchar(12) NOT NULL COMMENT '圈子名称',
  `tyq_desc` varchar(255) DEFAULT NULL COMMENT '圈子描述',
  `tyq_masterid` int(11) unsigned NOT NULL COMMENT '圈主id',
  `tyq_mastername` varchar(50) NOT NULL COMMENT '圈主名称',
  `tyq_img` varchar(50) DEFAULT NULL COMMENT '圈子图片',
  `class_id` int(11) unsigned NOT NULL COMMENT '圈子分类',
  `tyq_mcount` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '圈子成员数',
  `tyq_thcount` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '圈子主题数',
  `tyq_gcount` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '圈子商品数',
  `tyq_pursuereason` varchar(255) DEFAULT NULL COMMENT '圈子申请理由',
  `tyq_notice` varchar(255) DEFAULT NULL COMMENT '圈子公告',
  `tyq_status` tinyint(3) unsigned NOT NULL COMMENT '圈子状态，0关闭，1开启，2审核中，3审核失败',
  `tyq_statusinfo` varchar(255) DEFAULT NULL COMMENT '关闭或审核失败原因',
  `tyq_joinaudit` tinyint(3) unsigned NOT NULL COMMENT '加入圈子时候需要审核，0不需要，1需要',
  `tyq_addtime` varchar(10) NOT NULL COMMENT '圈子创建时间',
  `tyq_noticetime` varchar(10) DEFAULT NULL COMMENT '圈子公告更新时间',
  `is_recommend` tinyint(3) unsigned NOT NULL COMMENT '是否推荐 0未推荐，1已推荐',
  `is_hot` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否为热门圈子 1是 0否',
  `tyq_tag` varchar(60) DEFAULT NULL COMMENT '圈子标签',
...
CREATE TABLE `#__tyq_fs` (
  ...
  PRIMARY KEY (`tyq_id`,`friendship_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='友情圈子表';


CREATE TABLE `#__tyq_inform` (
  ...
  KEY `circle_id` (`tyq_id`,`theme_id`,`reply_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='圈子举报表';


CREATE TABLE `#__tyq_like` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `tyq_id` int(11) unsigned NOT NULL COMMENT '圈子id'
...
CREATE TABLE `#__tyq_member` (
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `tyq_id` int(11) unsigned NOT NULL COMMENT '圈子id',
  `tyq_name` varchar(12) DEFAULT NULL COMMENT '圈子名称',
  `member_name` varchar(50) NOT NULL COMMENT '会员名称',
...
CREATE TABLE `#__tyq_thpolloption` (
...
CREATE TABLE `#__tyq_thpollvoter` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '成员id',
  `member_name` varchar(50) NOT NULL COMMENT '成员名称',
...
INSERT INTO `#__tyq_mldefault` (`mld_id`, `mld_name`, `mld_exp`) VALUES
(1, '初级粉丝', 1),
(2, '中级粉丝', 5),
(3, '高级粉丝', 15),
(4, '正式会员', 30),
...
INSERT INTO `#__tyq_mlref` (`mlref_id`, `mlref_name`, `mlref_addtime`, `mlref_status`, `mlref_1`, `mlref_2`, `mlref_3`, `mlref_4`, `mlref_5`, `mlref_6`, `mlref_7`, `mlref_8`, `mlref_9`, `mlref_10`, `mlref_11`, `mlref_12`, `mlref_13`, `mlref_14`, `mlref_15`, `mlref_16`) VALUES
