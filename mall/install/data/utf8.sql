...
CREATE TABLE `#__brand` (
  ...
  `brand_bgpic` varchar(100) DEFAULT '/data/upload/shop/editor/brand_default_max.jpg',
  `brand_xbgpic` varchar(100) DEFAULT '/data/upload/shop/editor/brand_default_small.jpg',
  `brand_tjstore` varchar(100) DEFAULT '请于品牌管理里编辑我',
  `brand_introduction` varchar(100) DEFAULT '网店运维提醒您：你当前的品牌介绍并没有填写！使用默认的这些会出现在你的眼前，请于后台进行修改',
...
CREATE TABLE `#__yydb` (
  `yydb_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '夺宝编号',
  `yydb_code` varchar(32) NOT NULL COMMENT '夺宝编码',
  `yydb_g_id` int(11) DEFAULT NULL COMMENT '夺宝期数ID',
  `yydb_t_id` int(11) NOT NULL COMMENT '夺宝模版编号',
  `yydb_title` varchar(50) NOT NULL COMMENT '夺宝标题',
  `yydb_desc` varchar(255) NOT NULL COMMENT '夺宝描述',
  `yydb_start_date` int(11) NOT NULL COMMENT '夺宝有效期开始时间',
  `yydb_end_date` int(11) NOT NULL COMMENT '夺宝有效期结束时间',
  `yydb_price` int(11) NOT NULL COMMENT '夺宝面额',
  `yydb_state` tinyint(4) NOT NULL COMMENT '中奖状态(1-未中,2-已中)',
  `yydb_active_date` int(11) NOT NULL COMMENT '夺宝参与日期',
  `yydb_owner_id` int(11) NOT NULL COMMENT '参与夺宝者id',
  `yydb_owner_name` varchar(50) NOT NULL COMMENT '参与夺宝者名称',
  PRIMARY KEY (`yydb_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='红包表';


CREATE TABLE `#__yydb_class` (
  `sc_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `sc_name` varchar(50) NOT NULL COMMENT '分类名称',
  `sc_sort` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`sc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='夺宝分类表';


CREATE TABLE `#__yydb_giveout` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自动递增ID',
  `yydb_g_id` int(11) NOT NULL COMMENT '当期期数编号',
  `yydb_g_start_date` int(11) NOT NULL COMMENT '夺宝开始时间',
  `yydb_g_end_date` int(11) NOT NULL COMMENT '夺宝结束时间',
  `yydb_t_id` int(11) NOT NULL COMMENT '夺宝模板编号ID',
  `yydb_g_ob_date` int(11) DEFAULT NULL COMMENT '开奖时间',
  `yydb_g_code` int(11) DEFAULT NULL COMMENT '中奖编号码',
  `yydb_g_owner` int(11) DEFAULT NULL COMMENT '中奖者ID',
  `yydb_g_state` int(11) DEFAULT '1' COMMENT '开奖状态（1未开奖，2已开奖）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='夺宝期数表';
...
CREATE TABLE `#__yydb_template` (
  `yydb_t_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '夺宝模版编号',
  `yydb_t_title` varchar(50) NOT NULL COMMENT '夺宝模版名称',
  `yydb_t_desc` varchar(255) NOT NULL COMMENT '夺宝模版描述',
  `yydb_t_total` int(25) NOT NULL COMMENT '可发放数量',
  `yydb_t_adminid` int(11) NOT NULL COMMENT '修改管理员ID',
  `yydb_t_state` tinyint(4) NOT NULL COMMENT '模版状态(1-有效,2-失效)',
  `yydb_t_giveout` int(11) NOT NULL COMMENT '模版下的夺宝期数',
  `yydb_t_updatetime` int(11) NOT NULL COMMENT '模版的创建时间',
  `yydb_t_customimg` varchar(200) DEFAULT NULL COMMENT '自定义模板图片',
  `yydb_t_class` int(11) DEFAULT NULL,
  `yydb_t_dbody` text COMMENT '夺宝详细描述',
  `yydb_t_recommend` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否推荐 0不推荐 1推荐',
  `yydb_t_goodsid` int(11) NOT NULL DEFAULT '0' COMMENT '关联商品ID',
  PRIMARY KEY (`yydb_t_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='夺宝模版表';

INSERT INTO `#__adv` VALUES ('15', '9', '闪购特卖！狂喜', 'a:2:{s:7:\"adv_pic\";s:21:\"05034331849840951.jpg\";s:11:\"adv_pic_url\";s:34:\"http://s2.shopwwi.com/shop/tm.html\";}', '1388505600', '1577721600', '0', '0', '', '0', '1', '', '0');
INSERT INTO `#__adv` VALUES ('16', '38', '运维S3版购买', 'a:2:{s:7:\"adv_pic\";s:21:\"05071530547347064.jpg\";s:11:\"adv_pic_url\";s:22:\"http://www.shopwwi.com\";}', '1453737600', '1483632000', '0', '0', '', '0', '1', '', '0');
...
INSERT INTO `#__article` VALUES ('22', '7', '', '1', '1', '255', '关于ShopWWI', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 网店运维是由一批青年为网店经营者提供技术支持及二次开发业务！立足于为人民服务为标准化管理模式！促进客户成交转化！为客户谋取丰厚利益！网店运维交流中心网址http://www.shopwwi.com </p>', '1449242303');
...
INSERT INTO `#__article` VALUES ('25', '7', '', '1', '1', '255', '合作及洽谈', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; shopwwi希望与服务代理商、合作伙伴并肩合作，携手开拓日益广阔的网络购物软件市场。如果您拥有好的建议，拥有丰富渠道资源、拥有众多目标客户、拥有相应的市场资源，并希望与shopwwi进行深度业务合作， 欢迎成为shopwwi业务合作伙伴，请联系。</p>\r\n<p>&nbsp;</p>\r\n<p><strong>公司名称</strong>： 网店运维交流中心 <br />\r\n<strong>通信地址</strong>： http://www.shopwwi.com <br />\r\n<strong>邮政编码</strong>： 300121 <br />\r\n<strong>QQ群</strong>： 111731672 <br />\r\n<strong>商务洽谈</strong>： 111731672 <br />\r\n</p>', '1449242303');
...
INSERT INTO `#__article` VALUES ('35', '1', 'http://www.shopwwi.com/', '1', '1', '1', '网店运维S3.1新版火热销售中', '火爆销售中<br />', '1449242303');
...
INSERT INTO `#__setting` VALUES ('cb_seo_title', '运维跨境频道');
INSERT INTO `#__setting` VALUES ('closed_reason', '今天演示到此结束！需要的朋友直接论坛购买臻贵SVIP即可获得S3版本哦！购买地址：http://www.shopwwi.com/plugin.php?id=qmx8_buy_usergroup:vip 亲可以选择加入QQ群111731672！交流！');
...
INSERT INTO `#__setting` VALUES ('email_addr', 'wansyb@vip.qq.com');
INSERT INTO `#__setting` VALUES ('email_host', 'smtp.qq.com');
INSERT INTO `#__setting` VALUES ('email_id', 'wansyb@vip.qq.com');
...
INSERT INTO `#__setting` VALUES ('live_link1', 'http://www.shopwwi.com');
INSERT INTO `#__setting` VALUES ('live_link2', 'http://www.shopwwi.com');
...
INSERT INTO `#__setting` VALUES ('mobile_apk', 'http://www.shopwwi.com');
INSERT INTO `#__setting` VALUES ('mobile_apk_version', '3.0');
INSERT INTO `#__setting` VALUES ('mobile_app', 'mb_app.png');
INSERT INTO `#__setting` VALUES ('mobile_ios', 'http://www.shopwwi.com');
...
INSERT INTO `#__setting` VALUES ('#__sms_signature', '网店运维');
INSERT INTO `#__setting` VALUES ('#__sms_tgs', '云片网络');
...
INSERT INTO `#__setting` VALUES ('#__top_banner_url', 'http://www.shopwwi.com');
...
INSERT INTO `#__setting` VALUES ('site_bank_account', '银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:ShopWWI,开户行:中国银行天津分行');
INSERT INTO `#__setting` VALUES ('site_email', 'abc@shopwwi.com');
INSERT INTO `#__setting` VALUES ('site_logo', 'logo.png');
INSERT INTO `#__setting` VALUES ('site_name', '网店运维2016全新S5完美版');
...
INSERT INTO `#__setting` VALUES ('tfx_goods_default_class', '0');
INSERT INTO `#__setting` VALUES ('tfx_header_pic', '');
INSERT INTO `#__setting` VALUES ('tfx_isuse', '1');
INSERT INTO `#__setting` VALUES ('tfx_logo', '');
INSERT INTO `#__setting` VALUES ('tfx_personal_limit', '50');
INSERT INTO `#__setting` VALUES ('tfx_seo_description', 'ShopWWI商城系统,微商城,随心看,个人秀,店铺街');
INSERT INTO `#__setting` VALUES ('tfx_seo_keywords', 'ShopWWI商城系统,微商城,随心看,个人秀,店铺街,网上购物');
INSERT INTO `#__setting` VALUES ('tfx_store_banner', '');
INSERT INTO `#__setting` VALUES ('tfx_style', 'default');
INSERT INTO `#__setting` VALUES ('time_zone', 'Asia/Shanghai');
INSERT INTO `#__setting` VALUES ('tyq_contentleast', '10');
INSERT INTO `#__setting` VALUES ('tyq_createsum', '6');
INSERT INTO `#__setting` VALUES ('tyq_exprelease', '2');
INSERT INTO `#__setting` VALUES ('tyq_expreleasemax', '10');
INSERT INTO `#__setting` VALUES ('tyq_expreplied', '3');
INSERT INTO `#__setting` VALUES ('tyq_exprepliedmax', '1000');
INSERT INTO `#__setting` VALUES ('tyq_expreply', '1');
INSERT INTO `#__setting` VALUES ('tyq_intervaltime', '1');
INSERT INTO `#__setting` VALUES ('tyq_iscreate', '1');
INSERT INTO `#__setting` VALUES ('tyq_istalk', '1');
INSERT INTO `#__setting` VALUES ('tyq_isuse', '1');
INSERT INTO `#__setting` VALUES ('tyq_joinsum', '12');
INSERT INTO `#__setting` VALUES ('tyq_loginpic', 'a:4:{i:1;a:2:{s:3:\"pic\";s:5:\"1.jpg\";s:3:\"url\";s:23:\"http://www.shopwwi.com/\";}i:2;a:2:{s:3:\"pic\";s:5:\"2.jpg\";s:3:\"url\";s:23:\"http://www.shopwwi.com/\";}i:3;a:2:{s:3:\"pic\";s:5:\"3.jpg\";s:3:\"url\";s:23:\"http://www.shopwwi.com/\";}i:4;a:2:{s:3:\"pic\";s:5:\"4.jpg\";s:3:\"url\";s:23:\"http://www.shopwwi.com/\";}}');
INSERT INTO `#__setting` VALUES ('tyq_logo', 'logo.png');
INSERT INTO `#__setting` VALUES ('tyq_managesum', '4');
INSERT INTO `#__setting` VALUES ('tyq_name', '淘友圈');
INSERT INTO `#__setting` VALUES ('tyq_seodescription', '发现精彩：圈子是买家们自己创建的私属领地，我们排斥广告分子，我们热爱真实分享！');
INSERT INTO `#__setting` VALUES ('tyq_seokeywords', '圈子,帮派,讨论小组,购物,生活,分享,show,秀,商品,电子商务,社区,消费者社区,论坛,资讯,热门话题,朋友');
INSERT INTO `#__setting` VALUES ('tyq_seotitle', '发现精彩 - ShopWWI淘友圈');
INSERT INTO `#__setting` VALUES ('tyq_wordfilter', '');
INSERT INTO `#__setting` VALUES ('tzx_attitude_flag', '1');
INSERT INTO `#__setting` VALUES ('tzx_comment_flag', '1');
INSERT INTO `#__setting` VALUES ('tzx_isuse', '1');
INSERT INTO `#__setting` VALUES ('tzx_logo', '');
INSERT INTO `#__setting` VALUES ('tzx_seo_description', 'ShopWWI,资讯,画报');
INSERT INTO `#__setting` VALUES ('tzx_seo_keywords', 'ShopWWI,资讯,画报');
INSERT INTO `#__setting` VALUES ('tzx_seo_title', 'ShopWWI淘资讯频道');
INSERT INTO `#__setting` VALUES ('tzx_submit_flag', '1');
INSERT INTO `#__setting` VALUES ('tzx_submit_verify_flag', '0');
...
INSERT INTO `#__setting` VALUES ('ucenter_mysql_name', 'shopwwi');
...
INSERT INTO `#__setting` VALUES ('yydb_allow', '1');


INSERT INTO `#__seo` VALUES ('1', '{sitename} - Powered by shopwwi', 'shopwwi,PHP商城系统,shopwwi商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', 'shopwwi专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'index');
INSERT INTO `#__seo` VALUES ('2', '{sitename} - 团购', 'shopwwi,{sitename}', 'shopwwi专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'group');
INSERT INTO `#__seo` VALUES ('3', '{sitename} - {name}', 'shopwwi,{name},{sitename}', 'shopwwi,{name},{sitename}', 'group_content');
INSERT INTO `#__seo` VALUES ('4', '{sitename} - 品牌', 'shopwwi,{sitename}', 'shopwwi,{sitename}', 'brand');
INSERT INTO `#__seo` VALUES ('5', '{sitename} - {name}', 'shopwwi,{sitename},{name}', 'shopwwi,{sitename},{name}', 'brand_list');
INSERT INTO `#__seo` VALUES ('7', '{sitename} - {name}', 'shopwwi,{sitename},{name}', 'shopwwi,{sitename},{name}', 'coupon_content');
INSERT INTO `#__seo` VALUES ('8', '{sitename} - 积分商城', 'shopwwi,{sitename}', 'shopwwi,{sitename}', 'point');
INSERT INTO `#__seo` VALUES ('9', '{sitename} - {name}', 'shopwwi,{sitename},{key}', 'shopwwi,{sitename},{description}', 'point_content');
INSERT INTO `#__seo` VALUES ('10', '{sitename} - {article_class}', 'shopwwi,{sitename}', 'shopwwi,{sitename}', 'article');
INSERT INTO `#__seo` VALUES ('11', '{sitename} - {name}', 'shopwwi,{sitename},{key}', 'shopwwi,{sitename},{description}', 'article_content');
INSERT INTO `#__seo` VALUES ('12', '{sitename} - {shopname}', 'shopwwi,{sitename},{key}', 'shopwwi,{sitename},{description}', 'shop');
INSERT INTO `#__seo` VALUES ('13', '{name} - {sitename}', 'shopwwi,{sitename}', 'shopwwi,{sitename}', 'product');
INSERT INTO `#__seo` VALUES ('14', '看{name}怎么淘到好的宝贝-{sitename}', 'shopwwi,{sitename},{name}', 'shopwwi,{sitename},{name}', 'sns');
...
(6, 0, '关于ShopWWI', 'member/index.php?app=article&article_id=22', 2, 0, 255, 0),
...
(11, 0, '门户', 'tzx', 1, 1, 255, 0),
(12, 0, '圈子', 'tyq', 1, 1, 255, 0),
(13, 0, '微商城', 'tfx', 1, 1, 255, 0);
...
INSERT INTO `#__help` VALUES ('99', '4', '合作品牌', '<div class=\"brand_img\">\r\n	<img src=\"http://s.shopwwi.com/data/upload/shop/article/help_store_05090420267966612.png\" alt=\"image\" />\r\n</div>', '', '1455698067', '1', '1');
