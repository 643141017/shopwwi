...
CREATE TABLE `#__tzx_article_attitude` (
...
CREATE TABLE `#__tzx_article_class` (
...
CREATE TABLE `#__tzx_index_module` (
...
CREATE TABLE `#__tzx_module_assembly` (
...
CREATE TABLE `#__tzx_module_frame` (
...
CREATE TABLE `#__tzx_picture_class` (
  `class_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(1) unsigned NOT NULL DEFAULT '255' COMMENT '排序',
  PRIMARY KEY (`class_id`)
...
CREATE TABLE `#__tzx_picture_image` (
...
CREATE TABLE `#__tzx_tag_relation` (
...
INSERT INTO `#__tzx_module` (`module_id`, `module_title`, `module_name`, `module_type`, `module_class`) VALUES
...
INSERT INTO `#__tzx_module_assembly` (`assembly_id`, `assembly_title`, `assembly_name`, `assembly_explain`) VALUES
(1, '文章', 'article', '文章组件'),
(2, '图片', 'picture', '图片组件'),
(3, '商品', 'goods', '商品组件'),
(4, '品牌', 'brand', '品牌组件'),
...
INSERT INTO `#__tzx_module_frame` (`frame_id`, `frame_title`, `frame_name`, `frame_explain`, `frame_structure`) VALUES
...
INSERT INTO `#__tzx_navigation` (`navigation_id`, `navigation_title`, `navigation_link`, `navigation_sort`, `navigation_open_type`) VALUES
(1, '商城', '', 255, 1),
(2, '圈子', 'tyq', 255, 1),
(3, '微商城', 'tfx', 255, 1),
