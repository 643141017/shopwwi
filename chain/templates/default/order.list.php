  ...
  <tbody>
    ...
    <td class="bdl"></td>
      ...
      <td rowspan="<?php echo $_cont;?>" class="nscs-table-handle bdl bdr"><?php if ($order_info['order_state'] != ORDER_STATE_SUCCESS) { ?>
        ...
        <span><a href="javascript:void(0);" class="btn-bluejeans" onclick="javascript:ajax_form('pickup_parcel', '付款并自提', 'index.php?app=order&wwi=pickup_parcel&order_id=<?php echo $order_info['order_id'];?>&payment_code=<?php echo $order_info['payment_code']?>',900)"><i class="icon-truck"></i>
        <p>付款自提</p>
        </a></span>
        <?php } else { ?>
        <span><a href="javascript:void(0);" class="btn-bluejeans" onclick="javascript:ajax_form('pickup_parcel', '自提', 'index.php?app=order&wwi=pickup_parcel&order_id=<?php echo $order_info['order_id'];?>',900)"><i class="icon-truck"></i>
        <p>自提</p>
        </a></span>
        <?php } ?>
        <?php } ?></td>
