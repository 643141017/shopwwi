...
class member_articleControl extends TZXMemberControl{
    ...
    public function indexWwi() {
        $this->article_listWwi();
    }

    /**
     * 文章列表
     */
    public function article_listWwi() {
        $condition = array();
    ...
    private function get_article_list($condition = array()) {
        ...
        Tpl::showpage('member_article_list', 'tzx_member_layout');
    }
     ...
     * 移到回收站
     */
    public function article_publishWwi() {
     ...
     * 移到回收站
     */
    public function article_recycleWwi() {
     ...
     * 移到草稿箱
     */
    public function article_draftWwi() {
     ...
     * 删除
     */
    public function article_dropWwi() {
        $article_id = intval($_GET['article_id']);
