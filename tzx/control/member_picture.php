...
class member_pictureControl extends TZXMemberControl{
    ...
    public function indexWwi() {
        $this->picture_listWwi();
    }

    /**
     * 画报列表
     */
    public function picture_listWwi() {
        $condition = array();
     ...
     * 草稿列表
     */
    public function recycle_listWwi() {
        $condition = array();
    ...
    private function get_picture_list($condition = array()) {
        ...
        Tpl::showpage('member_picture_list', 'tzx_member_layout');
    }

    /**
     * 画报编辑
     */
    public function picture_editWwi() {
     ...
     * 发布
     */
    public function picture_publishWwi() {
     ...
     * 移到回收站
     */
    public function picture_recycleWwi() {
     ...
     * 移到草稿箱
     */
    public function picture_draftWwi() {
     ...
     * 删除
     */
    public function picture_dropWwi() {
        $picture_id = intval($_GET['picture_id']);
