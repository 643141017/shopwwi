...
<?php $url_function = 'getTZXPictureUrl';?>
<?php } else { ?>
<?php $url_function = 'getTZXArticleUrl';?>
<?php } ?>

<div class="warp-all article-layout-a">
  <div class="mainbox">
    <div class="sitenav-bar">
      <div class="sitenav"><?php echo $lang['current_location'];?><?php echo $lang['nc_colon'];?> <a href="<?php echo TZX_SITE_URL;?>"><?php echo $lang['tzx_site_name'];?></a> > <a href="<?php echo TZX_SITE_URL.DS.'index.php?app=article&wwi=article_list';?>"><?php echo $lang['tzx_article'];?></a></div>
    </div>
    ...
    <div class="block-style-one">
      ...
      <div class="content">
        ...
        <ul class="article-recommand-list">
          ...
          <li><a href="index.php?app=article&wwi=article_list&class_id=<?php echo $value['class_id'];?>" class="class" target="_blank">[<?php echo $value['class_name'];?>]</a><a href="<?php echo getTZXArticleUrl($value['article_id']);?>"><?php echo $value['article_title'];?></a></li>
