...
$(document).ready(function(){
    ...
    $("[nc_type='bindbtn']").unbind('click').bind('click',function(){
        ...
        if(isbind == '1'){//已经绑定
            ...
            html_form("bindtooltip", "<?php echo $lang['tzx_share_account_link'];?>", html, 360, 0);	    
...
<textarea id="bindtooltip_module" style="display:none;">
        <div class="eject_con">
            <dl>
                <dt style="width:25%">
                <img src="<?php echo TZX_TEMPLATES_URL;?>/images/shareicon/shareicon_@apikey.png" width="40" height="40" class="mt5 mr20">
                </dt>
                <dd style="width:75%">
                <p><?php echo $lang['tzx_share_tip1'];?><strong class="ml5 mr5">@apiname</strong><?php echo $lang['tzx_share_tip2'];?><p>
                <p class="red"><?php echo $lang['tzx_share_tip3'];?>@apiname<?php echo $lang['tzx_share_tip4'];?></p>
                </dd>
            </dl>
            <dl class="bottom">
                <dt style="width:25%">&nbsp;</dt>
                <dd style="width:75%">
                <a href="javascript:void(0);" id="finishbtn" data-param='{"apikey":"@apikey"}' class="ncu-btn2 mr10"><?php echo $lang['tzx_share_tip5'];?></a>
                <span><?php echo $lang['tzx_share_tip6'];?>
                    <a target="_blank" href="<?php echo MEMBER_SITE_URL;?>/api.php?app=sharebind&type=@apikey" class="ml5"><?php echo $lang['tzx_share_tip7'];?></a>
                </span>
                </dd>
            </dl>
        </div>
