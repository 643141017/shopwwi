...
<div class="tzx-content mt10">
  <form id="add_form" method="post" action="index.php?app=publish&wwi=publish_article_save">
    ...
    <div class="tzx-publish-content" id="main-nav-holder">
      <div class="tzx-publish-sidebar" id="main-nav">
        <div class="upload-btn"><a href="javascript:void(0);"><span>
          ...
          <div class="upload-button"><i></i><?php echo $lang['tzx_image_upload'];?></div>
        ...
        <div class="upload-images-box">
          ...
          <!-- <div id="btn_image_list_up" class="up-btn" title="<?php echo $lang['tzx_text_up'];?>"><i></i><?php echo $lang['tzx_text_up'];?></div>-->
          <div class="upload-img-list" id="art-upload-scrollbar">
            <ul id="article_image_list" class="article-image-list" style="position:relative;">
              ...
              <li><div class="picture"><a href="Javascript: void(0);"><img alt="" src="<?php echo getTZXArticleImageUrl($output['article_detail']['article_attachment_path'], serialize($value), 'max');?>"></a></div>
                <div class="handle"><a nctype="btn_insert_article_image"><?php echo $lang['tzx_text_insert'];?></a><a image_name="<?php echo $key;?>" nctype="btn_set_article_image"><?php echo $lang['tzx_cover'];?></a> <a image_name="<?php echo $key;?>" nctype="btn_drop_article_image"><?php echo $lang['tzx_delete'];?></a></div>
          ...
          <!-- <div id="btn_image_list_down" class="down-btn" title="<?php echo $lang['tzx_text_down'];?>"/> 
          <i></i><?php echo $lang['tzx_text_down'];?></div>-->
      </div>
    </div>
    <table class="tzx-publish-table">
      <tbody>
        <tr>
          <th><?php echo $lang['tzx_article_class'];?></th>
          ...
          <td rowspan="3" align="center" valign="middle" class="w200">
              ...
              <img alt="" src="<?php echo getTZXArticleImageUrl($output['article_detail']['article_attachment_path'],$output['article_detail']['article_image'], 'list');?>">
              <?php } ?>
              </div>
              <p class="edit-cover-text"><?php echo $lang['tzx_cover'];?></p>
            <input id="article_image" name="article_image" type="hidden" value="<?php if(!empty($output['article_detail'])) echo getTZXImageName($output['article_detail']['article_image']);?>" /></td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_title'];?><?php echo $lang['nc_colon'];?></th>
          <td><input id="article_title" class="text w300" name="article_title" type="text" value="<?php if(!empty($output['article_detail'])) echo $output['article_detail']['article_title'];?>" />
            <div class="hint"><?php echo $lang['tzx_title_explain'];?></div></td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_title_short'];?><?php echo $lang['nc_colon'];?></th>
          <td><input id="article_title_short" class="text w300" name="article_title_short" type="text" value="<?php if(!empty($output['article_detail'])) echo $output['article_detail']['article_title_short'];?>" />
            <div class="hint"><?php echo $lang['tzx_title_short_explain'];?></div></td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_article_abstract'];?><?php echo $lang['nc_colon'];?></th>
          <td colspan="2"><div class="abstract">
              ...
              <div class="hint"><?php echo $lang['tzx_article_abstract_explain'];?></div>
            </div></td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_article_content'];?><?php echo $lang['nc_colon'];?></th>
        ...
        <tr>
          <th><?php echo $lang['tzx_text_publisher'];?><?php echo $lang['nc_colon'];?></th>
          <td colspan="2"><input id="article_author" class="text w100" name="article_author" type="text" value="<?php echo empty($output['article_detail']['article_author'])?$output['publisher_info']['name']:$output['article_detail']['article_author'];?>"/>
            <div class="hint"><?php echo $lang['tzx_publisher_explain'];?></div></td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_publish_time'];?><?php echo $lang['nc_colon'];?></th>
          <td colspan="2"><input id="article_publish_time" class="text w100" name="article_publish_time" type="text" value="<?php echo empty($output['article_detail']['article_publish_time'])?date('Y-m-d',time()):date('Y-m-d',$output['article_detail']['article_publish_time']);?>"/>
            <div class="hint"><?php echo $lang['tzx_publish_time_explain'];?></div></td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_article_orgin'];?><?php echo $lang['nc_colon'];?></th>
          <td colspan="3"><input id="article_origin" class="text w100" name="article_origin" type="text" value="<?php if(!empty($output['article_detail'])) echo $output['article_detail']['article_origin'];?>"/>
            <span><?php echo $lang['tzx_article_orgin_address'];?><?php echo $lang['nc_colon'];?></span>
            ...
            <div class="hint"><?php echo $lang['tzx_article_orgin_explain'];?></div></td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_article_goods'];?><?php echo $lang['nc_colon'];?></th>
          <td colspan="2">
            <ul id="article_goods_list" class="article-goods-list">
              ...
              <li nctype="btn_goods_select">
                <dl>
                  ...
                  <dd class="price"><?php echo $lang['tzx_price'];?><?php echo $lang['nc_colon'];?><em><?php echo $value['price'];?></em></dd>
                </dl>
                <i><?php echo $lang['tzx_article_goods_delete_explain'];?></i>
            ...
            <p>
              ...
              <label for="goods_search_type_url"><?php echo $lang['tzx_goods_link'];?></label>
              <input id="goods_search_type_title" value="goods_name" name="goods_search_type" type="radio" />
              <label for="goods_search_type_title"><?php echo $lang['tzx_goods_name'];?></label>
            </p>
            <input id="goods_search_keyword" class="text w380" name="goods_search_keyword" type="text" />
            <input id="btn_goods_search" class="btn-type-s" type="button" value="<?php echo $lang['tzx_text_add'];?>" />
            <div id="div_goods_select"> </div>
            <div class="hint"><?php echo $lang['tzx_goods_explain'];?></div></td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_tag'];?><?php echo $lang['nc_colon'];?></th>
          <td colspan="3"><?php if(!empty($output['tag_list']) && is_array($output['tag_list'])) {?>
            <ul>
              ...
              <li nctype="tzx_tag" class="<?php echo in_array($value['tag_id'],$tag_selected)?'btn-tzx-tag-selected':'btn-tzx-tag';?>" tag_id="<?php echo $value['tag_id'];?>"><?php echo $value['tag_name'];?></li>
              <?php } ?>
            </ul>
            <?php } ?>
        ...
        <tr>
          <th><?php echo $lang['tzx_keyword'];?><?php echo $lang['nc_colon'];?></th>
          ...
          <div class="hint"><?php echo $lang['tzx_keyword_expalin'];?></div>
          </td>
        </tr>
        <tr>
          <th><?php echo $lang['tzx_other_article'];?><?php echo $lang['nc_colon'];?></th>
          <td colspan="2"><input id="article_link" name="article_link" type="hidden" value="<?php if(!empty($output['article_detail'])) echo $output['article_detail']['article_link'];?>"/>
            <ul id="article_link_list" class="article-link-list">
              ...
              <li article_id="<?php echo $value['article_id'];?>" nctype="btn_article_select"><a target="_blank" href="<?php echo getTZXArticleUrl($value['article_id']);?>"> <?php echo $value['article_title'];?> </a> <i><?php echo $lang['tzx_article_article_delete_explain'];?></i> </li>
              <?php } ?>
              <?php } ?>
            </ul>
            ...
            <p>
              ...
              <label for="article_search_type_id"><?php echo $lang['tzx_article_id'];?></label>
              <input id="article_search_type_title" name="article_search_type" value="article_keyword" type="radio" />
              <label for="article_search_type_title"><?php echo $lang['tzx_article_title'];?></label>
            </p>
            <input id="article_search_keyword" class="text w380" name="article_search_keyword" type="text" />
            <input id="btn_article_search"  class="btn-type-s" type="button" value="<?php echo $lang['tzx_text_search'];?>" />
            <div id="div_article_select"> </div>
            <div class="hint"><?php echo $lang['tzx_article_expalin'];?></div></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
          <td colspan="20"><a id="btn_draft" class="btn-draft" href="javascript:void(0);"><?php echo $lang['tzx_article_save_draft'];?></a> <a id="btn_publish" class="btn-publish" href="javascript:void(0);"><?php echo $lang['tzx_text_publish'];?></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
...
<script type="text/javascript" src="<?php echo TZX_RESOURCE_SITE_URL;?>/js/tzx_article_publish.js"></script>
