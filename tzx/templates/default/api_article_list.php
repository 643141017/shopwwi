...
<div class="article-select-box">
  ...
  <ul id="article_search_list" class="article-search-list">
    ...
    <li nctype="btn_article_select" article_id="<?php echo $value['article_id'];?>"><a href="<?php echo getTZXArticleUrl($value['article_id']);?>" target="_blank"> <?php echo $value['article_title'];?> </a> <i><?php echo $lang['api_article_add'];?></i> </li>
    <?php } ?>
  </ul>
