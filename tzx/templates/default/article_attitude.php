...
$(document).ready(function(){
    $("[nctype='article_attitude']").click(function() {
        ...
        $.getJSON("<?php echo TZX_SITE_URL.DS;?>index.php?app=attitude&wwi=article_attitude", { article_id: article_id, article_attitude: article_attitude }, function(json){
            if(json.result == "true") {
...
<ul id="tzx_attitude_flag">
  ...
  <li nctype="article_attitude" attitude="<?php echo $i;?>" title="<?php echo $output['article_attitude_list'][$i];?>">
      ...
      <img src="<?php echo TZX_TEMPLATES_URL;?>/images/attitude/<?php echo $i;?>.png" alt="" /> <span><?php echo $output['article_attitude_list'][$i];?></span>
  </li>
  <?php } ?>
</ul>
<div class="clear"></div>
