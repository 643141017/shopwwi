...
<dl class="member-info">
  <dt class="avatar">
    ...
    <img src="<?php echo TZX_TEMPLATES_URL;?>/images/admin.gif" />
    <?php } else { ?>
  ...
  <dd class="type">（<?php echo $output['publisher_info']['type'] === 2?$lang['tzx_article_type_admin']:$lang['tzx_article_type_member'];?>）</dd>
</dl>
