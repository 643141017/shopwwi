...
class web_chatControl extends BaseControl {
    ...
    public function get_user_listWwi(){
    ...
    public function get_seller_listWwi(){
    ...
    public function get_chat_logWwi(){
    ...
    public function get_goods_infoWwi(){
    ...
    public function get_sessionWwi(){
