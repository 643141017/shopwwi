...
class d_centerControl extends BaseDeliveryCenterControl{
     ...
     * 详细资料
     */
    public function informationWwi() {
     ...
     * 修改密码
     */
    public function change_passwordWwi() {
        if (chksubmit()) {
     ...
     * 从第三方取快递信息
     */
    public function ajax_get_expressWwi(){
     ...
     * 取件通知
     */
    public function arrive_pointWwi() {
     ...
     * 提货验证
     */
    public function pickup_parcelWwi() {
        if (chksubmit()) {
