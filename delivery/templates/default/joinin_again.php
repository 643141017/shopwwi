...
<div class="ncd-joinin">
  ...
  <form id="delivery_joinin" method="post" enctype="multipart/form-data" action="<?php echo DELIVERY_SITE_URL?>/index.php?app=joinin_again&wwi=edit_delivery">
    ...
    $('#delivery_joinin').validate({
        ...
        rules : {
            dname : {
                ...
                rangelength : [3,15],
                lettersonly : true,
                remote   : 'index.php?app=joinin_again&wwi=check&did=<?php echo $output['dpoint_info']['dlyp_id'];?>'
            },
            dpasswd : {
                required : true,
                rangelength : [3,15]
