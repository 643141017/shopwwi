...
<header class="ncd-header">
  <div class="wrapper">
    ...
    <div class="ncd-user">
      ...
      <ul>
        <li><a href="javascript:void(0);" onclick="javascript:ajax_form('information', '详细资料', 'index.php?app=d_center&wwi=information');">详细资料</a></li>
        <li><a href="javascript:void(0);" onclick="javascript:ajax_form('change_password', '修改密码', 'index.php?app=d_center&wwi=change_password')">修改密码</a></li>
        <li><a href="javascript:void(0);" onclick="javascript:ajaxget('<?php echo DELIVERY_SITE_URL;?>/index.php?app=login&wwi=logout');">安全退出</a></li>
      </ul>
    </div>
  </div>
</header>
