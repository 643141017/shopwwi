...
<div class="ncd-joinin">
  <h1>物流自提服务站加盟</h1>
  <form id="delivery_joinin" method="post" enctype="multipart/form-data" action="<?php echo DELIVERY_SITE_URL?>/index.php?app=joinin&wwi=save_delivery">
    ...
    $('#delivery_joinin').validate({
        ...
        rules : {
            dname : {
                ...
                rangelength : [3,15],
                lettersonly : true,
                remote   : 'index.php?app=joinin&wwi=check'
            },
            dpasswd : {
                required : true,
                rangelength : [6,20]
