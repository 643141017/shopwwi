...
<div class="wrap">
  ...
  <div class="ncm-default-form">
    <form method="post" id="mobile_form" action="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_security&wwi=modify_mobile">
...
$(function(){
	...
	$('#send_auth_code').on('click',function(){
		...
		ALLOW_SEND = !ALLOW_SEND;
		$('#sending').show();
		$.getJSON('index.php?app=member_security&wwi=send_modify_mobile',{mobile:$('#mobile').val()},function(data){
			if (data.state == 'true') {
				$('#sending').hide();
