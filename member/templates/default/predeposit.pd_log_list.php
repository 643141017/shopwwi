...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncbtn ncbtn-bittersweet" title="在线充值" href="index.php?app=predeposit&wwi=recharge_add" style="right: 207px;"><i class="icon-shield"></i>在线充值</a> <a class="ncbtn ncbtn-mint" href="index.php?app=member_security&wwi=auth&type=pd_cash" style="right: 107px;"><i class="icon-money"></i>申请提现</a> <a class="ncbtn ncbtn-bluejeansjeans" href="index.php?app=predeposit&wwi=rechargecard_add"><i class="icon-shield"></i>充值卡充值</a> </div>
