        ...
        <div id="default" class="tabs-content">
          <form class="nc-login-form" action="<?php echo urlLogin('login', 'find_password');?>" method="POST" id="find_password_form">
            ...
            <div class="code-div mt15">
              ...
              <span><img src="index.php?app=seccode&wwi=makecode&type=50,120&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" id="codeimage"> <a class="makecode" href="javascript:void(0);" class="ml5" onclick="javascript:document.getElementById('codeimage').src='index.php?app=seccode&wwi=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span></div>
...
$(function(){
    ...
    $('#find_password_form').validate({
        ...
        messages : {
            ...
            captcha : {
                required : '<i class="icon-remove-tyq" title="<?php echo $lang['login_usersave_code_isnull'];?>"></i>',
                minlength : '<i class="icon-remove-tyq" title="<?php echo $lang['login_usersave_wrong_code'];?>"></i>',
                remote   : '<i class="icon-remove-tyq" title="<?php echo $lang['login_usersave_wrong_code'];?>"></i>'
            }
        }
    });
});
...
$(function(){
	$("#post_form").validate({
		...
		messages: {
			...
			captcha : {
                required : '<i class="icon-remove-tyq" title="请输入正确的验证码"></i>',
                minlength: '<i class="icon-remove-tyq" title="请输入正确的验证码"></i>',
				remote	 : '<i class="icon-remove-tyq" title="请输入正确的验证码"></i>'
            },
			sms_captcha: {
