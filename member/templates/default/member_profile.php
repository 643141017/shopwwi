...
<div class="wrap">
  <div class="tabmenu">
    ...
    <div class="ncm-default-form">
      <form method="post" id="profile_form" action="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_information&wwi=member">
        ...
        <dl>
          ...
          <dd><span class="w400"><?php echo $output['member_info']['member_email']; ?>&nbsp;&nbsp;
            <a href="index.php?app=member_security&wwi=auth&type=modify_email">
