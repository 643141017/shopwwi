    ...
    <div class="nc-register-layout">
            ...
            <div id="default" class="tabs-content">
			  ...
			  <input type="hidden" id="rec_id" name="rec_id" class="text" value="<?php echo $_GET['rec'];?>"/>
                ...
                <div class="code-div mt15">
                  ...
                  <span><img src="index.php?app=seccode&wwi=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"/> <a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?app=seccode&wwi=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span></div>
                <?php } ?>
                <dl class="clause-div">
                  <dd>
            ...
            <div id="mobile" class="tabs-content">
              <form id="post_form" method="post" class="nc-login-form">
                ...
                <div class="code-div">
                  ...
                  <span><img src="index.php?app=seccode&wwi=makecode&type=50,120&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" id="sms_codeimage"><a class="makecode" href="javascript:void(0);" onclick="javascript:document.getElementById('sms_codeimage').src='index.php?app=seccode&wwi=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span> </div>
      ...
      <div class="right">
        ...
        <div class="api-login">
          ...
          <a href="<?php echo MEMBER_SITE_URL;?>/api.php?app=tosina" title="<?php echo $lang['nc_otherlogintip_sina']; ?>" class="sina"><i></i></a>
          <?php } ?>
    ...
    $("#register_form").validate({
        ...
        rules : {
            user_name : {
                ...
                letters_name : true,
                remote   : {
                    url :'index.php?app=login&wwi=check_member&column=ok',
                    type:'get',
                    data:{
                        user_name : function(){
            ...
            email : {
                ...
                email    : true,
                remote   : {
                    url : 'index.php?app=login&wwi=check_email',
                    type: 'get',
                    data:{
                        email : function(){
                            return $('#email').val();
                ...
                remote   : {
                    ...
                    complete: function(data) {
                        if(data.responseText == 'false') {
                        	document.getElementById('codeimage').src='index.php?app=seccode&wwi=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();
                        }
                    }
                }
            },
        ...
        messages : {
			...
			<?php if(C('captcha_status_register') == '1') { ?>
            captcha : {
                required : '<i class="icon-remove-tyq" title="<?php echo $lang['login_register_input_text_in_image'];?>"></i>',
				remote	 : '<i class="icon-remove-tyq" title="<?php echo $lang['login_register_code_wrong'];?>"></i>'
            },
			<?php } ?>
            agree : {
...
$(function(){
	...
	$("#post_form").validate({
		...
		rules: {
			...
			captcha : {
                ...
                remote   : {
                    ...
                    complete: function(data) {
                        if(data.responseText == 'false') {
                        	document.getElementById('sms_codeimage').src='index.php?app=seccode&wwi=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();
                        }
                    }
                }
            },
		...
		messages: {
			...
			captcha : {
                required : '<i class="icon-remove-tyq" title="<?php echo $lang['login_register_input_text_in_image'];?>"></i>',
                minlength: '<i class="icon-remove-tyq" title="<?php echo $lang['login_register_input_text_in_image'];?>"></i>',
				remote	 : '<i class="icon-remove-tyq" title="<?php echo $lang['login_register_code_wrong'];?>"></i>'
            },
			sms_captcha: {
