...
class member_informationControl extends BaseMemberControl {
    ...
    public function memberWwi() {
        ...
        Tpl::output('menu_sign_url','index.php?app=member_information&wwi=member');
...
public function uploadWwi() {
		if (!chksubmit()){
			redirect('index.php?app=member_information&wwi=avatar');
		}
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'member':
                $menu_array = array(
                1=>array('menu_key'=>'member',  'menu_name'=>Language::get('home_member_base_infomation'),'menu_url'=>'index.php?app=member_information&wwi=member'),
                2=>array('menu_key'=>'more',    'menu_name'=>Language::get('home_member_more'),'menu_url'=>'index.php?app=member_information&wwi=more'),
                5=>array('menu_key'=>'avatar',  'menu_name'=>Language::get('home_member_modify_avatar'),'menu_url'=>'index.php?app=member_information&wwi=avatar'));
                break;
        }
