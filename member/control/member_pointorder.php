...
class member_pointorderControl extends BaseMemberControl{
     ...
     *  取消兑换
     */
    public function cancel_orderWwi(){
        $model_pointorder = Model('pointorder');
        //取消订单
     ...
     * 确认收货
     */
    public function receiving_orderWwi(){
     ...
     *
     */
    public function get_expressWwi(){
        ...
        switch ($menu_type) {
            case 'pointorder':
                $menu_array = array(
                    ...
                    2=>array('menu_key'=>'orderlist','menu_name'=>Language::get('member_pointorder_list_title'),    'menu_url'=>'index.php?app=member_pointorder&wwi=orderlist')
                );
                break;
            case 'pointorderinfo':
                $menu_array = array(
                    1=>array('menu_key'=>'points',  'menu_name'=>'积分明细',    'menu_url'=>'index.php?app=member_points'),
                    2=>array('menu_key'=>'orderlist','menu_name'=>Language::get('nc_member_path_pointorder_list'),  'menu_url'=>'index.php?app=member_pointorder&wwi=orderlist'),
