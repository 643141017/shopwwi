...
class member_sharemanageControl extends BaseMemberControl {
    public function __construct(){
        ...
        //判断系统是否开启站外分享功能
        if (C('share_isuse') != 1){
            showMessage(Language::get('sharebind_unused'),'index.php?app=member_information&wwi=member','html','error');
        }
    }
    /**
     * 分享绑定列表
     ...
     * 分享绑定qqzone
     */
    public function share_qqzoneWwi(){
        //判断系统是否开启站外分享功能
     ...
     * 分享绑定sinaweibo
     */
    public function share_sinaweiboWwi(){
        //判断系统是否开启站外分享功能
     ...
     * 分享绑定腾讯微博
     */
    public function share_qqweiboWwi(){
        //判断系统是否开启站外分享功能
