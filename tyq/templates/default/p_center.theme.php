      ...
      <ul class="group-theme-list">
        ...
        <li>
          <dl class="theme-info" data-param="{t_id:<?php echo $val['theme_id'];?>,c_id:<?php echo $val['tyq_id'];?>}">
            <dt><span class="theme-title"><a href="index.php?app=theme&wwi=theme_detail&c_id=<?php echo $val['tyq_id'];?>&t_id=<?php echo $val['theme_id'];?>" target="_blank" class="title"><?php echo $val['theme_name'];?></a></span></dt>
            <dd class="theme-content">
              ...
              <div class="theme-info">
                ...
                <?php echo $lang['p_center_published_since'];?><span class="group-name">&#8220;<a href="<?php echo TYQ_SITE_URL;?>/index.php?app=group&c_id=<?php echo $val['tyq_id'];?>"><?php echo $val['tyq_name'];?></a>&#8221;<?php echo $lang['p_center_is_theme'];?></span>
                <?php if($val['lastspeak_name']){?>
                <span class="ml20"><?php echo $lang['tyq_reply'];?>(<em><?php echo $val['theme_commentcount'];?></em>)</span>
                <?php }else{?>
                </span> <span class="ml20"><?php echo $lang['tyq_no_comment'];?></span>
                <?php }?>
                <span class="ml10"><?php echo $lang['tyq_like'];?>(<em><?php echo $val['theme_likecount'];?></em>)</span></div>
            </dd>
          </dl>
        </li>
        <?php }?>
