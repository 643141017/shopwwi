...
<div class="eject_con">
  <div id="warning"></div>
  <form id="addclass_form" action="<?php echo TYQ_SITE_URL;?>/index.php?app=manage&wwi=class_edit&c_id=<?php echo $output['c_id'];?>" method="post" class="base-form-style">
    <input type="hidden" value="ok" name="form_submit">
    <input type="hidden" name="thc_id" value="<?php echo $output['thclass_info']['thclass_id'];?>" />
    <dl>
      <dt><?php echo $lang['tyq_tclass_name'].$lang['nc_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><?php echo $lang['tyq_tclass_status'].$lang['nc_colon'];?></dt>
      <dd>
...
$(function(){
    ...
    $('#addclass_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('addclass_form', '<?php echo TYQ_SITE_URL;?>/index.php?app=manage&wwi=class_edit&c_id=<?php echo $output['c_id'];?>', '', 'onerror');
    	},
        rules : {
        	name : {
                required : true,
        ...
        messages : {
        	name : {
            	...
            	maxlength : '<?php echo $lang['tyq_tclass_man_maxlength'];?>'

            },
            sort  : {
                required : '<?php echo $lang['tyq_tclass_sort_not_null'];?>',
