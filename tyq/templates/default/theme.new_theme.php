...
<div class="community-wrap">
    ...
    <form method="post" id="theme_form" action="<?php echo TYQ_SITE_URL;?>/index.php?app=theme&wwi=save_theme&c_id=<?php echo $output['c_id'];?>">
    	<p class="wrap edtTit">发布新话题</p>
      <input type="hidden" name="form_submit" value="ok" />
      <div class="quick-thread">
        <div class="base-tab-menu">
          <ul class="base-tabs-nav">
            <li class="selected"><a href="javascript:void(0);"><?php echo $lang['tyq_new_theme'];?></a></li>
            <li><a href="index.php?app=theme&wwi=new_theme&sp=1&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['tyq_new_poll'];?></a></li>
          </ul>
        </div>
