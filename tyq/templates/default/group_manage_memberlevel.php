...
<div class="base-layout">
  <div class="mainbox">
    ...
    <form id="tyq_level" name="tyq_level" method="post" action="<?php echo TYQ_SITE_URL;?>/index.php?app=manage_level&wwi=level&c_id=<?php echo $output['c_id']; ?>">
    ...
    <table class="base-table-style">
        ...
        <tr>
          <th colspan="15" class="tl"> <ul class="level-set">
              <li>
                ...
                <label for="levelset0"><?php echo $lang['tyq_default_series'];?></label>
              </li>
              ...
              <li>
                ...
                <label for="user-defined"><?php echo $lang['tyq_custom'];?></label>
              </li>
            </ul>
          </th>
        </tr>
      ...
      <tbody>
        <tr>
          <td class="w100"><?php echo $lang['tyq_level'];?></td>
          <td class="w100"><?php echo $lang['tyq_exp'];?></td>
          <td><?php echo $lang['tyq_rank'];?></td>
          <td class="w100"><?php echo $lang['tyq_level'];?></td>
          <td class="w100"><?php echo $lang['tyq_exp'];?></td>
          <td><?php echo $lang['tyq_rank'];?></td>
        </tr>
      ...
      <tfoot>
        <tr>
          <td colspan="10" class="bottom tc"><a href="JavaScript:void(0);" class="submit-btn" nctype="submitBtn" style="display: inline-block; float: none; margin: 10px auto 20px auto;"><?php echo $lang['tyq_submit_setting'];?></a></td>
        </tr>
      </tfoot>
    </table>
    </form>
