    ...
    <table class="base-table-style">
      <thead>
        <tr>
          ...
          <th class="w70"><?php echo $lang['tyq_level'];?></th>
          <th class="w70"><?php echo $lang['tyq_apply_time'];?></th>
          <th class="w380"><?php echo $lang['tyq_apply_reason'];?></th>
        ...
        <tr>
          ...
          <td colspan="5" class="batches"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo TYQ_SITE_URL;?>/index.php?app=manage_mapply&wwi=mapply_pass&c_id=<?php echo $output['c_id'];?>" name="cm_id" confirm="<?php echo $lang['tyq_manage_confirm_one'].C('tyq_managesum').$lang['tyq_manage_confirm_two'];?>" title="<?php echo $lang['tyq_manage_title'];?>"><i class="ac1"></i><?php echo $lang['tyq_pass'];?></a>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo TYQ_SITE_URL;?>/index.php?app=manage_mapply&wwi=del&c_id=<?php echo $output['c_id'];?>" name="cm_id" confirm="<?php echo $lang['nc_ensure_del'];?>" title="<?php echo $lang['tyq_manage_title'];?>"><i class="ac5"></i><?php echo $lang['nc_delete'];?></a>
          <?php }?>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td class="handle">
            <a href="javascript:void(0);" onclick="mapplyPass(<?php echo $val['member_id'];?>);"><?php echo $lang['tyq_pass'];?></a>
...
function mapplyPass(id){
	showDialog('<?php echo $lang['tyq_manage_confirm_one'].C('tyq_managesum').$lang['tyq_manage_confirm_two'];?>', 'confirm', '', function(){
		_uri = "<?php echo TYQ_SITE_URL;?>/index.php?app=manage_mapply&wwi=mapply_pass&c_id=<?php echo $output['c_id'];?>&cm_id="+id;
		ajaxget(_uri);
	});
}
...
function mapplyDel(id){
	showDialog('<?php echo $lang['nc_ensure_del'];?>', 'confirm', '', function(){
		_uri = "<?php echo TYQ_SITE_URL;?>/index.php?app=manage_mapply&wwi=del&c_id=<?php echo $output['c_id'];?>&cm_id="+id;
		ajaxget(_uri);
	});
}
</script>