...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="theme_form" action="<?php echo TYQ_SITE_URL;?>/index.php?app=theme&wwi=save_theme&sp=1&c_id=<?php echo $output['c_id'];?>">
      <input type="hidden" name="form_submit" value="ok" />
      <div class="quick-thread">
        <div class="base-tab-menu">
          <ul class="base-tabs-nav">
            <li><a href="index.php?app=theme&wwi=new_theme&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['tyq_new_theme'];?></a></li>
            <li class="selected"><a href="javascript:void(0);"><?php echo $lang['tyq_new_poll'];?></a></li>
          </ul>
        </div>
        <div class="quick-thread-box">
          <div class="title">
            <label class="mr10"><span class="t"><?php echo $lang['tyq_type'].$lang['nc_colon'];?></span><span class="i">
          ...
          <div class="poll-options">
            <div class="top"> <span>
              <h4><?php echo $lang['tyq_poll_options'].$lang['nc_colon'];?></h4>
              <?php echo $lang['tyq_poll_options_max'];?> </span><span class="input-text">
              <h4><?php echo $lang['tyq_poll_days'].$lang['nc_colon'];?></h4>
              <label>
                <input type="text" name="days" class="input-text" />
                <?php echo $lang['nc_day'];?></label>
              </span> <span id="poll_div_2" class="input-radio">
              <h4><?php echo $lang['tyq_poll_patterns'].$lang['nc_colon'];?></h4>
              <label>
              <input type="radio" name="multiple" value="0" checked="checked" />
              <h5><?php echo $lang['tyq_poll_radio'];?></h5>
              </label>
              <label>
              <input type="radio" name="multiple" value="1" />
              <h5><?php echo $lang['tyq_poll_chexkbox'];?></h5>
              </label>
              </span></div>
            <div id="poll_div_1" class="add-poll"><a href="javascript:void(0);" nctype="addpolloption" class="btn"><i></i><?php echo $lang['tyq_add_new'];?></a></div>
          </div>
...
$(function(){
    ...
    $('#theme_form').validate({
    	...
    	submitHandler:function(form){
    		...
    		ajaxpost('theme_form', TYQ_SITE_URL+'/index.php?app=theme&wwi=save_theme&c_id='+c_id, '', 'onerror');
    	},
    	focusInvalid : false,
        rules : {
        	name : {
        ...
        messages : {
            ...
            'polloption[]' : {
            	nullOption : '<?php echo $lang['tyq_poll_options_not_null'];?>',
                minOption : '<?php echo $lang['tyq_poll_options_min_error'];?>',
                maxlengthOption : '<?php echo $lang['tyq_poll_options_max_error'];?>'
            }
        }
    });
