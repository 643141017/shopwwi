...
<div class="eject_con inform-reason">
  ...
  <form id="inform_form" action="<?php echo TYQ_SITE_URL;?>/index.php?app=theme_inform&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id']; if(isset($_GET['r_id'])){echo '&r_id='.$_GET['r_id'];}?>" method="post" onsubmit="ajaxpost('inform_form', '<?php echo TYQ_SITE_URL;?>/index.php?app=theme_inform&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id']; if(isset($_GET['r_id'])){echo '&r_id='.$_GET['r_id'];}?>', '', 'onerror');">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt><?php echo $lang['tyq_inform_reason'];?></dt>
      <dd>
        <h5>
          <p><?php echo $lang['tyq_inform_choosable_reason'].$lang['nc_colon'];?></p>
          <ul nctype="selectable">
            <li style="display:blank;"><?php echo $lang['tyq_inform_reason_1'];?></li>
            <li style="display:blank;"><?php echo $lang['tyq_inform_reason_2'];?></li>
            <li style="display:blank;"><?php echo $lang['tyq_inform_reason_3'];?></li>
            <li style="display:blank;"><?php echo $lang['tyq_inform_reason_4'];?></li>
            <li style="display:blank;"><?php echo $lang['tyq_inform_reason_5'];?></li>
          </ul>
        </h5>
