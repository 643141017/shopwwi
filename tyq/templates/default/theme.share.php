...
<div class="tyq-share">
  <form method="post" action="<?php echo TYQ_SITE_URL;?>/index.php?app=theme_share&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>" id="share_form" class="feededitor">
    ...
    <dl class="share-target">
      ...
      <dd class="sub"><span id="_share_publisher">作者：<?php echo $output['theme_info']['member_name'];?></span><span id="_share_origin">来自：<?php echo $output['theme_info']['tyq_name'];?></span></dd>
...
$(function(){
	...
	$("[nc_type='finishbtn']").live('click',function(){
	    ...
	    eval( "data_str = "+data_str);
		// check binding
		var url = 'index.php?app=share&wwi=checkbind';
