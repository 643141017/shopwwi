...
<div class="base-layout">
  <div class="mainbox">
    ...
    <div class="my-theme-list">
      ...
      <ul class="group-theme-list">
        ...
        <li>
          <dl class="theme-info">
            ...
            <dt><span class="theme-title"><?php echo $lang['p_center_you_are_in'];?> <a href="<?php echo TYQ_SITE_URL;?>/index.php?app=group&c_id=<?php echo $val['tyq_id'];?>"><?php echo $val['tyq_name'];?></a> <?php echo $lang['p_center_published_theme'].$lang['nc_colon'];?><a href="javascript:void(0);"><?php echo $lang['nc_quote1'].$val['theme_name'].$lang['nc_quote2'];?></a></span></dt>
            ...
            <dt><span class="theme-title"><?php echo $lang['p_center_you_are_in'];?> <a href="<?php echo TYQ_SITE_URL;?>/index.php?app=group&c_id=<?php echo $val['tyq_id'];?>"><?php echo $val['tyq_name'];?></a> <?php echo $lang['p_center_published_reply'].$lang['nc_colon'];?><a href="javascript:void(0);"><?php echo $lang['nc_quote1'].replaceUBBTag($val['recycle_content'], 0).$lang['nc_quote2'];?></a></span></dt>
            <dd class="theme-content">
              <div class="theme-summary"><?php echo replaceUBBTag($val['recycle_content'], 0);?></div>
              <div class="theme-info">
                <time><?php echo date('Y-m-d H:i:s', $val['recycle_time']);?></time>
      ...
      <div class="pagination bottom"><a href="javascript:void(0);" class="submit-btn" style=" float: right;" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){ajaxget('<?php echo TYQ_SITE_URL?>/index.php?app=p_center&wwi=clr_recycled')}"><?php echo $lang['p_center_clear_recycle'];?></a><?php echo $output['show_page'];?></div>
      <?php }else{?>
