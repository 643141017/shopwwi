...
<div class="eject_con">
<form method="post" id="delmember" name="delmember" action="<?php echo TYQ_SITE_URL;?>/index.php?app=manage&wwi=delmember&c_id=<?php echo $_GET['c_id'];?>&cm_id=<?php echo $_GET['cm_id'];?>">
