...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="theme_form" action="<?php echo TYQ_SITE_URL;?>/index.php?app=theme&wwi=edit_theme&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id']; ?>">
...
$(function(){
    ...
    $('#theme_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('theme_form', TYQ_SITE_URL+'/index.php?app=theme&wwi=edit_theme&c_id='+c_id+'&t_id='+t_id, '', 'onerror');
    	},
        rules : {
        	name : {
                required : true,
