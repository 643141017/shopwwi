...
<link href="<?php echo TYQ_TEMPLATES_URL;?>/css/layout.css" rel="stylesheet" type="text/css">
...
<link href="<?php echo MALL_TEMPLATES_URL;?>/css/home_header.css" rel="stylesheet" type="text/css">
	<link href="<?php echo MALL_TEMPLATES_URL;?>/css/wwi-tenpty.css" rel="stylesheet" type="text/css">
...
var TYQ_SITE_URL = '<?php echo TYQ_SITE_URL;?>'; var _ISLOGIN = <?php echo intval($_SESSION['is_login']);?>;
...
<script type="text/javascript" src="<?php echo TYQ_RESOURCE_SITE_URL;?>/js/common.js" charset="utf-8"></script> 
<link href="<?php echo RESOURCE_SITE_URL;?>/js/perfect-scrollbar.min.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/perfect-scrollbar.min.js"></script>
</head>
<body>
<?php require_once(tyq_template('layout/top'));?>
<?php require_once($tpl_file);?>
<?php require_once(tyq_template('layout/footer'));?>
</body>
</html>
