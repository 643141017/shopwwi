...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="reply_form1" action="<?php echo TYQ_SITE_URL;?>/index.php?app=theme&wwi=edit_reply&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['reply_info']['theme_id'];?>&r_id=<?php echo $output['reply_info']['reply_id'];?>">
