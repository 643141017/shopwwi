...
<div class="eject_con">
  <div id="warning"></div>
  <form id="fsedit_form" action="<?php echo TYQ_SITE_URL;?>/index.php?app=manage&wwi=friendship_edit&c_id=<?php echo $output['c_id'];?>&fs_id=<?php echo $output['fs_id'];?>" method="post" class="base-form-style">
...
$(function(){
    ...
    $('#fsedit_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('fsedit_form', '<?php echo TYQ_SITE_URL;?>/index.php?app=manage&wwi=friendship_edit&c_id='+c_id+'$fs_id='+fs_id, '', 'onerror');
    	},
        rules : {
            sort : {
                required : true,
