  ...
  <div class="mainbox">
    ...
    <div class="my-theme-list">
      ...
      <ul class="group-theme-list">
        ...
        <li>
          <dl class="theme-info" data-param="{t_id:<?php echo $val['theme_id'];?>,c_id:<?php echo $val['tyq_id'];?>}">
            <dt><span class="theme-title"><a href="index.php?app=theme&wwi=theme_detail&c_id=<?php echo $val['tyq_id'];?>&t_id=<?php echo $val['theme_id'];?>" target="_blank"><?php echo $val['theme_name'];?></a></span></dt>
            <dd class="theme-content">
              ...
              <div class="theme-info"><?php echo $val['member_name'].$lang['p_center_at'];?>
                ...
                <?php echo $lang['p_center_published_since'];?><span class="group-name">&#8220;<a href="<?php echo TYQ_SITE_URL;?>/index.php?app=group&c_id=<?php echo $val['tyq_id'];?>"><?php echo $val['tyq_name'];?></a>&#8221;</span>
                <?php if($val['lastspeak_name']){?>
                <span class="ml20"><?php echo $lang['tyq_reply'];?>(<em><?php echo $val['theme_commentcount'];?></em>)</span>
                <?php }else{?>
                <span class="ml20"><?php echo $lang['tyq_no_comment'];?></span>
                <?php }?>
                <span class="ml10"><a href="javascript:void(0);" onclick="likeNo($(this), {'t_id':<?php echo $val['theme_id'];?>,'c_id':<?php echo $val['tyq_id'];?>});$(this).parents('li:first').remove();" class="edit"><?php echo $lang['tyq_like_cancel'];?>(<em nctype="like"><?php echo $val['theme_likecount'];?></em>)</a></span></div>
            </dd>
          </dl>
        </li>
        <?php }?>
