...
<a href="<?php echo urlTyq('group','group_member',array('c_id'=>$output['c_id']));?>">圈友</a>
<a class="now" href="<?php echo urlTyq('group','group_goods',array('c_id'=>$output['c_id']));?>">商品</a>
 </div>
...
$(function(){
	...
	$("a[nc_type='likebtn']").live('click',function(){
        ...
        //ajaxget(SITEURL+'/index.php?app=member_snsindex&wwi=editlike&inajax=1&id='+data_str.gid);
        ajaxget(TYQ_SITE_URL+'/index.php?app=member_snsindex&wwi=editlike&inajax=1&id='+data_str.gid);
	});
