...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="theme_form" action="<?php echo TYQ_SITE_URL;?>/index.php?app=theme&wwi=edit_theme&sp=1&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id']; ?>">
        ...
        <div class="quick-thread-box">
          ...
          <div class="poll-options">
            ...
            <div id="poll_div_1" class="add-poll">
              <div class="titbar"><span class="sort"><?php echo $lang['tyq_poll_sort'];?></span><span class="option"><?php echo $lang['tyq_option'];?></span></div>
              ...
              <?php }?>
              <?php }?>
              <a href="javascript:void(0);" nctype="addpolloption" class="btn"><i></i><?php echo $lang['tyq_add_new'];?></a> </div>
          </div>
...
$(function(){
    ...
    $('#theme_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('theme_form', TYQ_SITE_URL+'/index.php?app=theme&wwi=edit_theme&sp=1&c_id='+c_id+'&t_id='+t_id, '', 'onerror');
    	},
        rules : {
        	name : {
                required : true,
