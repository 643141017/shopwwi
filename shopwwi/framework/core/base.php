...
final class Base{
	...
	private static function parse_conf(&$setting_config){
		...
		$setting['shopwwi_version'] = '<span class="vol"><font class="b">mall</font><font class="o">WWI</font></span>';
	...
	private static function control(){
		...
		//二级域名
		if ($GLOBALS['setting_config']['enabled_subdomain'] == '1' && $_GET['app'] == 'index' && $_GET['wwi'] == 'index'){
			$store_id = subdomain();
